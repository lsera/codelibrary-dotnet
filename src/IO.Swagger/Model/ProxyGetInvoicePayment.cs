...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetInvoicePayment :  IEquatable<ProxyGetInvoicePayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoicePayment" /> class.
        /// </summary>
        /// <param name="Amount"> The amount of the payment. **Character limit**: 16 **Values**: a valid currency amount .</param>
        /// <param name="CreatedById"> The user ID of the person who created the invoice payment. **Character limit**: 32 **V****alues**: automatically generated .</param>
        /// <param name="CreatedDate"> The date when the invoice payment was generated. **Character limit**: 29 **V****alues**: automatically generated .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="InvoiceId"> The unique ID of the invoice associated with this invoice payment. **Character limit**: 32 **Values**: a valid invoice ID .</param>
        /// <param name="PaymentId"> The unique ID of the payment associated with this invoice payment. **Character limit**: 32 **V****alues**: a valid payment ID .</param>
        /// <param name="RefundAmount">Specifies the amount of a refund applied against this InvoicePayment. **Character limit**: 16 **Values**: automatically generated .</param>
        /// <param name="UpdatedById"> The ID of the user who last updated the invoice payment. **Character limit**: 32 **V****alues**: automatically generated .</param>
        /// <param name="UpdatedDate"> The date when the invoice payment was last updated. **Character limit**: 29 **V****alues**: automatically generated .</param>
        public ProxyGetInvoicePayment(double? Amount = null, string CreatedById = null, DateTime? CreatedDate = null, string Id = null, string InvoiceId = null, string PaymentId = null, double? RefundAmount = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
            this.Amount = Amount;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetInvoicePayment);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoicePayment instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetInvoicePayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoicePayment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
