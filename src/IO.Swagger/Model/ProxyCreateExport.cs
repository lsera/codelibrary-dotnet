...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateExport :  IEquatable<ProxyCreateExport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateExport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateExport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateExport" /> class.
        /// </summary>
        ...
        /// <param name="Format"> The format that you want the export file to use. **Character limit**: 4 **Values**: csv, html  (required).</param>
        /// <param name="Name"> The name of the export. **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        /// <param name="Query">optional (required).</param>
        /// <param name="Size"> The number of records or rows exported. This field value is null until the export status is Completed. **Character limit**: **Values**: automatically generated  (required).</param>
        ...
        /// <param name="Zip"> Indicates if you want the resulting export file to be compressed into a zip file. **Character limit**: **Values**: true, false (default)  (required).</param>
        public ProxyCreateExport(string ConvertToCurrencies = null, bool? Encrypted = null, string FileId = null, string Format = null, string Name = null, string Query = null, int? Size = null, string Status = null, string StatusReason = null, bool? Zip = null)
        {
            // to ensure "Format" is required (not null)
            if (Format == null)
            {
                throw new InvalidDataException("Format is a required property for ProxyCreateExport and cannot be null");
            }
            else
            {
                this.Format = Format;
            ...
            if (Query == null)
            {
                throw new InvalidDataException("Query is a required property for ProxyCreateExport and cannot be null");
            }
            else
            {
                this.Query = Query;
            ...
            if (Size == null)
            {
                throw new InvalidDataException("Size is a required property for ProxyCreateExport and cannot be null");
            }
            else
            {
                this.Size = Size;
            ...
            if (Zip == null)
            {
                throw new InvalidDataException("Zip is a required property for ProxyCreateExport and cannot be null");
            }
            else
            {
                this.Zip = Zip;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateExport);
        }

        /// <summary>
        /// Returns true if ProxyCreateExport instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateExport other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
