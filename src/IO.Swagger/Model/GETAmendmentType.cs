...
namespace IO.Swagger.Model
{
    ...
    public partial class GETAmendmentType :  IEquatable<GETAmendmentType>, IValidatableObject
    {
        ...
        /// <param name="Type">Type of the amendment. Possible values are:  - Cancellation - NewProduct - OwnerTransfer - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions .</param>
        public GETAmendmentType(bool? AutoRenew = null, string BaseRatePlanId = null, string BaseSubscriptionId = null, string Code = null, DateTime? ContractEffectiveDate = null, long? CurrentTerm = null, string CurrentTermPeriodType = null, DateTime? CustomerAcceptanceDate = null, string Description = null, string DestinationAccountId = null, string DestinationInvoiceOwnerId = null, DateTime? EffectiveDate = null, string Id = null, string Name = null, string NewRatePlanId = null, string NewSubscriptionId = null, string RenewalSetting = null, long? RenewalTerm = null, string RenewalTermPeriodType = null, DateTime? ResumeDate = null, DateTime? ServiceActivationDate = null, DateTime? SpecificUpdateDate = null, string Status = null, bool? Success = null, DateTime? SuspendDate = null, DateTime? TermStartDate = null, string TermType = null, string Type = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAmendmentType);
        }

        /// <summary>
        /// Returns true if GETAmendmentType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAmendmentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAmendmentType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.BaseRatePlanId == other.BaseRatePlanId ||
                    this.BaseRatePlanId != null &&
                    this.BaseRatePlanId.Equals(other.BaseRatePlanId)
                ) && 
                (
                    this.BaseSubscriptionId == other.BaseSubscriptionId ||
                    this.BaseSubscriptionId != null &&
                    this.BaseSubscriptionId.Equals(other.BaseSubscriptionId)
                ) && 
                (
                ...
                (
                    this.NewRatePlanId == other.NewRatePlanId ||
                    this.NewRatePlanId != null &&
                    this.NewRatePlanId.Equals(other.NewRatePlanId)
                ) && 
                (
                    this.NewSubscriptionId == other.NewSubscriptionId ||
                    this.NewSubscriptionId != null &&
                    this.NewSubscriptionId.Equals(other.NewSubscriptionId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BaseRatePlanId != null)
                    hash = hash * 59 + this.BaseRatePlanId.GetHashCode();
                if (this.BaseSubscriptionId != null)
                    hash = hash * 59 + this.BaseSubscriptionId.GetHashCode();
                if (this.Code != null)
                ...
                if (this.NewRatePlanId != null)
                    hash = hash * 59 + this.NewRatePlanId.GetHashCode();
                if (this.NewSubscriptionId != null)
                    hash = hash * 59 + this.NewSubscriptionId.GetHashCode();
