...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetProduct :  IEquatable<ProxyGetProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetProduct" /> class.
        /// </summary>
        ...
        /// <param name="CreatedById">The ID of the Zuora user who created the &#x60;Product&#x60; object. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate"> The date when the &#x60;Product&#x60; object was created. **Character limit**: n/a **Values**: automatically generated .</param>
        /// <param name="Description"> A descriptionof the product. **Character limit**: 500 **Values**: a string of 500 characters or fewer .</param>
        /// <param name="EffectiveEndDate">The date when the product expires and can&#39;t be subscribed to anymore. **Character limit**: 29 **Values**: a valid date and time value .</param>
        /// <param name="EffectiveStartDate">The date when the product becomes available and can be subscribed to. **Character limit**: 29 **Values**: a valid date and time value .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="Name">The name of the product. This information is displayed in the product catalog pages in the web-based UI. **Character limit**: 100 **Values**: a string of 100 characters or fewer .</param>
        ...
        public ProxyGetProduct(bool? AllowFeatureChanges = null, string Category = null, string CreatedById = null, DateTime? CreatedDate = null, string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Id = null, string Name = null, string SKU = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetProduct);
        }

        /// <summary>
        /// Returns true if ProxyGetProduct instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetProduct other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
