...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact :  IEquatable<POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact" /> class.
        /// </summary>
        /// <param name="City">The city of the bill-to address. The value should be 40 characters or less. .</param>
        /// <param name="Country">The country of the bill-to address. The value must be a valid [country name or abbreviation](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/A_Country_Names_and_Their_ISO_Codes). .</param>
        /// <param name="County">The county of the bill-to address. The value should be 32 characters or less. .</param>
        /// <param name="State">The state of the bill-to address. The value must be a valid state or province name or 2-character abbreviation. .</param>
        /// <param name="TaxRegion">If using [Z-Tax](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/L_Taxes/A_Z-Tax), a region string as optionally defined in your tax rules. .</param>
        /// <param name="ZipCode">The zip code of the bill-to address. The value should be 20 characters or less. .</param>
        public POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact(string City = null, string Country = null, string County = null, string State = null, string TaxRegion = null, string ZipCode = null)
        {
            this.City = City;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
