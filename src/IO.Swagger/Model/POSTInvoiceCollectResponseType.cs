...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTInvoiceCollectResponseType :  IEquatable<POSTInvoiceCollectResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTInvoiceCollectResponseType" /> class.
        /// </summary>
        /// <param name="AmountCollected">Payment amount applied. .</param>
        /// <param name="Invoices">Information on one or more invoices associated with this operation: .</param>
        /// <param name="PaymentId">Payment ID. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        public POSTInvoiceCollectResponseType(string AmountCollected = null, List<POSTInvoiceCollectInvoicesType> Invoices = null, string PaymentId = null, bool? Success = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTInvoiceCollectResponseType);
        }

        /// <summary>
        /// Returns true if POSTInvoiceCollectResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTInvoiceCollectResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTInvoiceCollectResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.AmountCollected == other.AmountCollected ||
                    this.AmountCollected != null &&
                    this.AmountCollected.Equals(other.AmountCollected)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AmountCollected != null)
                    hash = hash * 59 + this.AmountCollected.GetHashCode();
