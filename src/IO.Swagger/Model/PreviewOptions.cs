...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PreviewOptions :  IEquatable<PreviewOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOptions" /> class.
        /// </summary>
        /// <param name="EnablePreviewMode">.</param>
        /// <param name="IncludeExistingDraftInvoiceItems">.</param>
        /// <param name="NumberOfPeriods">.</param>
        /// <param name="PreviewThroughTermEnd">.</param>
        /// <param name="PreviewType">.</param>
        public PreviewOptions(bool? EnablePreviewMode = null, bool? IncludeExistingDraftInvoiceItems = null, int? NumberOfPeriods = null, bool? PreviewThroughTermEnd = null, string PreviewType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PreviewOptions);
        }

        /// <summary>
        /// Returns true if PreviewOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of PreviewOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviewOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.EnablePreviewMode == other.EnablePreviewMode ||
                    this.EnablePreviewMode != null &&
                    this.EnablePreviewMode.Equals(other.EnablePreviewMode)
                ) && 
                (
                ...
                (
                    this.PreviewThroughTermEnd == other.PreviewThroughTermEnd ||
                    this.PreviewThroughTermEnd != null &&
                    this.PreviewThroughTermEnd.Equals(other.PreviewThroughTermEnd)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnablePreviewMode != null)
                    hash = hash * 59 + this.EnablePreviewMode.GetHashCode();
                ...
                if (this.PreviewThroughTermEnd != null)
                    hash = hash * 59 + this.PreviewThroughTermEnd.GetHashCode();
