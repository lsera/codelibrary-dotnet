...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyProductRatePlan :  IEquatable<ProxyModifyProductRatePlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyProductRatePlan" /> class.
        /// </summary>
        ...
        public ProxyModifyProductRatePlan(string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Name = null, string ProductId = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyProductRatePlan {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyProductRatePlan);
        }

        /// <summary>
        /// Returns true if ProxyModifyProductRatePlan instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyProductRatePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyProductRatePlan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
