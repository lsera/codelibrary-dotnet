...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTRenewSubscriptionResponseType :  IEquatable<PUTRenewSubscriptionResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTRenewSubscriptionResponseType" /> class.
        /// </summary>
        /// <param name="InvoiceId">Invoice ID, if one is generated. .</param>
        /// <param name="PaidAmount">Payment amount, if payment is collected. .</param>
        /// <param name="PaymentId">Payment ID, if payment is collected. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="TermEndDate">Date the new subscription term ends, as yyyy-mm-dd. .</param>
        /// <param name="TermStartDate">Date the new subscription term begins, as yyyy-mm-dd. .</param>
        /// <param name="TotalDeltaMrr">Change in the subscription monthly recurring revenue as a result of the update. For a renewal, this is the MRR of the subscription in the new term. .</param>
        /// <param name="TotalDeltaTcv">Change in the total contracted value of the subscription as a result of the update. For a renewal, this is the TCV of the subscription in the new term. .</param>
        public PUTRenewSubscriptionResponseType(string InvoiceId = null, string PaidAmount = null, string PaymentId = null, bool? Success = null, DateTime? TermEndDate = null, DateTime? TermStartDate = null, string TotalDeltaMrr = null, string TotalDeltaTcv = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTRenewSubscriptionResponseType);
        }

        /// <summary>
        /// Returns true if PUTRenewSubscriptionResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTRenewSubscriptionResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTRenewSubscriptionResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
