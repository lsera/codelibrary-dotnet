...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetInvoiceSplitItem :  IEquatable<ProxyGetInvoiceSplitItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoiceSplitItem" /> class.
        /// </summary>
        /// <param name="CreatedById"> The ID of the Zuora user who created the InvoiceSplitItem object. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate"> The date when the InvoiceSplitItem was created. **Values**: automatically generated .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="InvoiceDate"> The generation date of the new split invoice. **Character limit**: 29 **Values**: [a valid date and time value](/CB_Billing/WA_Dates_in_Zuora/A_Date_Format_and_Datetimes_in_Zuora) .</param>
        /// <param name="InvoiceId"> The new invoice after the split. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="InvoiceSplitId"> The ID of the invoice split associated with the individual invoice split item. **Character limit**: 32 **Values**: [a valid invoice split ID](https://knowledgecenter.zuora.com/BC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/InvoiceSplit) .</param>
        /// <param name="PaymentTerm"> Indicates when the customer pays the split invoice. **Values**: [a valid, active payment term defined in the web-based UI administrative settings](/CB_Billing/W_Billing_and_Payments_Settings/K_Define_Payment_Terms) .</param>
        /// <param name="SplitPercentage"> Specifies the percentage of the original invoice that you want to be the balance of the split invoice. The total of the SplitPercentage field values for all of the InvoiceSplitItem objects in an InvoiceSplit object must equal 100. **Values**:  - If you&#39;re using WSDL 73.0 or earlier: a whole number between 1 and 100 - If you&#39;re using WSDL 74.0 or later: a decimal number with up to nine decimal places between 0.000000001 and 100, for example, &#x60;25&#x60; or &#x60;33.34&#x60; .</param>
        /// <param name="UpdatedById"> The ID of the Zuora user who last updated the invoice split. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="UpdatedDate"> The date when the invoice split was last updated. **Values**: automatically generated .</param>
        public ProxyGetInvoiceSplitItem(string CreatedById = null, DateTime? CreatedDate = null, string Id = null, DateTime? InvoiceDate = null, string InvoiceId = null, string InvoiceSplitId = null, string PaymentTerm = null, double? SplitPercentage = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetInvoiceSplitItem);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceSplitItem instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetInvoiceSplitItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceSplitItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.InvoiceSplitId == other.InvoiceSplitId ||
                    this.InvoiceSplitId != null &&
                    this.InvoiceSplitId.Equals(other.InvoiceSplitId)
                ) && 
                (
                ...
                (
                    this.SplitPercentage == other.SplitPercentage ||
                    this.SplitPercentage != null &&
                    this.SplitPercentage.Equals(other.SplitPercentage)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvoiceSplitId != null)
                    hash = hash * 59 + this.InvoiceSplitId.GetHashCode();
                if (this.PaymentTerm != null)
                    hash = hash * 59 + this.PaymentTerm.GetHashCode();
                if (this.SplitPercentage != null)
                    hash = hash * 59 + this.SplitPercentage.GetHashCode();
