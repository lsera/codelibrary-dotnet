...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyAmendment :  IEquatable<ProxyModifyAmendment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyAmendment" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyAmendment);
        }

        /// <summary>
        /// Returns true if ProxyModifyAmendment instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyAmendment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyAmendment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
