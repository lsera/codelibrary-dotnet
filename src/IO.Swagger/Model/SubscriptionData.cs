...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionData :  IEquatable<SubscriptionData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionData" /> class.
        /// </summary>
        /// <param name="RatePlanData">.</param>
        /// <param name="Subscription">.</param>
        public SubscriptionData(List<RatePlanData> RatePlanData = null, Subscription Subscription = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SubscriptionData);
        }

        /// <summary>
        /// Returns true if SubscriptionData instances are equal
        /// </summary>
        /// <param name="other">Instance of SubscriptionData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionData other)
        {
            ...
            return 
                (
                    ...
                    this.RatePlanData.SequenceEqual(other.RatePlanData)
                ) && 
                (
