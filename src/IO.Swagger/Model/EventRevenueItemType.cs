...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EventRevenueItemType :  IEquatable<EventRevenueItemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventRevenueItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventRevenueItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventRevenueItemType" /> class.
        /// </summary>
        ...
        public EventRevenueItemType(string AccountingPeriodName = null, string CustomFieldC = null)
        {
            // to ensure "AccountingPeriodName" is required (not null)
            if (AccountingPeriodName == null)
            {
                throw new InvalidDataException("AccountingPeriodName is a required property for EventRevenueItemType and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventRevenueItemType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EventRevenueItemType);
        }

        /// <summary>
        /// Returns true if EventRevenueItemType instances are equal
        /// </summary>
        /// <param name="other">Instance of EventRevenueItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventRevenueItemType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
