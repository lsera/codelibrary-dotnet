...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSubscriptionResumeResponseType :  IEquatable<PUTSubscriptionResumeResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionResumeResponseType" /> class.
        /// </summary>
        ...
        /// <param name="ResumeDate">The date when subscription resumption takes effect, as yyyy-mm-dd. .</param>
        /// <param name="SubscriptionId">The subscription ID. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="TermEndDate">The date when the new subscription term ends, as yyyy-mm-dd. .</param>
        /// <param name="TotalDeltaTcv">Change in the total contracted value of the subscription as a result of the update. .</param>
        public PUTSubscriptionResumeResponseType(string InvoiceId = null, string PaidAmount = null, string PaymentId = null, DateTime? ResumeDate = null, string SubscriptionId = null, bool? Success = null, DateTime? TermEndDate = null, string TotalDeltaTcv = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSubscriptionResumeResponseType);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionResumeResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSubscriptionResumeResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionResumeResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
