...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSubscriptionResponseTypeChargeMetrics :  IEquatable<PUTSubscriptionResponseTypeChargeMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionResponseTypeChargeMetrics" /> class.
        /// </summary>
        /// <param name="Dmrr">Change in total contract value. .</param>
        /// <param name="Dtcv">Change in monthly recurring revenue. .</param>
        ...
        public PUTSubscriptionResponseTypeChargeMetrics(string Dmrr = null, string Dtcv = null, string Mrr = null, string Number = null, string OriginRatePlanId = null, string OriginalId = null, string ProductRatePlanChargeId = null, string ProductRatePlanId = null, string Tcv = null)
        {
            this.Dmrr = Dmrr;
            this.Dtcv = Dtcv;
            this.Mrr = Mrr;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSubscriptionResponseTypeChargeMetrics);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionResponseTypeChargeMetrics instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSubscriptionResponseTypeChargeMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionResponseTypeChargeMetrics other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
