...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTAccountTypeTaxInfo :  IEquatable<POSTAccountTypeTaxInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeTaxInfo" /> class.
        /// </summary>
        /// <param name="VATId">EU Value Added Tax ID.   **Note:** This feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](https://support.zuora.com). .</param>
        /// <param name="CompanyCode">Unique code that identifies a company account in Avalara. Use this field to calculate taxes based on origin and sold-to addresses in Avalara.  **Note:** This feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](https://support.zuora.com).  .</param>
        /// <param name="ExemptCertificateId">ID of the customer tax exemption certificate. Requires Z-Tax. .</param>
        /// <param name="ExemptCertificateType">Type of tax exemption certificate that the customer holds. Requires Z-Tax. .</param>
        /// <param name="ExemptDescription">Description of the tax exemption certificate that the customer holds. Requires Z-Tax. .</param>
        /// <param name="ExemptEffectiveDate">Date when the customer tax exemption starts. Requires Z-Tax.  Format: &#x60;yyyy-mm-dd&#x60;. Defaults to the current date. .</param>
        /// <param name="ExemptExpirationDate">Date when the customer tax exemption expires. Requires Z-Tax.  Format: &#x60;yyyy-mm-dd&#x60;. Defaults to the current date. .</param>
        /// <param name="ExemptIssuingJurisdiction">Jurisdiction in which the customer tax exemption certificate was issued. .</param>
        /// <param name="ExemptStatus">Status of the account tax exemption. Requires Z-Tax.  Required if you use Z-Tax. This field is unavailable if Z-Tax is not used.  Values: &#x60;Yes&#x60;, &#x60;No&#x60;, &#x60;pendingVerification&#x60;. .</param>
        public POSTAccountTypeTaxInfo(string VATId = null, string CompanyCode = null, string ExemptCertificateId = null, string ExemptCertificateType = null, string ExemptDescription = null, DateTime? ExemptEffectiveDate = null, DateTime? ExemptExpirationDate = null, string ExemptIssuingJurisdiction = null, string ExemptStatus = null)
        {
            this.VATId = VATId;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTAccountTypeTaxInfo);
        }

        /// <summary>
        /// Returns true if POSTAccountTypeTaxInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTAccountTypeTaxInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountTypeTaxInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExemptCertificateId == other.ExemptCertificateId ||
                    this.ExemptCertificateId != null &&
                    this.ExemptCertificateId.Equals(other.ExemptCertificateId)
                ) && 
                (
                    this.ExemptCertificateType == other.ExemptCertificateType ||
                    this.ExemptCertificateType != null &&
                    this.ExemptCertificateType.Equals(other.ExemptCertificateType)
                ) && 
                (
                    this.ExemptDescription == other.ExemptDescription ||
                    this.ExemptDescription != null &&
                    this.ExemptDescription.Equals(other.ExemptDescription)
                ) && 
                (
                    this.ExemptEffectiveDate == other.ExemptEffectiveDate ||
                    this.ExemptEffectiveDate != null &&
                    this.ExemptEffectiveDate.Equals(other.ExemptEffectiveDate)
                ) && 
                (
                    this.ExemptExpirationDate == other.ExemptExpirationDate ||
                    this.ExemptExpirationDate != null &&
                    this.ExemptExpirationDate.Equals(other.ExemptExpirationDate)
                ) && 
                (
                    this.ExemptIssuingJurisdiction == other.ExemptIssuingJurisdiction ||
                    this.ExemptIssuingJurisdiction != null &&
                    this.ExemptIssuingJurisdiction.Equals(other.ExemptIssuingJurisdiction)
                ) && 
                (
                    this.ExemptStatus == other.ExemptStatus ||
                    this.ExemptStatus != null &&
                    this.ExemptStatus.Equals(other.ExemptStatus)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExemptCertificateId != null)
                    hash = hash * 59 + this.ExemptCertificateId.GetHashCode();
                if (this.ExemptCertificateType != null)
                    hash = hash * 59 + this.ExemptCertificateType.GetHashCode();
                if (this.ExemptDescription != null)
                    hash = hash * 59 + this.ExemptDescription.GetHashCode();
                if (this.ExemptEffectiveDate != null)
                    hash = hash * 59 + this.ExemptEffectiveDate.GetHashCode();
                if (this.ExemptExpirationDate != null)
                    hash = hash * 59 + this.ExemptExpirationDate.GetHashCode();
                if (this.ExemptIssuingJurisdiction != null)
                    hash = hash * 59 + this.ExemptIssuingJurisdiction.GetHashCode();
                if (this.ExemptStatus != null)
                    hash = hash * 59 + this.ExemptStatus.GetHashCode();
                return hash;
            }
        }
