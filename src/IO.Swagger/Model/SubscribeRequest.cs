...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscribeRequest :  IEquatable<SubscribeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequest" /> class.
        /// </summary>
        /// <param name="Account">.</param>
        /// <param name="BillToContact">.</param>
        /// <param name="PaymentMethod">.</param>
        /// <param name="PreviewOptions">.</param>
        /// <param name="SoldToContact">.</param>
        /// <param name="SubscribeOptions">.</param>
        /// <param name="SubscriptionData">.</param>
        public SubscribeRequest(Account Account = null, Contact BillToContact = null, PaymentMethod PaymentMethod = null, PreviewOptions PreviewOptions = null, Contact SoldToContact = null, SubscribeOptions SubscribeOptions = null, SubscriptionData SubscriptionData = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SubscribeRequest);
        }

        /// <summary>
        /// Returns true if SubscribeRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of SubscribeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequest other)
        {
            ...
            return 
                ...
                (
                    this.PreviewOptions == other.PreviewOptions ||
                    this.PreviewOptions != null &&
                    this.PreviewOptions.Equals(other.PreviewOptions)
                ) && 
                (
                ...
                (
                    this.SubscribeOptions == other.SubscribeOptions ||
                    this.SubscribeOptions != null &&
                    this.SubscribeOptions.Equals(other.SubscribeOptions)
                ) && 
                (
                    this.SubscriptionData == other.SubscriptionData ||
                    this.SubscriptionData != null &&
                    this.SubscriptionData.Equals(other.SubscriptionData)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreviewOptions != null)
                    hash = hash * 59 + this.PreviewOptions.GetHashCode();
                if (this.SoldToContact != null)
                    hash = hash * 59 + this.SoldToContact.GetHashCode();
                if (this.SubscribeOptions != null)
                    hash = hash * 59 + this.SubscribeOptions.GetHashCode();
                if (this.SubscriptionData != null)
                    hash = hash * 59 + this.SubscriptionData.GetHashCode();
                return hash;
            }
        }
