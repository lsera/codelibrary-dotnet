...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETUsageType :  IEquatable<GETUsageType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETUsageType" /> class.
        /// </summary>
        ...
        /// <param name="ChargeNumber">Number of the rate-plan charge that pays for this usage. .</param>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="Id">Unique ID for the usage item. .</param>
        /// <param name="Quantity">Number of units used. .</param>
        /// <param name="SourceName">Source of the usage data. Possible values are: &#x60;Import&#x60;, &#x60;API&#x60;. .</param>
        /// <param name="StartDateTime">Start date of the time period in which usage is tracked. Zuora uses this field value to determine the usage date. .</param>
        /// <param name="Status">Possible values are: &#x60;Importing&#x60;, &#x60;Pending&#x60;, &#x60;Processed&#x60;. .</param>
        /// <param name="SubmissionDateTime">Date when usage was submitted. .</param>
        /// <param name="SubscriptionNumber">Number of the subscription covering this usage. .</param>
        /// <param name="UnitOfMeasure">Unit used to measure consumption, as configured in the web-based UI at **Z-Billing &gt; Settings**. .</param>
        public GETUsageType(string AccountId = null, string AccountName = null, string AccountNumber = null, string ChargeNumber = null, string CustomFieldC = null, string Id = null, string Quantity = null, string SourceName = null, DateTime? StartDateTime = null, string Status = null, DateTime? SubmissionDateTime = null, string SubscriptionNumber = null, string UnitOfMeasure = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETUsageType);
        }

        /// <summary>
        /// Returns true if GETUsageType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETUsageType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETUsageType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
