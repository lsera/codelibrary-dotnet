...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetFeature :  IEquatable<ProxyGetFeature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetFeature" /> class.
        /// </summary>
        /// <param name="CreatedById"> Internal Zuora ID of the user who created the feature **Character limit**: 32 .</param>
        /// <param name="CreatedDate"> Date and time when the feature was created **Character limit**: 29 .</param>
        /// <param name="Description"> Description of the feature **Character limit**: 1000 .</param>
        /// <param name="FeatureCode"> Unique code of the feature **Character limit**: 255 .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="Name"> Name of the feature **Character limit**: 255 .</param>
        /// <param name="Status"> Status of the feature, Active or Inactive **Character limit**: 8 .</param>
        /// <param name="UpdatedById"> Internal Zuora ID of the user who last updated the feature **Character limit**: 32 .</param>
        /// <param name="UpdatedDate"> Date and time when the feature was last updated **Character limit**: 29 .</param>
        public ProxyGetFeature(string CreatedById = null, DateTime? CreatedDate = null, string Description = null, string FeatureCode = null, string Id = null, string Name = null, string Status = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetFeature);
        }

        /// <summary>
        /// Returns true if ProxyGetFeature instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetFeature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetFeature other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
