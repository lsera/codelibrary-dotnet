...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSubscriptionSuspendResponseType :  IEquatable<PUTSubscriptionSuspendResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionSuspendResponseType" /> class.
        /// </summary>
        /// <param name="InvoiceId">Invoice ID, if an invoice is generated during the subscription process. .</param>
        ...
        /// <param name="ResumeDate">The date when subscription resumption takes effect, in the format yyyy-mm-dd. .</param>
        /// <param name="SubscriptionId">The subscription ID. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="SuspendDate">The date when subscription suspension takes effect, in the format yyyy-mm-dd. .</param>
        /// <param name="TermEndDate">The date when the new subscription term ends, in the format yyyy-mm-dd. .</param>
        /// <param name="TotalDeltaTcv">Change in the total contracted value of the subscription as a result of the update. .</param>
        public PUTSubscriptionSuspendResponseType(string InvoiceId = null, string PaidAmount = null, string PaymentId = null, DateTime? ResumeDate = null, string SubscriptionId = null, bool? Success = null, DateTime? SuspendDate = null, DateTime? TermEndDate = null, string TotalDeltaTcv = null)
        {
        ...
        /// </summary>
        /// <value>The date when subscription resumption takes effect, in the format yyyy-mm-dd. </value>
        ...
        /// </summary>
        /// <value>The date when subscription suspension takes effect, in the format yyyy-mm-dd. </value>
        ...
        /// </summary>
        /// <value>The date when the new subscription term ends, in the format yyyy-mm-dd. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTSubscriptionSuspendResponseType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSubscriptionSuspendResponseType);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionSuspendResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSubscriptionSuspendResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionSuspendResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.SuspendDate == other.SuspendDate ||
                    this.SuspendDate != null &&
                    this.SuspendDate.Equals(other.SuspendDate)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SuspendDate != null)
                    hash = hash * 59 + this.SuspendDate.GetHashCode();
