...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyInvoiceAdjustment :  IEquatable<ProxyModifyInvoiceAdjustment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyInvoiceAdjustment" /> class.
        /// </summary>
        ...
        public ProxyModifyInvoiceAdjustment(string ReasonCode = null, string Status = null, string TransferredToAccounting = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyInvoiceAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyModifyInvoiceAdjustment instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyInvoiceAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyInvoiceAdjustment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
