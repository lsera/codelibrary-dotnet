...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AmendResult :  IEquatable<AmendResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AmendResult" /> class.
        /// </summary>
        /// <param name="AmendmentIds"> The IDs of the associated Amendment object. There can be as many as three AmendmentId values..</param>
        /// <param name="ChargeMetricsData">.</param>
        /// <param name="Errors">.</param>
        /// <param name="GatewayResponse">.</param>
        /// <param name="GatewayResponseCode">.</param>
        /// <param name="InvoiceDatas">.</param>
        /// <param name="InvoiceId">.</param>
        /// <param name="PaymentId">.</param>
        /// <param name="PaymentTransactionNumber">.</param>
        /// <param name="SubscriptionId">.</param>
        /// <param name="Success">.</param>
        /// <param name="TotalDeltaMrr">.</param>
        /// <param name="TotalDeltaTcv">.</param>
        public AmendResult(string AmendmentIds = null, ChargeMetricsData ChargeMetricsData = null, List<Error> Errors = null, string GatewayResponse = null, string GatewayResponseCode = null, List<InvoiceData> InvoiceDatas = null, string InvoiceId = null, string PaymentId = null, string PaymentTransactionNumber = null, string SubscriptionId = null, bool? Success = null, double? TotalDeltaMrr = null, double? TotalDeltaTcv = null)
        {
        ...
        /// </summary>
        /// <value> The IDs of the associated Amendment object. There can be as many as three AmendmentId values.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AmendResult);
        }

        /// <summary>
        /// Returns true if AmendResult instances are equal
        /// </summary>
        /// <param name="other">Instance of AmendResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AmendResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.AmendmentIds == other.AmendmentIds ||
                    this.AmendmentIds != null &&
                    this.AmendmentIds.Equals(other.AmendmentIds)
                ) && 
                (
                ...
                (
                    this.InvoiceDatas == other.InvoiceDatas ||
                    this.InvoiceDatas != null &&
                    this.InvoiceDatas.SequenceEqual(other.InvoiceDatas)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AmendmentIds != null)
                    hash = hash * 59 + this.AmendmentIds.GetHashCode();
                ...
                if (this.InvoiceDatas != null)
                    hash = hash * 59 + this.InvoiceDatas.GetHashCode();
