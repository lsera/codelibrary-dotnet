...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSrpAddType :  IEquatable<PUTSrpAddType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSrpAddType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTSrpAddType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSrpAddType" /> class.
        /// </summary>
        /// <param name="ChargeOverrides">This optional container is used to override the quantity of one or more product rate plan charges for this subscription. .</param>
        ...
        /// <param name="ProductRatePlanId">ID of a product rate plan for this subscription  (required).</param>
        /// <param name="ServiceActivationDate">The date when the new product in the subscription is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the &#x60;serviceActivationDate&#x60; field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate &lt;&#x3D; serviceActivationDate &lt;&#x3D; contractAcceptanceDate .</param>
        public PUTSrpAddType(List<PUTScAddType> ChargeOverrides = null, DateTime? ContractEffectiveDate = null, string CustomFieldC = null, DateTime? CustomerAcceptanceDate = null, string ProductRatePlanId = null, DateTime? ServiceActivationDate = null)
        {
            // to ensure "ContractEffectiveDate" is required (not null)
            if (ContractEffectiveDate == null)
            {
                throw new InvalidDataException("ContractEffectiveDate is a required property for PUTSrpAddType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProductRatePlanId is a required property for PUTSrpAddType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSrpAddType);
        }

        /// <summary>
        /// Returns true if PUTSrpAddType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSrpAddType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSrpAddType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.ChargeOverrides == other.ChargeOverrides ||
                    this.ChargeOverrides != null &&
                    this.ChargeOverrides.SequenceEqual(other.ChargeOverrides)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChargeOverrides != null)
                    hash = hash * 59 + this.ChargeOverrides.GetHashCode();
