...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountType :  IEquatable<GETAccountType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountType" /> class.
        /// </summary>
        /// <param name="BasicInfo">BasicInfo.</param>
        /// <param name="BillToContact">BillToContact.</param>
        /// <param name="BillingAndPayment">BillingAndPayment.</param>
        ...
        public GETAccountType(GETAccountTypeBasicInfo BasicInfo = null, GETAccountTypeBillToContact BillToContact = null, GETAccountTypeBillingAndPayment BillingAndPayment = null, GETAccountTypeMetrics Metrics = null, GETAccountTypeSoldToContact SoldToContact = null, bool? Success = null, GETAccountSummaryTypeTaxInfo TaxInfo = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountType);
        }

        /// <summary>
        /// Returns true if GETAccountType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.BillingAndPayment == other.BillingAndPayment ||
                    this.BillingAndPayment != null &&
                    this.BillingAndPayment.Equals(other.BillingAndPayment)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BillingAndPayment != null)
                    hash = hash * 59 + this.BillingAndPayment.GetHashCode();
