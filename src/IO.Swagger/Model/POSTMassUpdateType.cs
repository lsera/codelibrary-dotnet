...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTMassUpdateType :  IEquatable<POSTMassUpdateType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTMassUpdateType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTMassUpdateType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTMassUpdateType" /> class.
        /// </summary>
        /// <param name="File">File containing data about the mass action you want to perform. The file requirements are the same as when uploading a file through the Mass Updater on the Zuora UI.  The file must be a .csv file or a zipped .csv file.   The maximum file size is 4 MB.  The data in the file must be formatted according to the mass action type you want to perform. Refer to the articles listed in the &#x60;actionType&#x60; field below for the requirements of each mass action type.  See the [Uploaded File](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater#Uploaded_File) section of the Mass Updater article for more information about the upload file.  (required).</param>
        /// <param name="_Params">_Params.</param>
        public POSTMassUpdateType(string File = null, POSTMassUpdateTypeParams _Params = null)
        {
            // to ensure "File" is required (not null)
            if (File == null)
            {
                throw new InvalidDataException("File is a required property for POSTMassUpdateType and cannot be null");
            }
            else
            {
                this.File = File;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTMassUpdateType);
        }

        /// <summary>
        /// Returns true if POSTMassUpdateType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTMassUpdateType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTMassUpdateType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
