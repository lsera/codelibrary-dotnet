...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETJournalEntryItemType :  IEquatable<GETJournalEntryItemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETJournalEntryItemType" /> class.
        /// </summary>
        /// <param name="AccountingCodeName">Name of the accounting code. .</param>
        ...
        /// <param name="Amount">Journal entry item amount in transaction currency. .</param>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="GlAccountName">The account number in the general ledger (GL) that corresponds to the accounting code. .</param>
        /// <param name="GlAccountNumber">The account name in the general ledger (GL) that corresponds to the accounting code. .</param>
        /// <param name="HomeCurrencyAmount">Journal entry item amount in home currency. .</param>
        /// <param name="Type">Type of journal entry item. An enum with the value &#x60;Credit&#x60; or &#x60;Debit&#x60;. .</param>
        public GETJournalEntryItemType(string AccountingCodeName = null, string AccountingCodeType = null, string Amount = null, string CustomFieldC = null, string GlAccountName = null, string GlAccountNumber = null, string HomeCurrencyAmount = null, string Type = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETJournalEntryItemType);
        }

        /// <summary>
        /// Returns true if GETJournalEntryItemType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETJournalEntryItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETJournalEntryItemType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
