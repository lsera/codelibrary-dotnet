...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyAccountingCode :  IEquatable<ProxyModifyAccountingCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyAccountingCode" /> class.
        /// </summary>
        ...
        public ProxyModifyAccountingCode(string GLAccountName = null, string GLAccountNumber = null, string Name = null, string Notes = null, string Status = null, string Type = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyAccountingCode {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyAccountingCode);
        }

        /// <summary>
        /// Returns true if ProxyModifyAccountingCode instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyAccountingCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyAccountingCode other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
