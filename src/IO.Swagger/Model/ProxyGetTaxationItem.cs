...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetTaxationItem :  IEquatable<ProxyGetTaxationItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetTaxationItem" /> class.
        /// </summary>
        ...
        /// <param name="CreatedById"> The ID of the user who created the taxation item. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate"> The date when the payment was created in the Zuora system. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="ExemptAmount"> The amount of taxes or VAT for which the customer has an exemption. **Character limit**: 16 **Values**: a decimal value .</param>
        ...
        /// <param name="TaxAmount"> The amount of the tax applied to the charge. **Character limit**: 16 **Values**: a decimal value .</param>
        ...
        /// <param name="TaxRate"> The tax rate applied to the charge. **Character limit**: 16 **Values**: a valid decimal value .</param>
        ...
        /// <param name="UpdatedById"> The ID of the user who last updated the taxation item. **Character limit**: **Values**: automatically generated .</param>
        /// <param name="UpdatedDate">The date when the taxation item was last updated. **Character limit**: **Values**: automatically generated .</param>
        public ProxyGetTaxationItem(string AccountingCode = null, string CreatedById = null, DateTime? CreatedDate = null, double? ExemptAmount = null, string Id = null, string InvoiceItemId = null, string Jurisdiction = null, string LocationCode = null, string Name = null, double? TaxAmount = null, string TaxCode = null, string TaxCodeDescription = null, DateTime? TaxDate = null, double? TaxRate = null, string TaxRateDescription = null, string TaxRateType = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetTaxationItem);
        }

        /// <summary>
        /// Returns true if ProxyGetTaxationItem instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetTaxationItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetTaxationItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
