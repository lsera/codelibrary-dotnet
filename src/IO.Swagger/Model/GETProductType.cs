...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETProductType :  IEquatable<GETProductType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETProductType" /> class.
        /// </summary>
        /// <param name="Category">Category of the product. Used by Zuora Quotes Guided Product Selector.  Possible values are:   - Base Products   - Add On Services   - Miscellaneous Products .</param>
        ...
        /// <param name="EffectiveEndDate">The date when the product expires and cannot be subscribed to anymore, as &#x60;yyyy-mm-dd&#x60;. .</param>
        /// <param name="EffectiveStartDate">The date when the product becomes available and can be subscribed to, as &#x60;yyyy-mm-dd&#x60;. .</param>
        /// <param name="Id">Product ID. .</param>
        /// <param name="Name">Product name, up to 100 characters. .</param>
        /// <param name="ProductFeatures">Container for one or more product features. Only available when the following settings are enabled: - The Entitlements feature in your tenant - The [Enable Feature Specification in Product and Subscriptions](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Enable_Feature_Specification_in_Products_and_Subscriptions.3F) setting in Z-Billing Settings .</param>
        /// <param name="ProductRatePlans">Container for one or more product rate plans: .</param>
        /// <param name="Sku">Unique product SKU, up to 50 characters. .</param>
        /// <param name="Tags">dummy.</param>
        public GETProductType(string Category = null, string CustomFieldC = null, string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Id = null, string Name = null, List<GetProductFeatureType> ProductFeatures = null, List<GETProductRatePlanType> ProductRatePlans = null, string Sku = null, string Tags = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETProductType);
        }

        /// <summary>
        /// Returns true if GETProductType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETProductType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProductFeatures == other.ProductFeatures ||
                    this.ProductFeatures != null &&
                    this.ProductFeatures.SequenceEqual(other.ProductFeatures)
                ) && 
                (
                    this.ProductRatePlans == other.ProductRatePlans ||
                    this.ProductRatePlans != null &&
                    this.ProductRatePlans.SequenceEqual(other.ProductRatePlans)
                ) && 
                (
                    this.Sku == other.Sku ||
                    this.Sku != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProductFeatures != null)
                    hash = hash * 59 + this.ProductFeatures.GetHashCode();
                if (this.ProductRatePlans != null)
                    hash = hash * 59 + this.ProductRatePlans.GetHashCode();
                if (this.Sku != null)
