...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSrpUpdateType :  IEquatable<PUTSrpUpdateType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSrpUpdateType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTSrpUpdateType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSrpUpdateType" /> class.
        /// </summary>
        /// <param name="ChargeUpdateDetails">Container for one or more product rate plan charges.  .</param>
        /// <param name="ContractEffectiveDate">The date when the amendment changes take effect. The format of the date is yyyy-mm-dd.  If there is already a future-dated Update Product amendment on the subscription, the &#x60;specificUpdateDate&#x60; field will be used instead of this field to specify when the Update Product amendment takes effect.  (required).</param>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="CustomerAcceptanceDate">The date when the customer accepts the contract in yyyy-mm-dd format.  If this field is not set:  * If the &#x60;serviceActivationDate&#x60; field is not set, the value of this field is set to be the contract effective date. * If the &#x60;serviceActivationDate&#x60; field is set, the value of this field is set to be the service activation date.  The billing trigger dates must follow this rule:  contractEffectiveDate &lt;&#x3D; serviceActivationDate &lt;&#x3D; contractAcceptanceDate .</param>
        /// <param name="RatePlanId">ID of a rate plan for this subscription.  (required).</param>
        /// <param name="ServiceActivationDate">The date when the update amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the &#x60;serviceActivationDate&#x60; field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate &lt;&#x3D; serviceActivationDate &lt;&#x3D; contractAcceptanceDate .</param>
        /// <param name="SpecificUpdateDate">The date when the Update Product amendment takes effect. This field is only applicable if there is already a future-dated Update Product amendment on the subscription. The format of the date is yyyy-mm-dd.  Required only for Update Product amendments if there is already a future-dated Update Product amendment on the subscription. .</param>
        public PUTSrpUpdateType(List<PUTScUpdateType> ChargeUpdateDetails = null, DateTime? ContractEffectiveDate = null, string CustomFieldC = null, DateTime? CustomerAcceptanceDate = null, string RatePlanId = null, DateTime? ServiceActivationDate = null, DateTime? SpecificUpdateDate = null)
        {
            // to ensure "ContractEffectiveDate" is required (not null)
            if (ContractEffectiveDate == null)
            {
                throw new InvalidDataException("ContractEffectiveDate is a required property for PUTSrpUpdateType and cannot be null");
            }
            else
            {
                this.ContractEffectiveDate = ContractEffectiveDate;
            }
            // to ensure "RatePlanId" is required (not null)
            if (RatePlanId == null)
            {
                throw new InvalidDataException("RatePlanId is a required property for PUTSrpUpdateType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSrpUpdateType);
        }

        /// <summary>
        /// Returns true if PUTSrpUpdateType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSrpUpdateType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSrpUpdateType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.ChargeUpdateDetails == other.ChargeUpdateDetails ||
                    this.ChargeUpdateDetails != null &&
                    this.ChargeUpdateDetails.SequenceEqual(other.ChargeUpdateDetails)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChargeUpdateDetails != null)
                    hash = hash * 59 + this.ChargeUpdateDetails.GetHashCode();
