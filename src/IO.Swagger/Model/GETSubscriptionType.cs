...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETSubscriptionType :  IEquatable<GETSubscriptionType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETSubscriptionType" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETSubscriptionType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETSubscriptionType);
        }

        /// <summary>
        /// Returns true if GETSubscriptionType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETSubscriptionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETSubscriptionType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
