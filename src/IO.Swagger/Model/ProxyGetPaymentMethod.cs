...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetPaymentMethod :  IEquatable<ProxyGetPaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetPaymentMethod" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetPaymentMethod);
        }

        /// <summary>
        /// Returns true if ProxyGetPaymentMethod instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetPaymentMethod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
