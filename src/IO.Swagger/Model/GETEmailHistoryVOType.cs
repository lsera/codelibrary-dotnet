...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETEmailHistoryVOType :  IEquatable<GETEmailHistoryVOType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETEmailHistoryVOType" /> class.
        /// </summary>
        /// <param name="Bcc">Blind carbon copy recipients of the email. .</param>
        /// <param name="Cc">Carbon Copy recipients of the email. .</param>
        /// <param name="ErrorMessage">null if the content of result is \&quot;OK\&quot;. A description of the error if the content of result is not \&quot;OK\&quot;. .</param>
        /// <param name="EventCategory">The [event category](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Notification_History/Z_Event_Categories) of the email. .</param>
        /// <param name="FromEmail">The sender of the email. .</param>
        /// <param name="Notification">The name of the notification. .</param>
        /// <param name="ReplyTo">The reply-to address as configured in the email template. .</param>
        /// <param name="Result">The result from the mail server of sending the email. .</param>
        /// <param name="SendTime">The date and time the email was sent. .</param>
        /// <param name="Subject">The subject of the email. .</param>
        /// <param name="ToEmail">The intended recipient of the email. .</param>
        public GETEmailHistoryVOType(string Bcc = null, string Cc = null, string ErrorMessage = null, string EventCategory = null, string FromEmail = null, string Notification = null, string ReplyTo = null, string Result = null, string SendTime = null, string Subject = null, string ToEmail = null)
        {
            this.Bcc = Bcc;
            this.Cc = Cc;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETEmailHistoryVOType);
        }

        /// <summary>
        /// Returns true if GETEmailHistoryVOType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETEmailHistoryVOType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETEmailHistoryVOType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.ToEmail != null &&
                    this.ToEmail.Equals(other.ToEmail)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ToEmail != null)
                    hash = hash * 59 + this.ToEmail.GetHashCode();
                return hash;
            }
        }
