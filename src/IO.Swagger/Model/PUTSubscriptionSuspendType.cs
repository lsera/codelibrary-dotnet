...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSubscriptionSuspendType :  IEquatable<PUTSubscriptionSuspendType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionSuspendType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTSubscriptionSuspendType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionSuspendType" /> class.
        /// </summary>
        ...
        /// <param name="ContractEffectiveDate">The date when the customer notifies you that they want to amend their subscription. .</param>
        ...
        /// <param name="Resume">Whether to set when to resume a subscription when creating a suspend amendment. Values: &#x60;true&#x60;, &#x60;false&#x60;. .</param>
        ...
        /// <param name="SuspendPeriods">The length of the period used to specify when the subscription suspension takes effect. The subscription suspension takes effect after a specified period based on today&#39;s date. You must use this field together with the &#x60;suspendPeriodsType&#x60; field to specify the period.  **Note:** This field is only applicable only when the suspendPolicy field is set to FixedPeriodsFromToday. .</param>
        /// <param name="SuspendPeriodsType">The period type used to define when the subscription suspension takes effect. The subscription suspension takes effect after a specified period based on today&#39;s date. You must use this field together with the suspendPeriods field to specify the period.  Type: string (enum)  Values: &#x60;Day&#x60;, &#x60;Week&#x60;, &#x60;Month&#x60;, &#x60;Year&#x60;  **Note:** This field is only applicable only when the suspendPolicy field is set to FixedPeriodsFromToday. .</param>
        /// <param name="SuspendPolicy">Suspend methods. Specify a way to suspend a subscription. See [Suspend Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Suspend_a_Subscription#Suspend_Date) for more information.  Value:  * &#x60;Today&#x60;: The subscription suspension takes effect on today&#39;s date. * &#x60;EndOfLastInvoicePeriod&#x60;: The subscription suspension takes effect at the end of the last invoice period. The suspend date defaults to a date that is one day after the last invoiced period. You can choose this option to avoid any negative invoices (credits) issued back to the customer after the subscription suspension.  * &#x60;SpecificDate&#x60;: The subscription suspension takes effect on a specific date. You must define the specific date in the &#x60;suspendSpecificDate&#x60; field. * &#x60;FixedPeriodsFromToday&#x60;: The subscription suspension takes effect after a specified period based on today&#39;s date. You must specify the &#x60;suspendPeriods&#x60; and &#x60;suspendPeriodsType&#x60; fields to define the period.  (required).</param>
        /// <param name="SuspendSpecificDate">A specific date when the subscription suspension takes effect, in the format yyyy-mm-dd.  **Note:** This field is only applicable only when the suspendPolicy field is set to SpecificDate.  The value should not be earlier than the subscription contract effective date, later than the subscription term end date, or within a period for which the customer has been invoiced. .</param>
        public PUTSubscriptionSuspendType(bool? ApplyCreditBalance = null, bool? Collect = null, DateTime? ContractEffectiveDate = null, bool? ExtendsTerm = null, bool? Invoice = null, bool? InvoiceCollect = null, DateTime? InvoiceTargetDate = null, bool? Resume = null, string ResumePeriods = null, string ResumePeriodsType = null, string ResumePolicy = null, DateTime? ResumeSpecificDate = null, string SuspendPeriods = null, string SuspendPeriodsType = null, string SuspendPolicy = null, DateTime? SuspendSpecificDate = null)
        {
            // to ensure "SuspendPolicy" is required (not null)
            if (SuspendPolicy == null)
            {
                throw new InvalidDataException("SuspendPolicy is a required property for PUTSubscriptionSuspendType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSubscriptionSuspendType);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionSuspendType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSubscriptionSuspendType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionSuspendType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.SuspendPeriods == other.SuspendPeriods ||
                    this.SuspendPeriods != null &&
                    this.SuspendPeriods.Equals(other.SuspendPeriods)
                ) && 
                (
                    this.SuspendPeriodsType == other.SuspendPeriodsType ||
                    this.SuspendPeriodsType != null &&
                    this.SuspendPeriodsType.Equals(other.SuspendPeriodsType)
                ) && 
                (
                    this.SuspendPolicy == other.SuspendPolicy ||
                    this.SuspendPolicy != null &&
                    this.SuspendPolicy.Equals(other.SuspendPolicy)
                ) && 
                (
                    this.SuspendSpecificDate == other.SuspendSpecificDate ||
                    this.SuspendSpecificDate != null &&
                    this.SuspendSpecificDate.Equals(other.SuspendSpecificDate)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SuspendPeriods != null)
                    hash = hash * 59 + this.SuspendPeriods.GetHashCode();
                if (this.SuspendPeriodsType != null)
                    hash = hash * 59 + this.SuspendPeriodsType.GetHashCode();
                if (this.SuspendPolicy != null)
                    hash = hash * 59 + this.SuspendPolicy.GetHashCode();
                if (this.SuspendSpecificDate != null)
                    hash = hash * 59 + this.SuspendSpecificDate.GetHashCode();
                return hash;
            }
        }
