...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTAccountingPeriodType :  IEquatable<PUTAccountingPeriodType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountingPeriodType" /> class.
        /// </summary>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="EndDate">The end date of the accounting period in yyyy-mm-dd format, for example, \&quot;2016-02-19\&quot;. .</param>
        /// <param name="FiscalYear">Fiscal year of the accounting period in yyyy format, for example, \&quot;2016\&quot;. .</param>
        /// <param name="FiscalQuarter">dummy.</param>
        /// <param name="Name">Name of the accounting period.  Accounting period name must be unique. Maximum of 100 characters. .</param>
        /// <param name="Notes">Notes about the accounting period.  Maximum of 255 characters. .</param>
        /// <param name="StartDate">The start date of the accounting period in yyyy-mm-dd format, for example, \&quot;2016-02-19\&quot;. .</param>
        public PUTAccountingPeriodType(string CustomFieldC = null, DateTime? EndDate = null, string FiscalYear = null, long? FiscalQuarter = null, string Name = null, string Notes = null, DateTime? StartDate = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTAccountingPeriodType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTAccountingPeriodType);
        }

        /// <summary>
        /// Returns true if PUTAccountingPeriodType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTAccountingPeriodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountingPeriodType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
