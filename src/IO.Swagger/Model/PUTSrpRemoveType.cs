...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSrpRemoveType :  IEquatable<PUTSrpRemoveType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSrpRemoveType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTSrpRemoveType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSrpRemoveType" /> class.
        /// </summary>
        /// <param name="ContractEffectiveDate">Effective date of the new subscription, as yyyy-mm-dd.  (required).</param>
        ...
        /// <param name="RatePlanId">ID of a rate-plan charge for this subscription  (required).</param>
        /// <param name="ServiceActivationDate">The date when the remove amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the &#x60;serviceActivationDate&#x60; field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate &lt;&#x3D; serviceActivationDate &lt;&#x3D; contractAcceptanceDate .</param>
        public PUTSrpRemoveType(DateTime? ContractEffectiveDate = null, DateTime? CustomerAcceptanceDate = null, string RatePlanId = null, DateTime? ServiceActivationDate = null)
        {
            // to ensure "ContractEffectiveDate" is required (not null)
            if (ContractEffectiveDate == null)
            {
                throw new InvalidDataException("ContractEffectiveDate is a required property for PUTSrpRemoveType and cannot be null");
            }
            else
            {
            ...
            if (RatePlanId == null)
            {
                throw new InvalidDataException("RatePlanId is a required property for PUTSrpRemoveType and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Effective date of the new subscription, as yyyy-mm-dd. </value>
        ...
        /// </summary>
        /// <value>The date when the remove amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the &#x60;serviceActivationDate&#x60; field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate &lt;&#x3D; serviceActivationDate &lt;&#x3D; contractAcceptanceDate </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTSrpRemoveType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSrpRemoveType);
        }

        /// <summary>
        /// Returns true if PUTSrpRemoveType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSrpRemoveType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSrpRemoveType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
