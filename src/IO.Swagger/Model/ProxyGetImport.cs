...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetImport :  IEquatable<ProxyGetImport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetImport" /> class.
        /// </summary>
        /// <param name="CreatedById"> The user ID of the person who created the import. **Character limit**: 32 **Values**: automatically generated .</param>
        ...
        /// <param name="ImportType"> The type of item imported. **Character limit**: 7 **Values**: Usage .</param>
        /// <param name="ImportedCount">The number of records successfully imported. **Character limit**: **Values**: automatically generated .</param>
        ...
        /// <param name="OriginalResourceUrl"> The URL for your import file, which contains your records for upload. When you upload the file, Zuora assigns it to this address. **Character limit**: **Values**: automatic dynamically-generated URL .</param>
        /// <param name="ResultResourceUrl"> The URL for the import result file, which is a zipped CSV file. **Character limit**: **Values**: automatic dynamically-generated URL .</param>
        ...
        /// <param name="TotalCount"> The number of records in the import file. **Character limit**: **Values**: automatically generated .</param>
        /// <param name="UpdatedById"> The ID of the user who last updated the import. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="UpdatedDate"> The date when the import was last updated. **Character limi**t: 29 **Values**: automatically generated .</param>
        public ProxyGetImport(string CreatedById = null, DateTime? CreatedDate = null, string Id = null, string ImportType = null, int? ImportedCount = null, string Md5 = null, string Name = null, string OriginalResourceUrl = null, string ResultResourceUrl = null, string Status = null, string StatusReason = null, int? TotalCount = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetImport);
        }

        /// <summary>
        /// Returns true if ProxyGetImport instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetImport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetImport other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
