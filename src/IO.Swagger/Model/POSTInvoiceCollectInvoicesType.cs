...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTInvoiceCollectInvoicesType :  IEquatable<POSTInvoiceCollectInvoicesType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTInvoiceCollectInvoicesType" /> class.
        /// </summary>
        /// <param name="InvoiceAmount">Invoice amount. .</param>
        /// <param name="InvoiceId">Invoice ID. .</param>
        /// <param name="InvoiceNumber">Invoice number. .</param>
        public POSTInvoiceCollectInvoicesType(string InvoiceAmount = null, string InvoiceId = null, string InvoiceNumber = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTInvoiceCollectInvoicesType);
        }

        /// <summary>
        /// Returns true if POSTInvoiceCollectInvoicesType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTInvoiceCollectInvoicesType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTInvoiceCollectInvoicesType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
