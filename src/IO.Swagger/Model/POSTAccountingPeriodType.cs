...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTAccountingPeriodType :  IEquatable<POSTAccountingPeriodType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountingPeriodType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTAccountingPeriodType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountingPeriodType" /> class.
        /// </summary>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="EndDate">The end date of the accounting period in yyyy-mm-dd format, for example, \&quot;2016-02-19\&quot;.  (required).</param>
        /// <param name="FiscalYear">Fiscal year of the accounting period in yyyy format, for example, \&quot;2016\&quot;.  (required).</param>
        /// <param name="FiscalQuarter">dummy.</param>
        /// <param name="Name">Name of the accounting period.  Accounting period name must be unique. Maximum of 100 characters.  (required).</param>
        /// <param name="Notes">Notes about the accounting period.  Maximum of 255 characters. .</param>
        /// <param name="StartDate">The start date of the accounting period in yyyy-mm-dd format, for example, \&quot;2016-02-19\&quot;.  (required).</param>
        public POSTAccountingPeriodType(string CustomFieldC = null, DateTime? EndDate = null, string FiscalYear = null, long? FiscalQuarter = null, string Name = null, string Notes = null, DateTime? StartDate = null)
        {
            // to ensure "EndDate" is required (not null)
            if (EndDate == null)
            {
                throw new InvalidDataException("EndDate is a required property for POSTAccountingPeriodType and cannot be null");
            }
            else
            {
            ...
            if (FiscalYear == null)
            {
                throw new InvalidDataException("FiscalYear is a required property for POSTAccountingPeriodType and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for POSTAccountingPeriodType and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (StartDate == null)
            {
                throw new InvalidDataException("StartDate is a required property for POSTAccountingPeriodType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTAccountingPeriodType);
        }

        /// <summary>
        /// Returns true if POSTAccountingPeriodType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTAccountingPeriodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountingPeriodType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
