...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateImport :  IEquatable<ProxyCreateImport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateImport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateImport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateImport" /> class.
        /// </summary>
        /// <param name="ImportType"> The type of item imported. **Character limit**: 7 **Values**: Usage  (required).</param>
        /// <param name="ImportedCount">The number of records successfully imported. **Character limit**: **Values**: automatically generated  (required).</param>
        /// <param name="Md5"> A check to validate the import file&#39;s integrity. **Character limi**t: 32 **System-generated**: no **Values**: a string of 32 characters or fewer .</param>
        /// <param name="Name"> A descriptive name for the import. **Character limi**t: 100 **Values**: one of the following:  - a string of 100 characters or fewer - if NULL default is:&#x60; import &lt;ImportType_value&gt;&#x60; .</param>
        /// <param name="OriginalResourceUrl"> The URL for your import file, which contains your records for upload. When you upload the file, Zuora assigns it to this address. **Character limit**: **Values**: automatic dynamically-generated URL  (required).</param>
        /// <param name="ResultResourceUrl"> The URL for the import result file, which is a zipped CSV file. **Character limit**: **Values**: automatic dynamically-generated URL  (required).</param>
        /// <param name="Status">The status of the import process. **Character limit**: 10 **Values**: automatically generated using one of the following values:  - Pending - Processing - Completed - Failed .</param>
        /// <param name="StatusReason"> The reason for the system-generated status. Use this information if the import fails. **Character limit**: 2000 **Values**: automatically generated error message .</param>
        /// <param name="TotalCount"> The number of records in the import file. **Character limit**: **Values**: automatically generated  (required).</param>
        public ProxyCreateImport(string ImportType = null, int? ImportedCount = null, string Md5 = null, string Name = null, string OriginalResourceUrl = null, string ResultResourceUrl = null, string Status = null, string StatusReason = null, int? TotalCount = null)
        {
            // to ensure "ImportType" is required (not null)
            if (ImportType == null)
            {
                throw new InvalidDataException("ImportType is a required property for ProxyCreateImport and cannot be null");
            }
            else
            {
                this.ImportType = ImportType;
            }
            // to ensure "ImportedCount" is required (not null)
            if (ImportedCount == null)
            {
                throw new InvalidDataException("ImportedCount is a required property for ProxyCreateImport and cannot be null");
            }
            else
            {
                this.ImportedCount = ImportedCount;
            }
            // to ensure "OriginalResourceUrl" is required (not null)
            if (OriginalResourceUrl == null)
            {
                throw new InvalidDataException("OriginalResourceUrl is a required property for ProxyCreateImport and cannot be null");
            }
            else
            {
                this.OriginalResourceUrl = OriginalResourceUrl;
            }
            // to ensure "ResultResourceUrl" is required (not null)
            if (ResultResourceUrl == null)
            {
                throw new InvalidDataException("ResultResourceUrl is a required property for ProxyCreateImport and cannot be null");
            }
            else
            {
            ...
            if (TotalCount == null)
            {
                throw new InvalidDataException("TotalCount is a required property for ProxyCreateImport and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateImport);
        }

        /// <summary>
        /// Returns true if ProxyCreateImport instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateImport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateImport other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.ImportedCount.Equals(other.ImportedCount)
                ) && 
                (
                    this.Md5 == other.Md5 ||
                    this.Md5 != null &&
                ...
                (
                    this.OriginalResourceUrl == other.OriginalResourceUrl ||
                    this.OriginalResourceUrl != null &&
                    this.OriginalResourceUrl.Equals(other.OriginalResourceUrl)
                ) && 
                (
                    this.ResultResourceUrl == other.ResultResourceUrl ||
                    this.ResultResourceUrl != null &&
                    this.ResultResourceUrl.Equals(other.ResultResourceUrl)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ImportedCount != null)
                    hash = hash * 59 + this.ImportedCount.GetHashCode();
                if (this.Md5 != null)
                    hash = hash * 59 + this.Md5.GetHashCode();
                if (this.Name != null)
                    hash = hash * 59 + this.Name.GetHashCode();
                if (this.OriginalResourceUrl != null)
                    hash = hash * 59 + this.OriginalResourceUrl.GetHashCode();
                if (this.ResultResourceUrl != null)
                    hash = hash * 59 + this.ResultResourceUrl.GetHashCode();
                if (this.Status != null)
