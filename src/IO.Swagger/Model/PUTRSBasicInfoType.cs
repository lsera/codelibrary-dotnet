...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTRSBasicInfoType :  IEquatable<PUTRSBasicInfoType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTRSBasicInfoType" /> class.
        /// </summary>
        ...
        /// <param name="ReferenceId">Reference ID is used only in the custom unlimited rule to create a revenue schedule. In this scenario, the revenue schedule is not linked to an invoice item or invoice item adjustment.  Use this field only when the revenue schedule is not linked to an invoice item or invoice item adjustment, such as for revenue schedules based on the Custom - Unlimited recognition model.  .</param>
        public PUTRSBasicInfoType(string CustomFieldC = null, string Notes = null, string ReferenceId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTRSBasicInfoType);
        }

        /// <summary>
        /// Returns true if PUTRSBasicInfoType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTRSBasicInfoType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTRSBasicInfoType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
