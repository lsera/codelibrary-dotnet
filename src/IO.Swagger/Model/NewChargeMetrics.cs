...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewChargeMetrics :  IEquatable<NewChargeMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewChargeMetrics" /> class.
        /// </summary>
        /// <param name="ChargeNumber">.</param>
        /// <param name="DMRR">.</param>
        /// <param name="DTCV">.</param>
        /// <param name="MRR">.</param>
        /// <param name="OriginalId">.</param>
        /// <param name="OriginalRatePlanId">.</param>
        /// <param name="ProductRatePlanChargeId">.</param>
        /// <param name="ProductRatePlanId">.</param>
        /// <param name="TCV">.</param>
        public NewChargeMetrics(string ChargeNumber = null, double? DMRR = null, double? DTCV = null, double? MRR = null, string OriginalId = null, string OriginalRatePlanId = null, string ProductRatePlanChargeId = null, string ProductRatePlanId = null, double? TCV = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NewChargeMetrics);
        }

        /// <summary>
        /// Returns true if NewChargeMetrics instances are equal
        /// </summary>
        /// <param name="other">Instance of NewChargeMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewChargeMetrics other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.OriginalRatePlanId == other.OriginalRatePlanId ||
                    this.OriginalRatePlanId != null &&
                    this.OriginalRatePlanId.Equals(other.OriginalRatePlanId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OriginalRatePlanId != null)
                    hash = hash * 59 + this.OriginalRatePlanId.GetHashCode();
