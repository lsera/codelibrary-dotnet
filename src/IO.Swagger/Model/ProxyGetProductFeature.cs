...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetProductFeature :  IEquatable<ProxyGetProductFeature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetProductFeature" /> class.
        /// </summary>
        /// <param name="CreatedById">The ID of the Zuora user who created the Account object. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate">The date when the Account object was created. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="FeatureId"> Internal Zuora ID of the product feature. This field is not editable. **Character limit**: 32 **Values**: a string of 32 characters or fewer .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="ProductId"> Id of the product to which the feature belongs. This field is not editable. **Character limit**: 32 **Values**: a string of 32 characters or fewer .</param>
        /// <param name="UpdatedById">The ID of the user who last updated the account. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="UpdatedDate">The date when the account was last updated. **Character limit**: 29 **Values**: automatically generated .</param>
        public ProxyGetProductFeature(string CreatedById = null, DateTime? CreatedDate = null, string FeatureId = null, string Id = null, string ProductId = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetProductFeature);
        }

        /// <summary>
        /// Returns true if ProxyGetProductFeature instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetProductFeature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetProductFeature other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
