...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETProductRatePlanChargePricingTierType :  IEquatable<GETProductRatePlanChargePricingTierType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETProductRatePlanChargePricingTierType" /> class.
        /// </summary>
        /// <param name="EndingUnit">Decimal defining end of tier range. .</param>
        /// <param name="Price">The decimal value of the tiered charge model. If the charge model is not a tiered type then this price field will be null and the price field directly under the productRatePlanCharges applies. .</param>
        /// <param name="PriceFormat">Tier price format.  Allowed values: - flat fee  - per unit .</param>
        /// <param name="StartingUnit">Decimal defining start of tier range. .</param>
        /// <param name="Tier">Unique number of the tier. .</param>
        public GETProductRatePlanChargePricingTierType(string EndingUnit = null, string Price = null, string PriceFormat = null, string StartingUnit = null, long? Tier = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETProductRatePlanChargePricingTierType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETProductRatePlanChargePricingTierType);
        }

        /// <summary>
        /// Returns true if GETProductRatePlanChargePricingTierType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETProductRatePlanChargePricingTierType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductRatePlanChargePricingTierType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
