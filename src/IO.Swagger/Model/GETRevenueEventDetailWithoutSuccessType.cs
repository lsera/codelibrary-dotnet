...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETRevenueEventDetailWithoutSuccessType :  IEquatable<GETRevenueEventDetailWithoutSuccessType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRevenueEventDetailWithoutSuccessType" /> class.
        /// </summary>
        ...
        /// <param name="Number">The revenue event number created when a revenue event occurs. .</param>
        /// <param name="RecognitionEnd"> The end date of a recognition period in YYYY-MM-DD format.   The maximum difference of the recognitionStart and recognitionEnd date fields is equal to 250 multiplied by the length of an accounting period. .</param>
        /// <param name="RecognitionStart">The start date of a recognition period in YYYY-MM-DD format. .</param>
        ...
        public GETRevenueEventDetailWithoutSuccessType(string AccountId = null, DateTime? CreatedOn = null, string Currency = null, string CustomFieldC = null, string EventType = null, string Notes = null, string Number = null, DateTime? RecognitionEnd = null, DateTime? RecognitionStart = null, List<GETRevenueItemType> RevenueItems = null, string SubscriptionChargeId = null, string SubscriptionId = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRevenueEventDetailWithoutSuccessType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETRevenueEventDetailWithoutSuccessType);
        }

        /// <summary>
        /// Returns true if GETRevenueEventDetailWithoutSuccessType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETRevenueEventDetailWithoutSuccessType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRevenueEventDetailWithoutSuccessType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
