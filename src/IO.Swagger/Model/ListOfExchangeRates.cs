...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListOfExchangeRates :  IEquatable<ListOfExchangeRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOfExchangeRates" /> class.
        /// </summary>
        /// <param name="CURRENCY">The exchange rate on the **providerExchangeRateDate**. The field name is the ISO currency code of the currency, for example, &#x60;EUR&#x60;.  There may be more than one currency returned for a given **providerExchangeRateDate**. If the rate for a certain currency is not available on the **providerExchangeRateDate**, the currency is not returned in the response. .</param>
        /// <param name="ProviderExchangeRateDate">The date of the exchange rate used. The date is in &#x60;yyyy-mm-dd&#x60; format.  Corresponds to the value specified in the Provider Exchange Rate Date column in the Import Foreign Exchange Rates template when you uploaded the rates through the Mass Updater. .</param>
        public ListOfExchangeRates(string CURRENCY = null, DateTime? ProviderExchangeRateDate = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListOfExchangeRates {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListOfExchangeRates);
        }

        /// <summary>
        /// Returns true if ListOfExchangeRates instances are equal
        /// </summary>
        /// <param name="other">Instance of ListOfExchangeRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListOfExchangeRates other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProviderExchangeRateDate == other.ProviderExchangeRateDate ||
                    this.ProviderExchangeRateDate != null &&
                    this.ProviderExchangeRateDate.Equals(other.ProviderExchangeRateDate)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProviderExchangeRateDate != null)
                    hash = hash * 59 + this.ProviderExchangeRateDate.GetHashCode();
                return hash;
            }
        }
