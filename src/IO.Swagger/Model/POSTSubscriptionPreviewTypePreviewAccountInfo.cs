...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSubscriptionPreviewTypePreviewAccountInfo :  IEquatable<POSTSubscriptionPreviewTypePreviewAccountInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionPreviewTypePreviewAccountInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTSubscriptionPreviewTypePreviewAccountInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionPreviewTypePreviewAccountInfo" /> class.
        /// </summary>
        /// <param name="BillCycleDay">The account&#39;s bill cycle day (BCD), when bill runs generate invoices for the account. Specify any day of the month (&#x60;1&#x60;-&#x60;31&#x60;, where &#x60;31&#x60; &#x3D; end-of-month), or &#x60;0&#x60; for auto-set.  (required).</param>
        /// <param name="BillToContact">BillToContact.</param>
        /// <param name="Currency">A currency as defined in (Billing Settings)[https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Customize_Currencies]. .</param>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        public POSTSubscriptionPreviewTypePreviewAccountInfo(long? BillCycleDay = null, POSTSubscriptionPreviewTypePreviewAccountInfoBillToContact BillToContact = null, string Currency = null, string CustomFieldC = null)
        {
            // to ensure "BillCycleDay" is required (not null)
            if (BillCycleDay == null)
            {
                throw new InvalidDataException("BillCycleDay is a required property for POSTSubscriptionPreviewTypePreviewAccountInfo and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionPreviewTypePreviewAccountInfo);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionPreviewTypePreviewAccountInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionPreviewTypePreviewAccountInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionPreviewTypePreviewAccountInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
