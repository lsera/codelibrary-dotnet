...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTRevenueScheduleByDateRangeType :  IEquatable<POSTRevenueScheduleByDateRangeType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTRevenueScheduleByDateRangeType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTRevenueScheduleByDateRangeType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTRevenueScheduleByDateRangeType" /> class.
        /// </summary>
        ...
        public POSTRevenueScheduleByDateRangeType(string CustomFieldC = null, string DistributionType = null, string Notes = null, DateTime? RecognitionEnd = null, DateTime? RecognitionStart = null, POSTRevenueScheduleByDateRangeTypeRevenueEvent RevenueEvent = null)
        {
            // to ensure "RecognitionEnd" is required (not null)
            if (RecognitionEnd == null)
            {
                throw new InvalidDataException("RecognitionEnd is a required property for POSTRevenueScheduleByDateRangeType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RecognitionStart is a required property for POSTRevenueScheduleByDateRangeType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTRevenueScheduleByDateRangeType);
        }

        /// <summary>
        /// Returns true if POSTRevenueScheduleByDateRangeType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTRevenueScheduleByDateRangeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTRevenueScheduleByDateRangeType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
