...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateAccount :  IEquatable<ProxyCreateAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAccount" /> class.
        /// </summary>
        ...
        /// <param name="Balance">Current outstanding balance for the account. **Character limit**: 16 **Values**: automatically generated  (required).</param>
        ...
        /// <param name="BcdSettingOption">Billing cycle day setting option. **Character limit**: 9 **Values**: &#x60;AutoSet&#x60;, &#x60;ManualSet&#x60;  (required).</param>
        ...
        /// <param name="CreditBalance">Total credit balance for the account. **Character limit**: 16 **Values**: automatically generated  (required).</param>
        ...
        /// <param name="Status">Status of the account in the system. **Character limit**: 8 **Values**: one of the following:  - leave null if you&#39;re using &#x60;subscribe()&#x60; - if you&#39;re using &#x60;create()&#x60;: - &#x60;Draft&#x60; - &#x60;Active&#x60; - &#x60;Canceled&#x60;  (required).</param>
        ...
        /// <param name="TotalInvoiceBalance">Total balance of the account&#39;s invoices. **Character limit**: 16 **Values**: a valid currency value  (required).</param>
        ...
        public ProxyCreateAccount(string AccountNumber = null, string AdditionalEmailAddresses = null, bool? AllowInvoiceEdit = null, bool? AutoPay = null, double? Balance = null, string Batch = null, string BcdSettingOption = null, int? BillCycleDay = null, string BillToId = null, string CommunicationProfileId = null, double? CreditBalance = null, string CrmId = null, string Currency = null, string CustomerServiceRepName = null, string DefaultPaymentMethodId = null, bool? InvoiceDeliveryPrefsEmail = null, bool? InvoiceDeliveryPrefsPrint = null, string InvoiceTemplateId = null, string Name = null, string Notes = null, string ParentId = null, string PaymentGateway = null, string PaymentTerm = null, string PurchaseOrderNumber = null, string SalesRepName = null, string SoldToId = null, string Status = null, string TaxCompanyCode = null, string TaxExemptCertificateID = null, string TaxExemptCertificateType = null, string TaxExemptDescription = null, DateTime? TaxExemptEffectiveDate = null, DateTime? TaxExemptExpirationDate = null, string TaxExemptIssuingJurisdiction = null, string TaxExemptStatus = null, double? TotalInvoiceBalance = null, string VATId = null)
        {
            ...
            // to ensure "BcdSettingOption" is required (not null)
            if (BcdSettingOption == null)
            {
                throw new InvalidDataException("BcdSettingOption is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("BillCycleDay is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
                this.BillCycleDay = BillCycleDay;
            }
            // to ensure "CreditBalance" is required (not null)
            if (CreditBalance == null)
            {
                throw new InvalidDataException("CreditBalance is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
            ...
            if (Currency == null)
            {
                throw new InvalidDataException("Currency is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
                this.Status = Status;
            }
            // to ensure "TotalInvoiceBalance" is required (not null)
            if (TotalInvoiceBalance == null)
            {
                throw new InvalidDataException("TotalInvoiceBalance is a required property for ProxyCreateAccount and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateAccount);
        }

        /// <summary>
        /// Returns true if ProxyCreateAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
