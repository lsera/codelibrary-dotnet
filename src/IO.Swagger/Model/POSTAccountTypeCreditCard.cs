...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTAccountTypeCreditCard :  IEquatable<POSTAccountTypeCreditCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeCreditCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTAccountTypeCreditCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeCreditCard" /> class.
        /// </summary>
        /// <param name="CardHolderInfo">CardHolderInfo.</param>
        /// <param name="CardNumber">Card number, up to 16 characters. Once created, this field can&#39;t be updated or queried, and is only available in masked format (e.g., XXXX-XXXX-XXXX-1234).  (required).</param>
        /// <param name="CardType">Possible values are: &#x60;Visa&#x60;, &#x60;MasterCard&#x60;, &#x60;AmericanExpress&#x60;, &#x60;Discover&#x60;.  (required).</param>
        ...
        /// <param name="SecurityCode">The CVV or CVV2 security code of the card. To ensure PCI compliance, this value isn&#39;t stored and can&#39;t be queried. For more information, see [How do I control what information Zuora sends over to the Payment Gateway?](https://knowledgecenter.zuora.com/kb/How_do_I_control_information_sent_to_payment_gateways_when_verifying_payment_methods%3F). .</param>
        public POSTAccountTypeCreditCard(POSTAccountTypeCreditCardCardHolderInfo CardHolderInfo = null, string CardNumber = null, string CardType = null, string ExpirationMonth = null, string ExpirationYear = null, string SecurityCode = null)
        {
            // to ensure "CardNumber" is required (not null)
            if (CardNumber == null)
            {
                throw new InvalidDataException("CardNumber is a required property for POSTAccountTypeCreditCard and cannot be null");
            }
            else
            {
            ...
            if (CardType == null)
            {
                throw new InvalidDataException("CardType is a required property for POSTAccountTypeCreditCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationMonth is a required property for POSTAccountTypeCreditCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationYear is a required property for POSTAccountTypeCreditCard and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTAccountTypeCreditCard);
        }

        /// <summary>
        /// Returns true if POSTAccountTypeCreditCard instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTAccountTypeCreditCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountTypeCreditCard other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
