...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExternalPaymentOptions :  IEquatable<ExternalPaymentOptions>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="GatewayOrderId">.</param>
        /// <param name="PaymentMethodId">.</param>
        /// <param name="ReferenceId">.</param>
        public ExternalPaymentOptions(double? Amount = null, DateTime? EffectiveDate = null, string GatewayOrderId = null, string PaymentMethodId = null, string ReferenceId = null)
        {
            this.Amount = Amount;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExternalPaymentOptions);
        }

        /// <summary>
        /// Returns true if ExternalPaymentOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of ExternalPaymentOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalPaymentOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
