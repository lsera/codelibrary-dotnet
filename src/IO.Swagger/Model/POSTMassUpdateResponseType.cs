...
namespace IO.Swagger.Model
{
    ...
    public partial class POSTMassUpdateResponseType :  IEquatable<POSTMassUpdateResponseType>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTMassUpdateResponseType);
        }

        /// <summary>
        /// Returns true if POSTMassUpdateResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTMassUpdateResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTMassUpdateResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.BulkKey == other.BulkKey ||
                    this.BulkKey != null &&
                    this.BulkKey.Equals(other.BulkKey)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BulkKey != null)
                    hash = hash * 59 + this.BulkKey.GetHashCode();
