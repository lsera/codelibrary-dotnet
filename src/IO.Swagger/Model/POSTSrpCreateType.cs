...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSrpCreateType :  IEquatable<POSTSrpCreateType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSrpCreateType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTSrpCreateType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSrpCreateType" /> class.
        /// </summary>
        ...
        public POSTSrpCreateType(List<POSTScCreateType> ChargeOverrides = null, string CustomFieldC = null, string ProductRatePlanId = null)
        {
            // to ensure "ProductRatePlanId" is required (not null)
            if (ProductRatePlanId == null)
            {
                throw new InvalidDataException("ProductRatePlanId is a required property for POSTSrpCreateType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSrpCreateType);
        }

        /// <summary>
        /// Returns true if POSTSrpCreateType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSrpCreateType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSrpCreateType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
