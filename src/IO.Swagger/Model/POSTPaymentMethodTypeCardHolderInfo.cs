...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTPaymentMethodTypeCardHolderInfo :  IEquatable<POSTPaymentMethodTypeCardHolderInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPaymentMethodTypeCardHolderInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTPaymentMethodTypeCardHolderInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPaymentMethodTypeCardHolderInfo" /> class.
        /// </summary>
        ...
        /// <param name="Country">Country, must be a [valid country name or abbreviation](https://knowledgecenter.zuora.com/BC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/A_Country_Names_and_Their_ISO_Codes).  (required).</param>
        ...
        /// <param name="State">State; must be a [valid state name or 2-character abbreviation](https://knowledgecenter.zuora.com/BC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/B_State_Names_and_2-Digit_Codes).  (required).</param>
        /// <param name="ZipCode">Zip code, 20 characters or less.  (required).</param>
        public POSTPaymentMethodTypeCardHolderInfo(string AddressLine1 = null, string AddressLine2 = null, string CardHolderName = null, string City = null, string Country = null, string Email = null, string Phone = null, string State = null, string ZipCode = null)
        {
            // to ensure "CardHolderName" is required (not null)
            if (CardHolderName == null)
            {
                throw new InvalidDataException("CardHolderName is a required property for POSTPaymentMethodTypeCardHolderInfo and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for POSTPaymentMethodTypeCardHolderInfo and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for POSTPaymentMethodTypeCardHolderInfo and cannot be null");
            }
            else
            {
            ...
            if (State == null)
            {
                throw new InvalidDataException("State is a required property for POSTPaymentMethodTypeCardHolderInfo and cannot be null");
            }
            else
            {
                this.State = State;
            ...
            if (ZipCode == null)
            {
                throw new InvalidDataException("ZipCode is a required property for POSTPaymentMethodTypeCardHolderInfo and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTPaymentMethodTypeCardHolderInfo);
        }

        /// <summary>
        /// Returns true if POSTPaymentMethodTypeCardHolderInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTPaymentMethodTypeCardHolderInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPaymentMethodTypeCardHolderInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
