...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountTypeBasicInfo :  IEquatable<GETAccountTypeBasicInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountTypeBasicInfo" /> class.
        /// </summary>
        /// <param name="AccountNumber">Account number. .</param>
        /// <param name="Batch">The alias name given to a batch. A string of 50 characters or less. .</param>
        /// <param name="CommunicationProfileId">ID of a [communication profile](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Communication_Profile). .</param>
        /// <param name="CrmId">CRM account ID for the account, 100 characters or less. .</param>
        ...
        /// <param name="Notes">Notes associated with the account, up to 65,535 characters. .</param>
        /// <param name="Status">Account status; possible values are: &#x60;Active&#x60;, &#x60;Draft&#x60;, &#x60;Canceled&#x60;. .</param>
        /// <param name="Tags">dummy.</param>
        public GETAccountTypeBasicInfo(string AccountNumber = null, string Batch = null, string CommunicationProfileId = null, string CrmId = null, string CustomFieldC = null, string Id = null, string InvoiceTemplateId = null, string Name = null, string Notes = null, string Status = null, string Tags = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountTypeBasicInfo);
        }

        /// <summary>
        /// Returns true if GETAccountTypeBasicInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountTypeBasicInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeBasicInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
