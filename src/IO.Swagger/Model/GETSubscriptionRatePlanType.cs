...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETSubscriptionRatePlanType :  IEquatable<GETSubscriptionRatePlanType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETSubscriptionRatePlanType" /> class.
        /// </summary>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="Id">Rate plan ID. .</param>
        /// <param name="LastChangeType">The last amendment on the rate plan.  Possible Values:  * &#x60;Add&#x60; * &#x60;Update&#x60; * &#x60;Remove&#x60; .</param>
        /// <param name="ProductId">.</param>
        /// <param name="ProductName">.</param>
        /// <param name="ProductRatePlanId">.</param>
        /// <param name="ProductSku">The unique SKU for the product. .</param>
        /// <param name="RatePlanCharges">Container for one or more charges. .</param>
        /// <param name="RatePlanName">Name of the rate plan. .</param>
        /// <param name="SubscriptionProductFeatures">Container for one or more features.   Only available when the following settings are enabled:  * The Entitlements feature in your tenant. * The [Enable Feature Specification in Product and Subscriptions](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Enable_Feature_Specification_in_Products_and_Subscriptions.3F) setting in Billing Settings. .</param>
        public GETSubscriptionRatePlanType(string CustomFieldC = null, string Id = null, string LastChangeType = null, string ProductId = null, string ProductName = null, string ProductRatePlanId = null, string ProductSku = null, List<GETSubscriptionRatePlanChargesType> RatePlanCharges = null, string RatePlanName = null, List<GETSubscriptionProductFeatureType> SubscriptionProductFeatures = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETSubscriptionRatePlanType);
        }

        /// <summary>
        /// Returns true if GETSubscriptionRatePlanType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETSubscriptionRatePlanType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETSubscriptionRatePlanType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.LastChangeType == other.LastChangeType ||
                    this.LastChangeType != null &&
                    this.LastChangeType.Equals(other.LastChangeType)
                ) && 
                (
                ...
                (
                    this.RatePlanCharges == other.RatePlanCharges ||
                    this.RatePlanCharges != null &&
                    this.RatePlanCharges.SequenceEqual(other.RatePlanCharges)
                ) && 
                (
                    this.RatePlanName == other.RatePlanName ||
                    this.RatePlanName != null &&
                    this.RatePlanName.Equals(other.RatePlanName)
                ) && 
                (
                    this.SubscriptionProductFeatures == other.SubscriptionProductFeatures ||
                    this.SubscriptionProductFeatures != null &&
                    this.SubscriptionProductFeatures.SequenceEqual(other.SubscriptionProductFeatures)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastChangeType != null)
                    hash = hash * 59 + this.LastChangeType.GetHashCode();
                ...
                if (this.RatePlanCharges != null)
                    hash = hash * 59 + this.RatePlanCharges.GetHashCode();
                if (this.RatePlanName != null)
                    hash = hash * 59 + this.RatePlanName.GetHashCode();
                if (this.SubscriptionProductFeatures != null)
                    hash = hash * 59 + this.SubscriptionProductFeatures.GetHashCode();
                return hash;
            }
        }
