...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETProductRatePlanType :  IEquatable<GETProductRatePlanType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETProductRatePlanType" /> class.
        /// </summary>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="Description">Rate plan description. .</param>
        /// <param name="EffectiveEndDate">Final date the rate plan is active, as &#x60;yyyy-mm-dd&#x60;. After this date, the rate plan status is &#x60;Expired&#x60;. .</param>
        /// <param name="EffectiveStartDate">First date the rate plan is active (i.e., available to be subscribed to), as &#x60;yyyy-mm-dd&#x60;.  Before this date, the status is &#x60;NotStarted&#x60;. .</param>
        ...
        /// <param name="ProductRatePlanCharges">Field attributes describing the product rate plan charges: .</param>
        /// <param name="Status">Possible vales are: &#x60;Active&#x60;, &#x60;Expired&#x60;, &#x60;NotStarted&#x60;. .</param>
        public GETProductRatePlanType(string CustomFieldC = null, string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Id = null, string Name = null, List<GETProductRatePlanChargeType> ProductRatePlanCharges = null, string Status = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETProductRatePlanType);
        }

        /// <summary>
        /// Returns true if GETProductRatePlanType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETProductRatePlanType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductRatePlanType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProductRatePlanCharges == other.ProductRatePlanCharges ||
                    this.ProductRatePlanCharges != null &&
                    this.ProductRatePlanCharges.SequenceEqual(other.ProductRatePlanCharges)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProductRatePlanCharges != null)
                    hash = hash * 59 + this.ProductRatePlanCharges.GetHashCode();
                if (this.Status != null)
