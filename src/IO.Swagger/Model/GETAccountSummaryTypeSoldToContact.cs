...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountSummaryTypeSoldToContact :  IEquatable<GETAccountSummaryTypeSoldToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummaryTypeSoldToContact" /> class.
        /// </summary>
        ...
        /// <param name="Country">[A valid country name or abbreviation](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/A_Country_Names_and_Their_ISO_Codes). .</param>
        /// <param name="County">County; 32 characters or less. [Z-Tax](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/L_Taxes/A_Z-Tax) uses this information to calculate county taxation.           .</param>
        ...
        /// <param name="FirstName">First name, 100 characters or less. .</param>
        /// <param name="Id">Contact ID. .</param>
        /// <param name="LastName">Last name, 100 characters or less. .</param>
        /// <param name="State">[State name or 2-character abbreviation](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/B_State_Names_and_2-Digit_Codes). .</param>
        /// <param name="TaxRegion">A region string, defined in your [Z-Tax](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/L_Taxes/A_Z-Tax) tax rules. .</param>
        ...
        public GETAccountSummaryTypeSoldToContact(string Address1 = null, string Address2 = null, string City = null, string Country = null, string County = null, string CustomFieldC = null, string Fax = null, string FirstName = null, string Id = null, string LastName = null, string State = null, string TaxRegion = null, string WorkEmail = null, string WorkPhone = null, string ZipCode = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETAccountSummaryTypeSoldToContact {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountSummaryTypeSoldToContact);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeSoldToContact instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountSummaryTypeSoldToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeSoldToContact other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
