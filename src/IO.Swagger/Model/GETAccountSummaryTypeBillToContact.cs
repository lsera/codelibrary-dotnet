...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountSummaryTypeBillToContact :  IEquatable<GETAccountSummaryTypeBillToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummaryTypeBillToContact" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountSummaryTypeBillToContact);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeBillToContact instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountSummaryTypeBillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeBillToContact other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
