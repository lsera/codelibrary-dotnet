...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateProductRatePlan :  IEquatable<ProxyCreateProductRatePlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateProductRatePlan" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateProductRatePlan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateProductRatePlan" /> class.
        /// </summary>
        ...
        /// <param name="Name">The name of the product rate plan. The name doesn&#39;t have to be unique in a Product Catalog, but the name has to be unique within a product. **Character limit**: 100 **Values**: a string of 100 characters or fewer  (required).</param>
        ...
        public ProxyCreateProductRatePlan(string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Name = null, string ProductId = null)
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for ProxyCreateProductRatePlan and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateProductRatePlan);
        }

        /// <summary>
        /// Returns true if ProxyCreateProductRatePlan instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateProductRatePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateProductRatePlan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
