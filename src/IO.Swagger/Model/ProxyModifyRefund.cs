...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyRefund :  IEquatable<ProxyModifyRefund>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyRefund" /> class.
        /// </summary>
        ...
        public ProxyModifyRefund(string ReasonCode = null, string Status = null, string TransferredToAccounting = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyRefund);
        }

        /// <summary>
        /// Returns true if ProxyModifyRefund instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyRefund other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
