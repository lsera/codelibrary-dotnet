...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTRevenueScheduleByTransactionType :  IEquatable<POSTRevenueScheduleByTransactionType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTRevenueScheduleByTransactionType" /> class.
        /// </summary>
        ...
        /// <param name="RevenueDistributions">An array of revenue distributions. Represents how you want to distribute revenue for this revenue schedule. You can distribute revenue into a maximum of 250 accounting periods with one revenue schedule.  The sum of newAmounts must equal the the Charge Amount of the specified Invoice Item. .</param>
        /// <param name="RevenueEvent">RevenueEvent.</param>
        public POSTRevenueScheduleByTransactionType(string CustomFieldC = null, string Notes = null, List<POSTDistributionItemType> RevenueDistributions = null, POSTRevenueScheduleByTransactionTypeRevenueEvent RevenueEvent = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTRevenueScheduleByTransactionType);
        }

        /// <summary>
        /// Returns true if POSTRevenueScheduleByTransactionType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTRevenueScheduleByTransactionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTRevenueScheduleByTransactionType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
