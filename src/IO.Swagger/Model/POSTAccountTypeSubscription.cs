...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTAccountTypeSubscription :  IEquatable<POSTAccountTypeSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeSubscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTAccountTypeSubscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeSubscription" /> class.
        /// </summary>
        /// <param name="CpqBundleJsonIdQT">dummy.</param>
        /// <param name="OpportunityCloseDateQT">dummy.</param>
        /// <param name="OpportunityNameQT">dummy.</param>
        /// <param name="QuoteBusinessTypeQT">dummy.</param>
        /// <param name="QuoteNumberQT">dummy.</param>
        /// <param name="QuoteTypeQT">dummy.</param>
        /// <param name="AutoRenew">If &#x60;true&#x60;, auto-renew is enabled. Default is &#x60;false&#x60;. .</param>
        ...
        /// <param name="InitialTerm">Duration of the initial subscription term in whole months.  Default is 0.  .</param>
        /// <param name="InvoiceOwnerAccountKey">Invoice owner account number or ID.  **Note:** This feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](https://support.zuora.com).  .</param>
        ...
        /// <param name="Notes">dummy.</param>
        /// <param name="RenewalTerm">Duration of the renewal term in whole months. Default is 0. .</param>
        ...
        /// <param name="SubscribeToRatePlans">Container for one or more rate plans for this subscription. .</param>
        /// <param name="SubscriptionNumber">Subscription Number. The value can be up to 1000 characters.  If you do not specify a subscription number when creating a subscription for the new account, Zuora will generate a subscription number automatically.  If the account is created successfully, the subscription number is returned in the &#x60;subscriptionNumber&#x60; response field. .</param>
        ...
        /// <param name="TermType">Possible values are: &#x60;TERMED&#x60;, &#x60;EVERGREEN&#x60;. See [Subscriptions](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions) for more information.  (required).</param>
        public POSTAccountTypeSubscription(string CpqBundleJsonIdQT = null, string OpportunityCloseDateQT = null, string OpportunityNameQT = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, bool? AutoRenew = null, DateTime? ContractEffectiveDate = null, string CustomFieldC = null, DateTime? CustomerAcceptanceDate = null, long? InitialTerm = null, string InvoiceOwnerAccountKey = null, bool? InvoiceSeparately = null, string Notes = null, long? RenewalTerm = null, DateTime? ServiceActivationDate = null, List<POSTSrpCreateType> SubscribeToRatePlans = null, string SubscriptionNumber = null, DateTime? TermStartDate = null, string TermType = null)
        {
            // to ensure "ContractEffectiveDate" is required (not null)
            if (ContractEffectiveDate == null)
            {
                throw new InvalidDataException("ContractEffectiveDate is a required property for POSTAccountTypeSubscription and cannot be null");
            }
            else
            {
            ...
            if (TermType == null)
            {
                throw new InvalidDataException("TermType is a required property for POSTAccountTypeSubscription and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTAccountTypeSubscription);
        }

        /// <summary>
        /// Returns true if POSTAccountTypeSubscription instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTAccountTypeSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountTypeSubscription other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
