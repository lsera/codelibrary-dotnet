...
namespace IO.Swagger.Model
{
    ...
    public partial class InvoiceData :  IEquatable<InvoiceData>, IValidatableObject
    {
        ...
        public InvoiceData(Invoice Invoice = null, List<InvoiceItem> InvoiceItem = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoiceData);
        }

        /// <summary>
        /// Returns true if InvoiceData instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoiceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceData other)
        {
            ...
            return 
                ...
                (
                    this.InvoiceItem == other.InvoiceItem ||
                    this.InvoiceItem != null &&
                    this.InvoiceItem.SequenceEqual(other.InvoiceItem)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvoiceItem != null)
                    hash = hash * 59 + this.InvoiceItem.GetHashCode();
                return hash;
            }
        }
