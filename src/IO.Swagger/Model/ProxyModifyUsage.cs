...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyUsage :  IEquatable<ProxyModifyUsage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyUsage" /> class.
        /// </summary>
        ...
        public ProxyModifyUsage(DateTime? EndDateTime = null, double? Quantity = null, string RbeStatus = null, DateTime? StartDateTime = null, DateTime? SubmissionDateTime = null, string UOM = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyUsage);
        }

        /// <summary>
        /// Returns true if ProxyModifyUsage instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyUsage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
