...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyInvoice :  IEquatable<ProxyModifyInvoice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyInvoice" /> class.
        /// </summary>
        ...
        public ProxyModifyInvoice(string Status = null, string TransferredToAccounting = null)
        {
            this.Status = Status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyInvoice {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyInvoice);
        }

        /// <summary>
        /// Returns true if ProxyModifyInvoice instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyInvoice other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
