...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSubscriptionPreviewResponseTypeChargeMetrics :  IEquatable<POSTSubscriptionPreviewResponseTypeChargeMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionPreviewResponseTypeChargeMetrics" /> class.
        /// </summary>
        /// <param name="Dmrr">Change in monthly recurring revenue. .</param>
        /// <param name="Dtcv">Change in total contract value. .</param>
        /// <param name="Mrr">Monthly recurring revenue. .</param>
        /// <param name="Number">The charge number of the subscription. Only available for update subscription. .</param>
        /// <param name="OriginRatePlanId">The origin rate plan ID. Only available for update subscription. .</param>
        /// <param name="OriginalId">The original rate plan charge ID. Only available for update subscription. .</param>
        /// <param name="ProductRatePlanChargeId">The product rate plan charge ID. .</param>
        /// <param name="ProductRatePlanId">The product rate plan ID. .</param>
        /// <param name="Tcv">Total contract value. .</param>
        public POSTSubscriptionPreviewResponseTypeChargeMetrics(string Dmrr = null, string Dtcv = null, string Mrr = null, string Number = null, string OriginRatePlanId = null, string OriginalId = null, string ProductRatePlanChargeId = null, string ProductRatePlanId = null, string Tcv = null)
        {
            this.Dmrr = Dmrr;
            this.Dtcv = Dtcv;
            this.Mrr = Mrr;
        ...
        /// </summary>
        /// <value>The product rate plan charge ID. </value>
        ...
        /// </summary>
        /// <value>The product rate plan ID. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTSubscriptionPreviewResponseTypeChargeMetrics {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionPreviewResponseTypeChargeMetrics);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionPreviewResponseTypeChargeMetrics instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionPreviewResponseTypeChargeMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionPreviewResponseTypeChargeMetrics other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.Dmrr == other.Dmrr ||
                    this.Dmrr != null &&
                    this.Dmrr.Equals(other.Dmrr)
                ) && 
                (
                ...
                (
                    this.OriginRatePlanId == other.OriginRatePlanId ||
                    this.OriginRatePlanId != null &&
                    this.OriginRatePlanId.Equals(other.OriginRatePlanId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Dmrr != null)
                    hash = hash * 59 + this.Dmrr.GetHashCode();
                if (this.Dtcv != null)
                ...
                if (this.OriginRatePlanId != null)
                    hash = hash * 59 + this.OriginRatePlanId.GetHashCode();
