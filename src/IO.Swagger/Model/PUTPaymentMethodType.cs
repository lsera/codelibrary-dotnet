...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTPaymentMethodType :  IEquatable<PUTPaymentMethodType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTPaymentMethodType" /> class.
        /// </summary>
        ...
        /// <param name="CardHolderName">The full name as it appears on the card, e.g., \&quot;John J Smith\&quot;, 50 characters or less. .</param>
        /// <param name="City">City, 40 characters or less. .</param>
        /// <param name="Country">Country; must be a [valid country name or abbreviation](https://knowledgecenter.zuora.com/BC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/A_Country_Names_and_Their_ISO_Codes). .</param>
        ...
        /// <param name="ExpirationMonth">Two-digit expiration month (01-12). .</param>
        ...
        /// <param name="State">State; must be a [valid state name or 2-character abbreviation](https://knowledgecenter.zuora.com/BC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/B_State_Names_and_2-Digit_Codes). .</param>
        /// <param name="ZipCode">Zip code, 20 characters or less. .</param>
        public PUTPaymentMethodType(string AddressLine1 = null, string AddressLine2 = null, string CardHolderName = null, string City = null, string Country = null, bool? DefaultPaymentMethod = null, string Email = null, string ExpirationMonth = null, string ExpirationYear = null, string Phone = null, string SecurityCode = null, string State = null, string ZipCode = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTPaymentMethodType);
        }

        /// <summary>
        /// Returns true if PUTPaymentMethodType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTPaymentMethodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTPaymentMethodType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
