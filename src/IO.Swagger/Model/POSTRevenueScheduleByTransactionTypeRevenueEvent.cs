...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTRevenueScheduleByTransactionTypeRevenueEvent :  IEquatable<POSTRevenueScheduleByTransactionTypeRevenueEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTRevenueScheduleByTransactionTypeRevenueEvent" /> class.
        /// </summary>
        ...
        /// <param name="EventTypeSystemId">System ID of the revenue event type. Each eventType has a unique system ID. You can configure your revenue event type system IDs by navigating to **Settings &gt; Z-Finance Settings &gt; Configure Revenue Event Types** in the Zuora UI.  Required only if there is more than one revenue event type with the same label. .</param>
        /// <param name="Notes">Additional information about this record. .</param>
        public POSTRevenueScheduleByTransactionTypeRevenueEvent(string CustomFieldC = null, string EventType = null, string EventTypeSystemId = null, string Notes = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTRevenueScheduleByTransactionTypeRevenueEvent);
        }

        /// <summary>
        /// Returns true if POSTRevenueScheduleByTransactionTypeRevenueEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTRevenueScheduleByTransactionTypeRevenueEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTRevenueScheduleByTransactionTypeRevenueEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
