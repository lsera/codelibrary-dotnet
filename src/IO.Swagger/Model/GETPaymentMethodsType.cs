...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETPaymentMethodsType :  IEquatable<GETPaymentMethodsType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentMethodsType" /> class.
        /// </summary>
        /// <param name="CreditCards">Container for one or more credit or debit card records: .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        public GETPaymentMethodsType(List<GETPaymentMethodType> CreditCards = null, bool? Success = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETPaymentMethodsType);
        }

        /// <summary>
        /// Returns true if GETPaymentMethodsType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETPaymentMethodsType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentMethodsType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
