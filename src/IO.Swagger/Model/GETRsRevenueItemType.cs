...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETRsRevenueItemType :  IEquatable<GETRsRevenueItemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRsRevenueItemType" /> class.
        /// </summary>
        /// <param name="AccountingPeriodEndDate">The accounting period end date. The accounting period end date of the open-ended accounting period is null. .</param>
        /// <param name="AccountingPeriodName">Name of the accounting period. The open-ended accounting period is named &#x60;Open-Ended&#x60;.  .</param>
        /// <param name="AccountingPeriodStartDate">The accounting period start date. .</param>
        /// <param name="Amount">The amount of the revenue item. .</param>
        ...
        /// <param name="IsAccountingPeriodClosed">Indicates if the accounting period is closed or open. .</param>
        ...
        public GETRsRevenueItemType(DateTime? AccountingPeriodEndDate = null, string AccountingPeriodName = null, DateTime? AccountingPeriodStartDate = null, string Amount = null, string Currency = null, string CustomFieldC = null, string DeferredRevenueAccountingCode = null, string DeferredRevenueAccountingCodeType = null, bool? IsAccountingPeriodClosed = null, string RecognizedRevenueAccountingCode = null, string RecognizedRevenueAccountingCodeType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETRsRevenueItemType);
        }

        /// <summary>
        /// Returns true if GETRsRevenueItemType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETRsRevenueItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRsRevenueItemType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.AccountingPeriodEndDate == other.AccountingPeriodEndDate ||
                    this.AccountingPeriodEndDate != null &&
                    this.AccountingPeriodEndDate.Equals(other.AccountingPeriodEndDate)
                ) && 
                (
                ...
                (
                    this.AccountingPeriodStartDate == other.AccountingPeriodStartDate ||
                    this.AccountingPeriodStartDate != null &&
                    this.AccountingPeriodStartDate.Equals(other.AccountingPeriodStartDate)
                ) && 
                (
                ...
                (
                    this.IsAccountingPeriodClosed == other.IsAccountingPeriodClosed ||
                    this.IsAccountingPeriodClosed != null &&
                    this.IsAccountingPeriodClosed.Equals(other.IsAccountingPeriodClosed)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccountingPeriodEndDate != null)
                    hash = hash * 59 + this.AccountingPeriodEndDate.GetHashCode();
                if (this.AccountingPeriodName != null)
                    hash = hash * 59 + this.AccountingPeriodName.GetHashCode();
                if (this.AccountingPeriodStartDate != null)
                    hash = hash * 59 + this.AccountingPeriodStartDate.GetHashCode();
                if (this.Amount != null)
                ...
                if (this.IsAccountingPeriodClosed != null)
                    hash = hash * 59 + this.IsAccountingPeriodClosed.GetHashCode();
