...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreatePaymentMethod :  IEquatable<ProxyCreatePaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreatePaymentMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreatePaymentMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreatePaymentMethod" /> class.
        /// </summary>
        ...
        public ProxyCreatePaymentMethod(string AccountId = null, string AchAbaCode = null, string AchAccountName = null, string AchAccountType = null, string AchAddress1 = null, string AchAddress2 = null, string AchBankName = null, string BankBranchCode = null, string BankCheckDigit = null, string BankCity = null, string BankCode = null, string BankName = null, string BankPostalCode = null, string BankStreetName = null, string BankStreetNumber = null, string BankTransferAccountName = null, string BankTransferAccountType = null, string BankTransferType = null, string BusinessIdentificationCode = null, string City = null, string Country = null, string CreditCardAddress1 = null, string CreditCardAddress2 = null, string CreditCardCity = null, string CreditCardCountry = null, int? CreditCardExpirationMonth = null, int? CreditCardExpirationYear = null, string CreditCardHolderName = null, string CreditCardPostalCode = null, string CreditCardState = null, string CreditCardType = null, string DeviceSessionId = null, string Email = null, string ExistingMandate = null, string FirstName = null, string IBAN = null, string IPAddress = null, string LastName = null, DateTime? LastTransactionDateTime = null, string LastTransactionStatus = null, DateTime? MandateCreationDate = null, string MandateID = null, string MandateReceived = null, DateTime? MandateUpdateDate = null, int? MaxConsecutivePaymentFailures = null, int? PaymentRetryWindow = null, string PaypalBaid = null, string PaypalEmail = null, string PaypalPreapprovalKey = null, string PaypalType = null, string Phone = null, string PostalCode = null, string SecondTokenId = null, string State = null, string StreetName = null, string StreetNumber = null, string TokenId = null, int? TotalNumberOfErrorPayments = null, int? TotalNumberOfProcessedPayments = null, string Type = null, bool? UseDefaultRetryRule = null)
        {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for ProxyCreatePaymentMethod and cannot be null");
            }
            else
            {
                this.Type = Type;
            }
            // to ensure "UseDefaultRetryRule" is required (not null)
            if (UseDefaultRetryRule == null)
            {
                throw new InvalidDataException("UseDefaultRetryRule is a required property for ProxyCreatePaymentMethod and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreatePaymentMethod);
        }

        /// <summary>
        /// Returns true if ProxyCreatePaymentMethod instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreatePaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreatePaymentMethod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
