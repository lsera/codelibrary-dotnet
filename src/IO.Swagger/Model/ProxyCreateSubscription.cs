...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateSubscription :  IEquatable<ProxyCreateSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateSubscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateSubscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateSubscription" /> class.
        /// </summary>
        /// <param name="AccountId"> This field can be updated when **Status** is &#x60;Draft&#x60;. The ID of the [a valid account ID](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account)  (required).</param>
        ...
        /// <param name="InvoiceOwnerId"> This field can be updated when **Status** is &#x60;Draft&#x60;. The [a valid account ID](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account)  (required).</param>
        ...
        /// <param name="RenewalSetting"> This field can be updated when **Status** is &#x60;Draft&#x60;. Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed. **Required**: If TermType is Termed **Values**: &#x60;RENEW_WITH_SPECIFIC_TERM &#x60;(default), &#x60;RENEW_TO_EVERGREEN&#x60;  (required).</param>
        ...
        public ProxyCreateSubscription(string AccountId = null, bool? AutoRenew = null, DateTime? CancelledDate = null, DateTime? ContractAcceptanceDate = null, DateTime? ContractEffectiveDate = null, string CpqBundleJsonIdQT = null, string CurrentTermPeriodType = null, int? InitialTerm = null, string InitialTermPeriodType = null, string InvoiceOwnerId = null, bool? IsInvoiceSeparate = null, string Name = null, string Notes = null, DateTime? OpportunityCloseDateQT = null, string OpportunityNameQT = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, string RenewalSetting = null, int? RenewalTerm = null, string RenewalTermPeriodType = null, DateTime? ServiceActivationDate = null, string Status = null, DateTime? TermStartDate = null, string TermType = null, int? Version = null)
        {
            // to ensure "AccountId" is required (not null)
            if (AccountId == null)
            {
                throw new InvalidDataException("AccountId is a required property for ProxyCreateSubscription and cannot be null");
            }
            else
            {
                this.AccountId = AccountId;
            }
            // to ensure "InvoiceOwnerId" is required (not null)
            if (InvoiceOwnerId == null)
            {
                throw new InvalidDataException("InvoiceOwnerId is a required property for ProxyCreateSubscription and cannot be null");
            }
            else
            {
                this.InvoiceOwnerId = InvoiceOwnerId;
            }
            // to ensure "RenewalSetting" is required (not null)
            if (RenewalSetting == null)
            {
                throw new InvalidDataException("RenewalSetting is a required property for ProxyCreateSubscription and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateSubscription);
        }

        /// <summary>
        /// Returns true if ProxyCreateSubscription instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateSubscription other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
