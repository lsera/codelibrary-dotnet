...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTMassUpdateTypeParams :  IEquatable<POSTMassUpdateTypeParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTMassUpdateTypeParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTMassUpdateTypeParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTMassUpdateTypeParams" /> class.
        /// </summary>
        /// <param name="ActionType">Type of mass action you want to perform. The following mass actions are supported: - [UpdateAccountingCode](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Update_Accounting_Codes) - [CreateRevenueSchedule](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Create_Revenue_Schedules) - [UpdateRevenueSchedule](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Update_Revenue_Schedules) - [DeleteRevenueSchedule](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Delete_Revenue_Schedules) - [ImportFXRate](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Import_Foreign_Exchange_Rates)  (required).</param>
        /// <param name="Checksum">An MD5 checksum that is used to validate the integrity of the uploaded file. The checksum is a 32-character string. .</param>
        public POSTMassUpdateTypeParams(string ActionType = null, string Checksum = null)
        {
            // to ensure "ActionType" is required (not null)
            if (ActionType == null)
            {
                throw new InvalidDataException("ActionType is a required property for POSTMassUpdateTypeParams and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTMassUpdateTypeParams);
        }

        /// <summary>
        /// Returns true if POSTMassUpdateTypeParams instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTMassUpdateTypeParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTMassUpdateTypeParams other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
