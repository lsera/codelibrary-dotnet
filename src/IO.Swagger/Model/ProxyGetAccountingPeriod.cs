...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetAccountingPeriod :  IEquatable<ProxyGetAccountingPeriod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetAccountingPeriod" /> class.
        /// </summary>
        ...
        /// <param name="EndDate"> The end date of the accounting period. **Character limit**: **Version notes**: Z-Finance .</param>
        /// <param name="FiscalYear"> The fiscal year for the accounting period. **Values**: a valid integer of the form, YYYY .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="Name"> The name of the accounting period, which is displayed on the list of accounting periods on the All Accounting Periods page. **Character limit**:100 **Values**: a string of 100 characters or fewer .</param>
        /// <param name="Notes">Use this field to record comments about the accounting period. **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        /// <param name="StartDate"> The start date of the accounting period. **Character limit**: 29 **Values**: automatically generated after the first accounting period .</param>
        /// <param name="Status"> The status of the accounting period. **Character limit**: 6 **Allowable values**: automatically generated on creattion; one of the following values:  - Open - Closed .</param>
        ...
        public ProxyGetAccountingPeriod(string CreatedById = null, DateTime? CreatedDate = null, DateTime? EndDate = null, int? FiscalYear = null, string Id = null, string Name = null, string Notes = null, DateTime? StartDate = null, string Status = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetAccountingPeriod);
        }

        /// <summary>
        /// Returns true if ProxyGetAccountingPeriod instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetAccountingPeriod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetAccountingPeriod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
