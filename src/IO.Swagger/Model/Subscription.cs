...
namespace IO.Swagger.Model
{
    ...
    public partial class Subscription :  IEquatable<Subscription>, IValidatableObject
    {
        ...
        /// <param name="AncestorAccountId"> A filter option for querying all subscriptions under the same account hierarchy. **Character limit**: 32 **Values**: [a valid account ID](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account) .</param>
        ...
        public bool Equals(Subscription other)
        {
            ...
            return 
                ...
                (
                    this.AncestorAccountId == other.AncestorAccountId ||
                    this.AncestorAccountId != null &&
                    this.AncestorAccountId.Equals(other.AncestorAccountId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AncestorAccountId != null)
                    hash = hash * 59 + this.AncestorAccountId.GetHashCode();
