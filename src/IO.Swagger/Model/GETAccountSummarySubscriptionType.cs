...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountSummarySubscriptionType :  IEquatable<GETAccountSummarySubscriptionType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummarySubscriptionType" /> class.
        /// </summary>
        ...
        /// <param name="AutoRenew">If &#x60;true&#x60;, auto-renew is enabled. If &#x60;false&#x60;, auto-renew is disabled. .</param>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="Id">Subscription ID. .</param>
        /// <param name="InitialTerm">Duration of the initial subscription term in whole months.  .</param>
        /// <param name="RatePlans">Container for rate plans for this subscription. .</param>
        /// <param name="RenewalTerm">Duration of the renewal term in whole months. .</param>
        /// <param name="Status">Subscription status; possible values are: &#x60;Draft&#x60;, &#x60;PendingActivation&#x60;, &#x60;PendingAcceptance&#x60;, &#x60;Active&#x60;, &#x60;Cancelled&#x60;, &#x60;Expired&#x60;. .</param>
        /// <param name="SubscriptionNumber">Subscription Number. .</param>
        /// <param name="SubscriptionStartDate">Subscription start date. .</param>
        /// <param name="TermEndDate">End date of the subscription term. If the subscription is evergreen, this is either null or equal to the cancellation date, as appropriate. .</param>
        /// <param name="TermStartDate">Start date of the subscription term. If this is a renewal subscription, this date is different than the subscription start date. .</param>
        /// <param name="TermType">Possible values are: &#x60;TERMED&#x60;, &#x60;EVERGREEN&#x60;. .</param>
        public GETAccountSummarySubscriptionType(string CpqBundleJsonIdQT = null, string OpportunityCloseDateQT = null, string OpportunityNameQT = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, bool? AutoRenew = null, string CustomFieldC = null, string Id = null, string InitialTerm = null, List<GETAccountSummarySubscriptionRatePlanType> RatePlans = null, string RenewalTerm = null, string Status = null, string SubscriptionNumber = null, DateTime? SubscriptionStartDate = null, DateTime? TermEndDate = null, DateTime? TermStartDate = null, string TermType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountSummarySubscriptionType);
        }

        /// <summary>
        /// Returns true if GETAccountSummarySubscriptionType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountSummarySubscriptionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummarySubscriptionType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
