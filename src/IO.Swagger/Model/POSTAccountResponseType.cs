...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTAccountResponseType :  IEquatable<POSTAccountResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountResponseType" /> class.
        /// </summary>
        /// <param name="AccountId">Auto-generated account ID. .</param>
        /// <param name="AccountNumber">Account number. .</param>
        /// <param name="ContractedMrr">Contracted [monthly recurring revenue](https://knowledgecenter.zuora.com/BC_Subscription_Management/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/A_Monthly_Recurring_Revenue) of the subscription. .</param>
        /// <param name="InvoiceId">ID of the invoice generated at account creation, if applicable. .</param>
        /// <param name="PaidAmount">Amount collected on the invoice generated at account creation, if applicable. .</param>
        /// <param name="PaymentId">ID of the payment collected on the invoice generated at account creation, if applicable. .</param>
        /// <param name="PaymentMethodId">ID of the payment method that was set up at account creation, which automatically becomes the default payment method for this account. .</param>
        /// <param name="SubscriptionId">ID of the subscription that was set up at account creation, if applicable. .</param>
        /// <param name="SubscriptionNumber">Number of the subscription that was set up at account creation, if applicable. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="TotalContractedValue">[Total contracted value](https://knowledgecenter.zuora.com/P_Glossary) of the subscription. .</param>
        public POSTAccountResponseType(string AccountId = null, string AccountNumber = null, string ContractedMrr = null, string InvoiceId = null, string PaidAmount = null, string PaymentId = null, string PaymentMethodId = null, string SubscriptionId = null, string SubscriptionNumber = null, bool? Success = null, string TotalContractedValue = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTAccountResponseType);
        }

        /// <summary>
        /// Returns true if POSTAccountResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTAccountResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
