...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetInvoiceAdjustment :  IEquatable<ProxyGetInvoiceAdjustment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoiceAdjustment" /> class.
        /// </summary>
        /// <param name="AccountId"> The ID of the account that owns the invoice. **Character limit**: 32 **Values**: inherited from &#x60;[Account](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account).ID&#x60; for the invoice owner .</param>
        ...
        /// <param name="AdjustmentNumber"> A unique string to identify an individual invoice adjustment. **Character limit**: 255 **Values**: automatically generated .</param>
        /// <param name="Amount"> The amount of the invoice adjustment. **Character limit**: 16 **Values**: a valid currency amount .</param>
        /// <param name="CancelledById"> The ID of the Zuora user who canceled the invoice adjustment. Zuora generates this read-only field only if the adjustment is canceled. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CancelledOn"> The date when the invoice adjustment is canceled. Zuora generates this read-only field if this adjustment is canceled. **Character limit**: 29 **Values**: automatically generated .</param>
        ...
        /// <param name="CreatedById"> The user ID of the person who created the invoice adjustment. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate"> The date the invoice adjustment was created. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="CustomerName"> The name of the account that owns the associated invoice. **Character limit**: 50 **Values**: inherited from &#x60;[Account](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account).Name&#x60; .</param>
        /// <param name="CustomerNumber"> The unique account number of the customer&#39;s account. **Character limit**: 70 **Values**: inherited from &#x60;[Account](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account).AccountNumber&#x60; .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="ImpactAmount"> The amount that changes the balance of the associated invoice. **Character limit**: 16 **Values**: automatically calculated .</param>
        ...
        /// <param name="Status"> The status of the invoice adjustment. This field is required in &#x60;query()&#x60; calls, but is automatically generated in other calls. **Character limit**: 9 **Values**: &#x60;Canceled&#x60;, &#x60;Processed&#x60; .</param>
        ...
        /// <param name="Type"> Indicates whether the adjustment credits or debits the invoice amount. **Character limit**: 6 **Values**: &#x60;Credit&#x60;, &#x60;Charge&#x60; .</param>
        /// <param name="UpdatedById"> The ID of the user who last updated the invoice. **Character limit**: 32 **Values**: automatically generated .</param>
        ...
        public ProxyGetInvoiceAdjustment(string AccountId = null, string AccountingCode = null, DateTime? AdjustmentDate = null, string AdjustmentNumber = null, double? Amount = null, string CancelledById = null, DateTime? CancelledOn = null, string Comments = null, string CreatedById = null, DateTime? CreatedDate = null, string CustomerName = null, string CustomerNumber = null, string Id = null, double? ImpactAmount = null, string InvoiceId = null, string InvoiceNumber = null, string ReasonCode = null, string ReferenceId = null, string Status = null, string TransferredToAccounting = null, string Type = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        /// </summary>
        /// <value> The ID of the Zuora user who canceled the invoice adjustment. Zuora generates this read-only field only if the adjustment is canceled. **Character limit**: 32 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> The date when the invoice adjustment is canceled. Zuora generates this read-only field if this adjustment is canceled. **Character limit**: 29 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> The user ID of the person who created the invoice adjustment. **Character limit**: 32 **Values**: automatically generated </value>
        [DataMember(Name="CreatedById", EmitDefaultValue=false)]
        public string CreatedById { get; set; }
        /// <summary>
        ///  The date the invoice adjustment was created. **Character limit**: 29 **Values**: automatically generated 
        /// </summary>
        /// <value> The date the invoice adjustment was created. **Character limit**: 29 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> The ID of the user who last updated the invoice. **Character limit**: 32 **Values**: automatically generated </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetInvoiceAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceAdjustment instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetInvoiceAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceAdjustment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
