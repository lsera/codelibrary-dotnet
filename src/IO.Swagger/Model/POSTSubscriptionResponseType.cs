...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSubscriptionResponseType :  IEquatable<POSTSubscriptionResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionResponseType" /> class.
        /// </summary>
        ...
        public POSTSubscriptionResponseType(string ContractedMrr = null, string InvoiceId = null, string PaidAmount = null, string PaymentId = null, string SubscriptionId = null, string SubscriptionNumber = null, bool? Success = null, string TotalContractedValue = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionResponseType);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
