...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetContact :  IEquatable<ProxyGetContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetContact" /> class.
        /// </summary>
        /// <param name="AccountId"> The Zuora account ID associated with this contact. This field is not required when you use the subscribe() call. This field is required for all other calls. **Character limit: **32 **Values: **[a valid account ID](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account#Id) .</param>
        ...
        /// <param name="CreatedById">The ID of the Zuora user who created the contact. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate">The date when the contact was created. **Character limit**: 29 **Values**: automatically generated .</param>
        ...
        /// <param name="FirstName"> The contact&#39;s first name. **Character limit**: 100 **Values**: a string of the contact&#39;s first name .</param>
        ...
        /// <param name="LastName"> The contact&#39;s last name. **Character limit**: 100 **Values**: a string of 100 characters or fewer .</param>
        ...
        /// <param name="UpdatedById"> The ID of the user who lasted updated the contact. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="UpdatedDate"> The date when the contact was last updated. **Character limit**: 29 **Values**: automatically generated .</param>
        ...
        public ProxyGetContact(string AccountId = null, string Address1 = null, string Address2 = null, string City = null, string Country = null, string County = null, string CreatedById = null, DateTime? CreatedDate = null, string Description = null, string Fax = null, string FirstName = null, string HomePhone = null, string Id = null, string LastName = null, string MobilePhone = null, string NickName = null, string OtherPhone = null, string OtherPhoneType = null, string PersonalEmail = null, string PostalCode = null, string State = null, string TaxRegion = null, string UpdatedById = null, DateTime? UpdatedDate = null, string WorkEmail = null, string WorkPhone = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetContact {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetContact);
        }

        /// <summary>
        /// Returns true if ProxyGetContact instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetContact other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
