...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETRevenueItemsType :  IEquatable<GETRevenueItemsType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRevenueItemsType" /> class.
        /// </summary>
        ...
        public GETRevenueItemsType(List<GETRevenueItemType> RevenueItems = null, bool? Success = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRevenueItemsType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETRevenueItemsType);
        }

        /// <summary>
        /// Returns true if GETRevenueItemsType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETRevenueItemsType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRevenueItemsType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
