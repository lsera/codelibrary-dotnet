...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FinanceInformation :  IEquatable<FinanceInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FinanceInformation" /> class.
        /// </summary>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="DeferredRevenueAccountingCode">The accounting code for deferred revenue, such as Monthly Recurring Liability.  .</param>
        /// <param name="DeferredRevenueAccountingCodeType">The type associated with the deferred revenue accounting code, such as Deferred Revenue.  .</param>
        /// <param name="RecognizedRevenueAccountingCode">The accounting code for recognized revenue, such as Monthly Recurring Charges or Overage Charges.  .</param>
        /// <param name="RecognizedRevenueAccountingCodeType">The type associated with the recognized revenue accounting code, such as Sales Revenue or Sales Discount.  .</param>
        public FinanceInformation(string CustomFieldC = null, string DeferredRevenueAccountingCode = null, string DeferredRevenueAccountingCodeType = null, string RecognizedRevenueAccountingCode = null, string RecognizedRevenueAccountingCodeType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FinanceInformation);
        }
