...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTJournalEntryItemType :  IEquatable<POSTJournalEntryItemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTJournalEntryItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTJournalEntryItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTJournalEntryItemType" /> class.
        /// </summary>
        /// <param name="AccountingCodeName">Name of the accounting code.  (required).</param>
        /// <param name="AccountingCodeType">Accounting code type. The accounting code types are:  * &#x60;AccountsReceivable&#x60; *  &#x60;Cash&#x60; *  &#x60;OtherAssets&#x60; *  &#x60;CustomerCashOnAccount &#x60; * &#x60;DeferredRevenue&#x60; * &#x60;SalesTaxPayable&#x60; * &#x60;OtherLiabilities&#x60; * &#x60;SalesRevenue&#x60; * &#x60;SalesDiscounts&#x60; * &#x60;OtherRevenue&#x60;  * &#x60;OtherEquity&#x60; * &#x60;BadDebt&#x60;   * &#x60;OtherExpenses&#x60;  This field is required if accountingCodeName is not unique. .</param>
        /// <param name="Amount">Journal entry item amount in transaction currency.  (required).</param>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="HomeCurrencyAmount">Journal entry item amount in home currency.  This field is required if you have set your home currency for foreign currency conversion. Otherwise, do not pass this field. .</param>
        /// <param name="Type">Type of journal entry item. An enum with the value &#x60;Credit&#x60; or &#x60;Debit&#x60;.  (required).</param>
        public POSTJournalEntryItemType(string AccountingCodeName = null, string AccountingCodeType = null, string Amount = null, string CustomFieldC = null, string HomeCurrencyAmount = null, string Type = null)
        {
            // to ensure "AccountingCodeName" is required (not null)
            if (AccountingCodeName == null)
            {
                throw new InvalidDataException("AccountingCodeName is a required property for POSTJournalEntryItemType and cannot be null");
            }
            else
            {
            ...
            if (Amount == null)
            {
                throw new InvalidDataException("Amount is a required property for POSTJournalEntryItemType and cannot be null");
            }
            else
            {
                this.Amount = Amount;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for POSTJournalEntryItemType and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTJournalEntryItemType);
        }

        /// <summary>
        /// Returns true if POSTJournalEntryItemType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTJournalEntryItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTJournalEntryItemType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.HomeCurrencyAmount == other.HomeCurrencyAmount ||
                    this.HomeCurrencyAmount != null &&
                    this.HomeCurrencyAmount.Equals(other.HomeCurrencyAmount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HomeCurrencyAmount != null)
                    hash = hash * 59 + this.HomeCurrencyAmount.GetHashCode();
                if (this.Type != null)
