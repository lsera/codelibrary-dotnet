...
namespace IO.Swagger.Model
{
    ...
    public partial class Invoice :  IEquatable<Invoice>, IValidatableObject
    {
        ...
        /// <param name="BillRunId"> The ID of a Bill Run. **Character limit**: 32 **Values**: a BillRun ID .</param>
        ...
        /// <param name="RegenerateInvoicePDF"> Regenerates a PDF of an invoice that was already generated. Add this field to an &#x60;update()&#x60; call to regenerate an invoice PDF. Note that when you set the &#x60;RegenerateInvoicePDF&#x60; field to &#x60;true&#x60;, you cannot update any other fields in the same &#x60;update()&#x60; call. Otherwise, you will receive the following &#x60;INVALID_VALUE&#x60; error: &amp;quot;When field RegenerateInvoicePDF is set to true to regenerate the invoice PDF file, changes on other fields of the invoice are not allowed.&amp;quot; **Character limit**: 5 **Values**: &#x60;True&#x60;, &#x60;False&#x60; .</param>
        ...
        public Invoice(string AccountId = null, double? AdjustmentAmount = null, double? Amount = null, double? AmountWithoutTax = null, double? Balance = null, string BillRunId = null, string Body = null, string Comments = null, string CreatedById = null, DateTime? CreatedDate = null, double? CreditBalanceAdjustmentAmount = null, DateTime? DueDate = null, bool? IncludesOneTime = null, bool? IncludesRecurring = null, bool? IncludesUsage = null, DateTime? InvoiceDate = null, string InvoiceNumber = null, DateTime? LastEmailSentDate = null, double? PaymentAmount = null, string PostedBy = null, DateTime? PostedDate = null, double? RefundAmount = null, bool? RegenerateInvoicePDF = null, string Status = null, DateTime? TargetDate = null, double? TaxAmount = null, double? TaxExemptAmount = null, string TransferredToAccounting = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        /// </summary>
        /// <value> The ID of a Bill Run. **Character limit**: 32 **Values**: a BillRun ID </value>
        [DataMember(Name="BillRunId", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value> Regenerates a PDF of an invoice that was already generated. Add this field to an &#x60;update()&#x60; call to regenerate an invoice PDF. Note that when you set the &#x60;RegenerateInvoicePDF&#x60; field to &#x60;true&#x60;, you cannot update any other fields in the same &#x60;update()&#x60; call. Otherwise, you will receive the following &#x60;INVALID_VALUE&#x60; error: &amp;quot;When field RegenerateInvoicePDF is set to true to regenerate the invoice PDF file, changes on other fields of the invoice are not allowed.&amp;quot; **Character limit**: 5 **Values**: &#x60;True&#x60;, &#x60;False&#x60; </value>
        [DataMember(Name="RegenerateInvoicePDF", EmitDefaultValue=false)]
        public bool? RegenerateInvoicePDF { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RegenerateInvoicePDF: ").Append(RegenerateInvoicePDF).Append("\n");
        ...
        public bool Equals(Invoice other)
        {
            ...
            return 
                ...
                (
                    this.BillRunId == other.BillRunId ||
                    this.BillRunId != null &&
                    this.BillRunId.Equals(other.BillRunId)
                ) && 
                (
                ...
                (
                    this.RegenerateInvoicePDF == other.RegenerateInvoicePDF ||
                    this.RegenerateInvoicePDF != null &&
                    this.RegenerateInvoicePDF.Equals(other.RegenerateInvoicePDF)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BillRunId != null)
                    hash = hash * 59 + this.BillRunId.GetHashCode();
                if (this.Body != null)
                ...
                if (this.RegenerateInvoicePDF != null)
                    hash = hash * 59 + this.RegenerateInvoicePDF.GetHashCode();
                if (this.Status != null)
