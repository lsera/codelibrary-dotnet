...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RevenueScheduleItemType :  IEquatable<RevenueScheduleItemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevenueScheduleItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RevenueScheduleItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RevenueScheduleItemType" /> class.
        /// </summary>
        ...
        public RevenueScheduleItemType(string AccountingPeriodName = null, string CustomFieldC = null)
        {
            // to ensure "AccountingPeriodName" is required (not null)
            if (AccountingPeriodName == null)
            {
                throw new InvalidDataException("AccountingPeriodName is a required property for RevenueScheduleItemType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RevenueScheduleItemType);
        }

        /// <summary>
        /// Returns true if RevenueScheduleItemType instances are equal
        /// </summary>
        /// <param name="other">Instance of RevenueScheduleItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevenueScheduleItemType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
