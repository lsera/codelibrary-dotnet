...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTAccountTypeBillToContact :  IEquatable<PUTAccountTypeBillToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeBillToContact" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTAccountTypeBillToContact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeBillToContact" /> class.
        /// </summary>
        ...
        /// <param name="Country">Country; must be a valid country name or abbreviation. If using [Z-Tax](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/L_Taxes/A_Z-Tax), must specify a country in the sold-to contact to calculate tax. A bill-to contact may be used if no sold-to contact is provided. .</param>
        ...
        public PUTAccountTypeBillToContact(string Address1 = null, string Address2 = null, string City = null, string Country = null, string County = null, string CustomFieldC = null, string Fax = null, string FirstName = null, string HomePhone = null, string LastName = null, string MobilePhone = null, string Nickname = null, string OtherPhone = null, string OtherPhoneType = null, string PersonalEmail = null, string State = null, string TaxRegion = null, string WorkEmail = null, string WorkPhone = null, string ZipCode = null)
        {
            // to ensure "FirstName" is required (not null)
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for PUTAccountTypeBillToContact and cannot be null");
            }
            else
            {
            ...
            if (LastName == null)
            {
                throw new InvalidDataException("LastName is a required property for PUTAccountTypeBillToContact and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTAccountTypeBillToContact {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTAccountTypeBillToContact);
        }

        /// <summary>
        /// Returns true if PUTAccountTypeBillToContact instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTAccountTypeBillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountTypeBillToContact other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
