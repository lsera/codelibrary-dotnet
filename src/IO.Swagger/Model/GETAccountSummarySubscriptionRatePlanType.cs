...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountSummarySubscriptionRatePlanType :  IEquatable<GETAccountSummarySubscriptionRatePlanType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummarySubscriptionRatePlanType" /> class.
        /// </summary>
        /// <param name="ProductId">Product ID. .</param>
        /// <param name="ProductName">Product name. .</param>
        /// <param name="ProductRatePlanId">Product Rate Plan ID. .</param>
        /// <param name="ProductSku">dummy.</param>
        /// <param name="RatePlanName">Rate plan name. .</param>
        public GETAccountSummarySubscriptionRatePlanType(string ProductId = null, string ProductName = null, string ProductRatePlanId = null, string ProductSku = null, string RatePlanName = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountSummarySubscriptionRatePlanType);
        }

        /// <summary>
        /// Returns true if GETAccountSummarySubscriptionRatePlanType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountSummarySubscriptionRatePlanType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummarySubscriptionRatePlanType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
