...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountSummaryTypeBasicInfoDefaultPaymentMethod :  IEquatable<GETAccountSummaryTypeBasicInfoDefaultPaymentMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummaryTypeBasicInfoDefaultPaymentMethod" /> class.
        /// </summary>
        /// <param name="CreditCardExpirationMonth">Two-digit numeric card expiration month as &#x60;mm&#x60;. .</param>
        /// <param name="CreditCardExpirationYear">Four-digit card expiration year as &#x60;yyyy&#x60;. .</param>
        /// <param name="CreditCardNumber">Credit card number, 16 characters or less, displayed in masked format (e.g., ************1234). .</param>
        /// <param name="CreditCardType">Possible values are: &#x60;Visa&#x60;, &#x60;MasterCard&#x60;, &#x60;AmericanExpress&#x60;, &#x60;Discover&#x60;. .</param>
        /// <param name="Id">The ID of the credit card payment method associated with this account. .</param>
        /// <param name="PaymentMethodType">dummy.</param>
        public GETAccountSummaryTypeBasicInfoDefaultPaymentMethod(string CreditCardExpirationMonth = null, string CreditCardExpirationYear = null, string CreditCardNumber = null, string CreditCardType = null, string Id = null, string PaymentMethodType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountSummaryTypeBasicInfoDefaultPaymentMethod);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeBasicInfoDefaultPaymentMethod instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountSummaryTypeBasicInfoDefaultPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeBasicInfoDefaultPaymentMethod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
