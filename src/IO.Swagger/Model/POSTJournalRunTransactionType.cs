...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTJournalRunTransactionType :  IEquatable<POSTJournalRunTransactionType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTJournalRunTransactionType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTJournalRunTransactionType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTJournalRunTransactionType" /> class.
        /// </summary>
        /// <param name="Type">Transaction type.   The transaction types are: * Invoice Item * Taxation Item * Invoice Item Adjustment (Invoice) * Invoice Item Adjustment (Tax) * Invoice Adjustment (Invoice Adjustment is deprecated on Production. Zuora recommends that you use the Invoice Item Adjustment instead.) * Electronic Payment * External Payment * Electronic Refund * External Refund * Electronic Credit Balance Payment * External Credit Balance Payment * Electronic Credit Balance Refund * External Credit Balance Refund * Credit Balance Adjustment (Applied from Credit Balance) * Credit Balance Adjustment (Transferred to Credit Balance) * Revenue Event Item  To include all transaction types, pass in \&quot;All\&quot;.  (required).</param>
        public POSTJournalRunTransactionType(string Type = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for POSTJournalRunTransactionType and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTJournalRunTransactionType);
        }

        /// <summary>
        /// Returns true if POSTJournalRunTransactionType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTJournalRunTransactionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTJournalRunTransactionType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
