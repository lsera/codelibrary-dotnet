...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTRevenueScheduleByDateRangeTypeRevenueEvent :  IEquatable<POSTRevenueScheduleByDateRangeTypeRevenueEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTRevenueScheduleByDateRangeTypeRevenueEvent" /> class.
        /// </summary>
        ...
        public POSTRevenueScheduleByDateRangeTypeRevenueEvent(string CustomFieldC = null, string EventType = null, string EventTypeSystemId = null, string Notes = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTRevenueScheduleByDateRangeTypeRevenueEvent);
        }

        /// <summary>
        /// Returns true if POSTRevenueScheduleByDateRangeTypeRevenueEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTRevenueScheduleByDateRangeTypeRevenueEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTRevenueScheduleByDateRangeTypeRevenueEvent other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
