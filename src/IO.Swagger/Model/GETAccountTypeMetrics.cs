...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountTypeMetrics :  IEquatable<GETAccountTypeMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountTypeMetrics" /> class.
        /// </summary>
        /// <param name="Balance">The customer&#39;s total invoice balance minus credit balance. .</param>
        /// <param name="ContractedMrr">Future expected MRR that accounts for future upgrades, downgrades, upsells and cancellations. .</param>
        /// <param name="CreditBalance">Current credit balance. .</param>
        /// <param name="TotalInvoiceBalance">Total of all open invoices. .</param>
        public GETAccountTypeMetrics(string Balance = null, string ContractedMrr = null, string CreditBalance = null, string TotalInvoiceBalance = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountTypeMetrics);
        }

        /// <summary>
        /// Returns true if GETAccountTypeMetrics instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountTypeMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeMetrics other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
