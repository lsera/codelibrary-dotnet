...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyUnitOfMeasure :  IEquatable<ProxyModifyUnitOfMeasure>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyUnitOfMeasure" /> class.
        /// </summary>
        ...
        public ProxyModifyUnitOfMeasure(bool? Active = null, long? DecimalPlaces = null, string DisplayedAs = null, string RoundingMode = null, string UomName = null)
        {
            this.Active = Active;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyUnitOfMeasure);
        }

        /// <summary>
        /// Returns true if ProxyModifyUnitOfMeasure instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyUnitOfMeasure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyUnitOfMeasure other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
