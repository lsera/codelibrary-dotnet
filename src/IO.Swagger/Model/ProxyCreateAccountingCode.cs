...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateAccountingCode :  IEquatable<ProxyCreateAccountingCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAccountingCode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateAccountingCode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAccountingCode" /> class.
        /// </summary>
        ...
        /// <param name="Name"> The name of the accounting code. **Character limit**: 100 **Z-Finance Required:** No  (required).</param>
        /// <param name="Notes"> Any note about the accounting code. **Character limit:** 2000 **Z-Finance Required**: No .</param>
        /// <param name="Type"> The accounting code type. Possible values:  - AccountsReceivable - Cash - OtherAssets - CustomerCashOnAccount - DeferredRevenue - SalesTaxPayable - OtherLiabilities - SalesRevenue - SalesDiscounts - OtherRevenue - OtherEquity - BadDebt - OtherExpenses **Character limit**: N/A **Z-Finance Required:** No  (required).</param>
        public ProxyCreateAccountingCode(string GLAccountName = null, string GLAccountNumber = null, string Name = null, string Notes = null, string Type = null)
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for ProxyCreateAccountingCode and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for ProxyCreateAccountingCode and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateAccountingCode);
        }

        /// <summary>
        /// Returns true if ProxyCreateAccountingCode instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateAccountingCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateAccountingCode other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
