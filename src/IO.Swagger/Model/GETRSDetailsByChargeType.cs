...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETRSDetailsByChargeType :  IEquatable<GETRSDetailsByChargeType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRSDetailsByChargeType" /> class.
        /// </summary>
        /// <param name="RevenueSchedules">Represents how revenue will be recognized over time.  This contains the details of a revenue schedule. If you do not specify the ｀pageSize｀ variable, the default number of revenue schedules returned per invocation is 8, and if there are more than 8 revenue schedules to be returned, the ｀nextPage｀ field will provide a hyperlink to view the next page(s) of revenue events. The order of revenue schedules is descending by the ｀updatedOn｀ field. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        public GETRSDetailsByChargeType(List<GETRSDetailWithoutSuccessType> RevenueSchedules = null, bool? Success = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETRSDetailsByChargeType);
        }

        /// <summary>
        /// Returns true if GETRSDetailsByChargeType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETRSDetailsByChargeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailsByChargeType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.RevenueSchedules == other.RevenueSchedules ||
                    this.RevenueSchedules != null &&
                    this.RevenueSchedules.SequenceEqual(other.RevenueSchedules)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RevenueSchedules != null)
                    hash = hash * 59 + this.RevenueSchedules.GetHashCode();
