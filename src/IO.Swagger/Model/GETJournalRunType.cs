...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETJournalRunType :  IEquatable<GETJournalRunType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETJournalRunType" /> class.
        /// </summary>
        /// <param name="AggregateCurrency">dummy.</param>
        /// <param name="ExecutedOn">Date and time the journal run was executed. .</param>
        /// <param name="JournalEntryDate">Date of the journal entry. .</param>
        /// <param name="Number">Journal run number. .</param>
        /// <param name="SegmentationRuleName">Name of GL segmentation rule used in the journal run. .</param>
        /// <param name="Status">Status of the journal run.   The possible values are: * Pending * Processing * Completed * Error * CancelInprogress * Cancelled * DeleteInprogress .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="TargetEndDate">The target end date of the journal run. .</param>
        /// <param name="TargetStartDate">The target start date of the journal run. .</param>
        /// <param name="TotalJournalEntryCount">Total number of journal entries in the journal run. .</param>
        /// <param name="TransactionTypes">Transaction types included in the journal run. .</param>
        public GETJournalRunType(bool? AggregateCurrency = null, DateTime? ExecutedOn = null, DateTime? JournalEntryDate = null, string Number = null, string SegmentationRuleName = null, string Status = null, bool? Success = null, DateTime? TargetEndDate = null, DateTime? TargetStartDate = null, long? TotalJournalEntryCount = null, List<GETJournalRunTransactionType> TransactionTypes = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETJournalRunType);
        }

        /// <summary>
        /// Returns true if GETJournalRunType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETJournalRunType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETJournalRunType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExecutedOn == other.ExecutedOn ||
                    this.ExecutedOn != null &&
                    this.ExecutedOn.Equals(other.ExecutedOn)
                ) && 
                (
                ...
                (
                    this.SegmentationRuleName == other.SegmentationRuleName ||
                    this.SegmentationRuleName != null &&
                    this.SegmentationRuleName.Equals(other.SegmentationRuleName)
                ) && 
                (
                ...
                (
                    this.TotalJournalEntryCount == other.TotalJournalEntryCount ||
                    this.TotalJournalEntryCount != null &&
                    this.TotalJournalEntryCount.Equals(other.TotalJournalEntryCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExecutedOn != null)
                    hash = hash * 59 + this.ExecutedOn.GetHashCode();
                if (this.JournalEntryDate != null)
                    hash = hash * 59 + this.JournalEntryDate.GetHashCode();
                if (this.Number != null)
                    hash = hash * 59 + this.Number.GetHashCode();
                if (this.SegmentationRuleName != null)
                    hash = hash * 59 + this.SegmentationRuleName.GetHashCode();
                if (this.Status != null)
                ...
                if (this.TotalJournalEntryCount != null)
                    hash = hash * 59 + this.TotalJournalEntryCount.GetHashCode();
