...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTAccountTypeSoldToContact :  IEquatable<PUTAccountTypeSoldToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeSoldToContact" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTAccountTypeSoldToContact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeSoldToContact" /> class.
        /// </summary>
        ...
        public PUTAccountTypeSoldToContact(string Address1 = null, string Address2 = null, string City = null, string Country = null, string County = null, string CustomFieldC = null, string Fax = null, string FirstName = null, string HomePhone = null, string LastName = null, string MobilePhone = null, string Nickname = null, string OtherPhone = null, string OtherPhoneType = null, string PersonalEmail = null, string State = null, string TaxRegion = null, string WorkEmail = null, string WorkPhone = null, string ZipCode = null)
        {
            // to ensure "FirstName" is required (not null)
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for PUTAccountTypeSoldToContact and cannot be null");
            }
            else
            {
            ...
            if (LastName == null)
            {
                throw new InvalidDataException("LastName is a required property for PUTAccountTypeSoldToContact and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTAccountTypeSoldToContact);
        }

        /// <summary>
        /// Returns true if PUTAccountTypeSoldToContact instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTAccountTypeSoldToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountTypeSoldToContact other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
