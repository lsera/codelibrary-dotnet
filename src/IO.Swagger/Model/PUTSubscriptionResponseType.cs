...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSubscriptionResponseType :  IEquatable<PUTSubscriptionResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionResponseType" /> class.
        /// </summary>
        /// <param name="Amount">Invoice amount. Preview mode only. .</param>
        /// <param name="AmountWithoutTax">Invoice amount minus tax. Preview mode only. .</param>
        /// <param name="ChargeMetrics">ChargeMetrics.</param>
        /// <param name="InvoiceId">Invoice ID, if an invoice is generated during the update. .</param>
        /// <param name="InvoiceItems">Container for invoice items. .</param>
        /// <param name="InvoiceTargetDate">Date through which charges are calculated on the invoice, as yyyy-mm-dd. Preview mode only. .</param>
        /// <param name="PaidAmount">Payment amount, if a payment is collected .</param>
        /// <param name="PaymentId">Payment ID, if a payment is collected. .</param>
        /// <param name="PreviewChargeMetricsResponse">.</param>
        /// <param name="SubscriptionId">The ID of the resulting new subscription. .</param>
        ...
        /// <param name="TotalDeltaMrr">Change in the subscription monthly recurring revenue as a result of the update. .</param>
        /// <param name="TotalDeltaTcv">Change in the total contracted value of the subscription as a result of the update. .</param>
        public PUTSubscriptionResponseType(string Amount = null, string AmountWithoutTax = null, PUTSubscriptionResponseTypeChargeMetrics ChargeMetrics = null, string InvoiceId = null, List<PUTSubscriptionPreviewInvoiceItemsType> InvoiceItems = null, DateTime? InvoiceTargetDate = null, string PaidAmount = null, string PaymentId = null, string PreviewChargeMetricsResponse = null, string SubscriptionId = null, bool? Success = null, string TaxAmount = null, string TotalDeltaMrr = null, string TotalDeltaTcv = null)
        {
            this.Amount = Amount;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSubscriptionResponseType);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSubscriptionResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.TotalDeltaMrr == other.TotalDeltaMrr ||
                    this.TotalDeltaMrr != null &&
                    this.TotalDeltaMrr.Equals(other.TotalDeltaMrr)
                ) && 
                (
                    this.TotalDeltaTcv == other.TotalDeltaTcv ||
                    this.TotalDeltaTcv != null &&
                    this.TotalDeltaTcv.Equals(other.TotalDeltaTcv)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TotalDeltaMrr != null)
                    hash = hash * 59 + this.TotalDeltaMrr.GetHashCode();
                if (this.TotalDeltaTcv != null)
                    hash = hash * 59 + this.TotalDeltaTcv.GetHashCode();
                return hash;
            }
        }
