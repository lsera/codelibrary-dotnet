...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTJournalEntryType :  IEquatable<POSTJournalEntryType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTJournalEntryType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTJournalEntryType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTJournalEntryType" /> class.
        /// </summary>
        /// <param name="AccountingPeriodName">Name of the accounting period. The open-ended accounting period is named &#x60;Open-Ended&#x60;.   (required).</param>
        /// <param name="Currency">The type of currency used.   Currency must be active in **Z-Billing Settings &gt; Customize Currencies.**  (required).</param>
        ...
        /// <param name="JournalEntryItems">Key name that represents the list of journal entry items.  (required).</param>
        /// <param name="Notes">The number associated with the revenue event.  Character limit: 2,000 .</param>
        ...
        public POSTJournalEntryType(string AccountingPeriodName = null, string Currency = null, string CustomFieldC = null, DateTime? JournalEntryDate = null, List<POSTJournalEntryItemType> JournalEntryItems = null, string Notes = null, List<POSTJournalEntrySegmentType> Segments = null, string TransferredToAccounting = null)
        {
            // to ensure "AccountingPeriodName" is required (not null)
            if (AccountingPeriodName == null)
            {
                throw new InvalidDataException("AccountingPeriodName is a required property for POSTJournalEntryType and cannot be null");
            }
            else
            {
            ...
            if (Currency == null)
            {
                throw new InvalidDataException("Currency is a required property for POSTJournalEntryType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("JournalEntryDate is a required property for POSTJournalEntryType and cannot be null");
            }
            else
            {
                this.JournalEntryDate = JournalEntryDate;
            }
            // to ensure "JournalEntryItems" is required (not null)
            if (JournalEntryItems == null)
            {
                throw new InvalidDataException("JournalEntryItems is a required property for POSTJournalEntryType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTJournalEntryType);
        }

        /// <summary>
        /// Returns true if POSTJournalEntryType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTJournalEntryType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTJournalEntryType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
