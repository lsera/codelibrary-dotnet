...
namespace IO.Swagger.Model
{
    ...
    public partial class PUTRSTermType :  IEquatable<PUTRSTermType>, IValidatableObject
    {
        ...
        /// <param name="RecognitionEnd">The end date of a recognition period in &#x60;YYYY-MM-DD&#x60; format.   The maximum difference of the &#x60;recognitionStart&#x60; and &#x60;recognitionEnd&#x60; date fields is equal to 250 multiplied by the length of an accounting period.  (required).</param>
        /// <param name="RecognitionStart">The start date of a recognition period in &#x60;YYYY-MM-DD&#x60; format.  If there is a closed accounting period between the &#x60;recognitionStart&#x60; and &#x60;recognitionEnd&#x60; dates, the revenue that would be placed in the closed accounting period is instead placed in the next open accounting period.  (required).</param>
        public PUTRSTermType(string CustomFieldC = null, string DistributionType = null, string EventType = null, string EventTypeSystemId = null, string Notes = null, DateTime? RecognitionEnd = null, DateTime? RecognitionStart = null)
        {
            // to ensure "RecognitionEnd" is required (not null)
            if (RecognitionEnd == null)
            {
                throw new InvalidDataException("RecognitionEnd is a required property for PUTRSTermType and cannot be null");
            }
            else
            {
                this.RecognitionEnd = RecognitionEnd;
            }
            // to ensure "RecognitionStart" is required (not null)
            if (RecognitionStart == null)
            {
                throw new InvalidDataException("RecognitionStart is a required property for PUTRSTermType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTRSTermType);
        }

        /// <summary>
        /// Returns true if PUTRSTermType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTRSTermType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTRSTermType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.RecognitionEnd == other.RecognitionEnd ||
                    this.RecognitionEnd != null &&
                    this.RecognitionEnd.Equals(other.RecognitionEnd)
                ) && 
                (
                    this.RecognitionStart == other.RecognitionStart ||
                    this.RecognitionStart != null &&
                    this.RecognitionStart.Equals(other.RecognitionStart)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RecognitionEnd != null)
                    hash = hash * 59 + this.RecognitionEnd.GetHashCode();
                if (this.RecognitionStart != null)
                    hash = hash * 59 + this.RecognitionStart.GetHashCode();
                return hash;
            }
        }
