...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetSubscriptionProductFeature :  IEquatable<ProxyGetSubscriptionProductFeature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetSubscriptionProductFeature" /> class.
        /// </summary>
        /// <param name="CreatedById">.</param>
        /// <param name="CreatedDate"> Date and time when the product feature was added to the subscription. **Character limit**: 29 **Values**: .</param>
        /// <param name="Description"> Description of the subscription product feature. **Character limit**: 500 **Values**: .</param>
        /// <param name="FeatureCode"> Unique code of the feature. **Character limit**: 255 **Values**: .</param>
        /// <param name="FeatureId"> Internal Zuora ID of the feature. **Character limit**: 32 **Values**: .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="Name"> Name of the feature. **Character limit**: 255 **Values**: .</param>
        /// <param name="RatePlanId"> Id of the product rate plan to which the feature belongs. **Character limit**: 32 **Values**: .</param>
        /// <param name="UpdatedById"> Internal Zuora ID of the user who last updated the subscription product feature. **Character limit**: 32 **Values**: .</param>
        /// <param name="UpdatedDate"> Date and time when the subscription product feature was last updated. **Character limit**: 29 **Values**: .</param>
        public ProxyGetSubscriptionProductFeature(string CreatedById = null, DateTime? CreatedDate = null, string Description = null, string FeatureCode = null, string FeatureId = null, string Id = null, string Name = null, string RatePlanId = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetSubscriptionProductFeature);
        }

        /// <summary>
        /// Returns true if ProxyGetSubscriptionProductFeature instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetSubscriptionProductFeature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetSubscriptionProductFeature other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.FeatureCode.Equals(other.FeatureCode)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FeatureCode != null)
                    hash = hash * 59 + this.FeatureCode.GetHashCode();
