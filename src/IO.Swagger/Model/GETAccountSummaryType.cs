...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountSummaryType :  IEquatable<GETAccountSummaryType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummaryType" /> class.
        /// </summary>
        /// <param name="BasicInfo">BasicInfo.</param>
        /// <param name="BillToContact">BillToContact.</param>
        /// <param name="Invoices">Container for invoices. Only returns the last 6 invoices. .</param>
        /// <param name="Payments">Container for payments. Only returns the last 6 payments. .</param>
        /// <param name="SoldToContact">SoldToContact.</param>
        /// <param name="Subscriptions">Container for subscriptions. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="TaxInfo">TaxInfo.</param>
        /// <param name="Usage">Container for usage data. Only returns the last 6 months of usage. .</param>
        public GETAccountSummaryType(GETAccountSummaryTypeBasicInfo BasicInfo = null, GETAccountSummaryTypeBillToContact BillToContact = null, List<GETAccountSummaryInvoiceType> Invoices = null, List<GETAccountSummaryPaymentType> Payments = null, GETAccountSummaryTypeSoldToContact SoldToContact = null, List<GETAccountSummarySubscriptionType> Subscriptions = null, bool? Success = null, GETAccountSummaryTypeTaxInfo TaxInfo = null, List<GETAccountSummaryUsageType> Usage = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountSummaryType);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountSummaryType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.BasicInfo != null &&
                    this.BasicInfo.Equals(other.BasicInfo)
                ) && 
                (
                ...
                (
                    ...
                    this.Usage != null &&
                    this.Usage.SequenceEqual(other.Usage)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BasicInfo != null)
                    hash = hash * 59 + this.BasicInfo.GetHashCode();
