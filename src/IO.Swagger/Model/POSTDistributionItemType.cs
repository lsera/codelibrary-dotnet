...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTDistributionItemType :  IEquatable<POSTDistributionItemType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTDistributionItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTDistributionItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTDistributionItemType" /> class.
        /// </summary>
        /// <param name="AccountingPeriodName">Name of the accounting period. The open-ended accounting period is named &#x60;Open-Ended&#x60;.   The accounting period must be open.  (required).</param>
        /// <param name="NewAmount">Amount of revenue you want to distribute into the accounting period.  The value must be formatted based on the currency, for example, &#x60;JPY 30&#x60; or &#x60;USD 30.15&#x60;. If the value is formatted incorrectly, the following error message is returned: &#x60;Allocation amount with wrong decimal places.&#x60;  (required).</param>
        public POSTDistributionItemType(string AccountingPeriodName = null, string NewAmount = null)
        {
            // to ensure "AccountingPeriodName" is required (not null)
            if (AccountingPeriodName == null)
            {
                throw new InvalidDataException("AccountingPeriodName is a required property for POSTDistributionItemType and cannot be null");
            }
            else
            {
            ...
            if (NewAmount == null)
            {
                throw new InvalidDataException("NewAmount is a required property for POSTDistributionItemType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTDistributionItemType);
        }

        /// <summary>
        /// Returns true if POSTDistributionItemType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTDistributionItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTDistributionItemType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.NewAmount != null &&
                    this.NewAmount.Equals(other.NewAmount)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NewAmount != null)
                    hash = hash * 59 + this.NewAmount.GetHashCode();
                return hash;
            }
        }
