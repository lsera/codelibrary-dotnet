...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTDecryptResponseType :  IEquatable<POSTDecryptResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTDecryptResponseType" /> class.
        /// </summary>
        /// <param name="DecryptedSignature">The string of a list of the following items: Payment Pages 2.0 URL, tenant ID, timestamp,the Payment Page ID  The items are separated by &#39;#&#39;, e.g., \&quot;/apps/publichostedpagelite.do#12271#rvBp1AxBJwk6FrT7aqFuABIINiRbwJCc #1418848373103#2c92c0f948f899\&quot; .</param>
        /// <param name="PublicKey">The public key passed in as a request parameter. .</param>
        /// <param name="Signature">The signature passed in as a request parameter. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        public POSTDecryptResponseType(string DecryptedSignature = null, string PublicKey = null, string Signature = null, bool? Success = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTDecryptResponseType);
        }

        /// <summary>
        /// Returns true if POSTDecryptResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTDecryptResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTDecryptResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.DecryptedSignature == other.DecryptedSignature ||
                    this.DecryptedSignature != null &&
                    this.DecryptedSignature.Equals(other.DecryptedSignature)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DecryptedSignature != null)
                    hash = hash * 59 + this.DecryptedSignature.GetHashCode();
