...
namespace IO.Swagger.Model
{
    ...
    public partial class POSTSubscriptionType :  IEquatable<POSTSubscriptionType>, IValidatableObject
    {
        ...
        /// <param name="OpportunityCloseDateQT">.</param>
        /// <param name="OpportunityNameQT">.</param>
        /// <param name="QuoteBusinessTypeQT">.</param>
        /// <param name="QuoteNumberQT">.</param>
        /// <param name="QuoteTypeQT">.</param>
        /// <param name="AccountKey">Customer account number or ID  (required).</param>
        /// <param name="ApplyCreditBalance">Applies a credit balance to an invoice.  If the value is &#x60;true&#x60;, the credit balance is applied to the invoice. If the value is &#x60;false&#x60;, no action is taken.  **Prerequisite:** &#x60;invoice&#x60; must be &#x60;true&#x60;.   **Note:** If you are using the field &#x60;invoiceCollect&#x60; rather than the field invoice, the &#x60;invoiceCollect&#x60; value must be &#x60;true&#x60;.  To view the credit balance adjustment, retrieve the details of the invoice using the [Get Invoices](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Transactions/GET_invoices) method. .</param>
        ...
        /// <param name="Collect">Collects an automatic payment for a subscription. The collection generated in this operation is only for this subscription, not for the entire customer account. If the value is &#x60;true&#x60;, the automatic payment is collected. If the value is &#x60;false&#x60;, no action is taken.  The default value is &#x60;true&#x60;.  **Prerequisite:** The invoice field must be &#x60;true&#x60;.   **Note:** This field is in Zuora REST API version control. Supported minor versions are 196.0 or later. To use this field in the method, you must set the &#x60;zuora-version&#x60; field to the minor version number in the request header. See [Zuora REST API Versions](https://knowledgecenter.zuora.com/DC_Developers/REST_API/A_REST_basics#Zuora_REST_API_Versions) for more information. .</param>
        ...
        /// <param name="InitialTerm">The length of the period for the first subscription term. Default is &#x60;0&#x60;. If &#x60;termType&#x60; is &#x60;TERMED&#x60;, then this field is required, and the value must be greater than &#x60;0&#x60;. If &#x60;termType&#x60; is &#x60;EVERGREEN&#x60;, this field is ignored. .</param>
        ...
        public POSTSubscriptionType(string CpqBundleJsonIdQT = null, string OpportunityCloseDateQT = null, string OpportunityNameQT = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, string AccountKey = null, bool? ApplyCreditBalance = null, bool? AutoRenew = null, bool? Collect = null, DateTime? ContractEffectiveDate = null, string CustomFieldC = null, DateTime? CustomerAcceptanceDate = null, long? InitialTerm = null, string InitialTermPeriodType = null, bool? Invoice = null, bool? InvoiceCollect = null, string InvoiceOwnerAccountKey = null, bool? InvoiceSeparately = null, DateTime? InvoiceTargetDate = null, string Notes = null, string RenewalSetting = null, long? RenewalTerm = null, string RenewalTermPeriodType = null, DateTime? ServiceActivationDate = null, List<POSTSrpCreateType> SubscribeToRatePlans = null, string SubscriptionNumber = null, DateTime? TermStartDate = null, string TermType = null)
        {
            // to ensure "AccountKey" is required (not null)
            if (AccountKey == null)
            {
                throw new InvalidDataException("AccountKey is a required property for POSTSubscriptionType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ContractEffectiveDate is a required property for POSTSubscriptionType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SubscribeToRatePlans is a required property for POSTSubscriptionType and cannot be null");
            }
            else
            {
            ...
            if (TermType == null)
            {
                throw new InvalidDataException("TermType is a required property for POSTSubscriptionType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionType);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
