...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETAccountTypeBillingAndPayment :  IEquatable<GETAccountTypeBillingAndPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountTypeBillingAndPayment" /> class.
        /// </summary>
        ...
        /// <param name="Currency">A currency defined in the [administrative web-based UI](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Customize_Currencies). .</param>
        ...
        /// <param name="PaymentTerm">A payment-terms indicator defined in the [web-based UI administrative settings](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Payment_Terms), e.g., \&quot;Net 30\&quot;. .</param>
        public GETAccountTypeBillingAndPayment(string BillCycleDay = null, string Currency = null, string PaymentGateway = null, string PaymentTerm = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETAccountTypeBillingAndPayment);
        }

        /// <summary>
        /// Returns true if GETAccountTypeBillingAndPayment instances are equal
        /// </summary>
        /// <param name="other">Instance of GETAccountTypeBillingAndPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeBillingAndPayment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
