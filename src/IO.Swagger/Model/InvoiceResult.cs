...
namespace IO.Swagger.Model
{
    ...
    public partial class InvoiceResult :  IEquatable<InvoiceResult>, IValidatableObject
    {
        ...
        public InvoiceResult(List<Invoice> Invoice = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoiceResult);
        }

        /// <summary>
        /// Returns true if InvoiceResult instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoiceResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Invoice != null &&
                    this.Invoice.SequenceEqual(other.Invoice)
                );
        }
