...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSubscriptionCancellationResponseType :  IEquatable<POSTSubscriptionCancellationResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionCancellationResponseType" /> class.
        /// </summary>
        /// <param name="CancelledDate">The date that the subscription was canceled. .</param>
        /// <param name="InvoiceId">ID of the invoice, if one is generated. .</param>
        /// <param name="PaidAmount">Amount paid. .</param>
        /// <param name="PaymentId">ID of the payment, if a payment is collected. .</param>
        ...
        public POSTSubscriptionCancellationResponseType(DateTime? CancelledDate = null, string InvoiceId = null, string PaidAmount = null, string PaymentId = null, string SubscriptionId = null, bool? Success = null, string TotalDeltaMrr = null, string TotalDeltaTcv = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionCancellationResponseType);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionCancellationResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionCancellationResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionCancellationResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
