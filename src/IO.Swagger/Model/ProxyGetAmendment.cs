...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetAmendment :  IEquatable<ProxyGetAmendment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetAmendment" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetAmendment {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetAmendment);
        }

        /// <summary>
        /// Returns true if ProxyGetAmendment instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetAmendment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetAmendment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
