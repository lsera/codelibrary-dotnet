...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSubscriptionCancellationType :  IEquatable<POSTSubscriptionCancellationType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionCancellationType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTSubscriptionCancellationType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionCancellationType" /> class.
        /// </summary>
        ...
        /// <param name="CancellationEffectiveDate">Date the cancellation takes effect, in the format yyyy-mm-dd.  Use only if &#x60;cancellationPolicy&#x60; is &#x60;SpecificDate&#x60;. Should not be earlier than the subscription contract-effective date, later than the subscription term-end date, or within a period for which the customer has been invoiced. .</param>
        /// <param name="CancellationPolicy">Cancellation method. Possible values are: &#x60;EndOfCurrentTerm&#x60;, &#x60;EndOfLastInvoicePeriod&#x60;, &#x60;SpecificDate&#x60;. If using &#x60;SpecificDate&#x60;, the &#x60;cancellationEffectiveDate&#x60; field is required.  (required).</param>
        ...
        /// <param name="InvoiceCollect">This field has been replaced by the &#x60;invoice&#x60; field and the &#x60;collect&#x60; field. &#x60;invoiceCollect&#x60; is available only for backward compatibility.  If &#x60;true&#x60;, an invoice is generated and payment automatically collected. Default is &#x60;false&#x60;.  This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://knowledgecenter.zuora.com/DC_Developers/REST_API/A_REST_basics#Zuora_REST_API_Versions) for more information.  (required).</param>
        ...
        public POSTSubscriptionCancellationType(string OpportunityCloseDateQT = null, string OpportunityNameQT = null, string QuoteBusinessTypeQT = null, string QuoteNumberQT = null, string QuoteTypeQT = null, bool? ApplyCreditBalance = null, DateTime? CancellationEffectiveDate = null, string CancellationPolicy = null, bool? Collect = null, bool? Invoice = null, bool? InvoiceCollect = null, DateTime? InvoiceTargetDate = null)
        {
            // to ensure "CancellationPolicy" is required (not null)
            if (CancellationPolicy == null)
            {
                throw new InvalidDataException("CancellationPolicy is a required property for POSTSubscriptionCancellationType and cannot be null");
            }
            else
            {
                this.CancellationPolicy = CancellationPolicy;
            }
            // to ensure "InvoiceCollect" is required (not null)
            if (InvoiceCollect == null)
            {
                throw new InvalidDataException("InvoiceCollect is a required property for POSTSubscriptionCancellationType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTSubscriptionCancellationType);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionCancellationType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSubscriptionCancellationType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionCancellationType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.CancellationEffectiveDate == other.CancellationEffectiveDate ||
                    this.CancellationEffectiveDate != null &&
                    this.CancellationEffectiveDate.Equals(other.CancellationEffectiveDate)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CancellationEffectiveDate != null)
                    hash = hash * 59 + this.CancellationEffectiveDate.GetHashCode();
