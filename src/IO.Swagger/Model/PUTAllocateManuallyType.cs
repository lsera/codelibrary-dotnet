...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTAllocateManuallyType :  IEquatable<PUTAllocateManuallyType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAllocateManuallyType" /> class.
        /// </summary>
        /// <param name="CustomFieldC">Any custom fields defined for this object. .</param>
        /// <param name="EventType">Label of the revenue event type. Revenue event type labels can be duplicated. You can configure your revenue event type labels by navigating to **Settings &gt; Z-Finance Settings &gt; Configure Revenue Event Types** in the Zuora UI. The default revenue event types are: * Invoice Posted * Invoice Item Adjustment Created * Invoice Canceled * Invoice Item Adjustment Canceled * Revenue Distributed  You can create revenue event types from **Finance Settings &gt; Revenue Event Types**. .</param>
        /// <param name="EventTypeSystemId">System ID of the revenue event type. Each eventType has a unique system ID. You can configure your revenue event type system IDs by navigating to **Settings &gt; Z-Finance Settings &gt; Configure Revenue Event Types** in the Zuora UI.  Cannot be duplicated. .</param>
        /// <param name="Notes">Additional information about this record. .</param>
        /// <param name="RevenueDistributions">An array of revenue distributions. Represents how you want to distribute revenue for this revenue schedule. You can distribute revenue into a maximum of 250 accounting periods with one revenue schedule. .</param>
        public PUTAllocateManuallyType(string CustomFieldC = null, string EventType = null, string EventTypeSystemId = null, string Notes = null, List<POSTDistributionItemType> RevenueDistributions = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTAllocateManuallyType);
        }

        /// <summary>
        /// Returns true if PUTAllocateManuallyType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTAllocateManuallyType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAllocateManuallyType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
