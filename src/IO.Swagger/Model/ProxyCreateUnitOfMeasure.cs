...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateUnitOfMeasure :  IEquatable<ProxyCreateUnitOfMeasure>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateUnitOfMeasure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateUnitOfMeasure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateUnitOfMeasure" /> class.
        /// </summary>
        ...
        /// <param name="UomName"> The name of the UOM, such as license or GB. This name is displayed in query results and in the web-based UI labels. If you want a different name to be displayed on invoices, then use the &#x60;DisplayedAs&#x60; field to provide the invoice label. **Character limit**: 50 **Values**: a string of 50 characters or fewer  (required).</param>
        public ProxyCreateUnitOfMeasure(bool? Active = null, long? DecimalPlaces = null, string DisplayedAs = null, string RoundingMode = null, string UomName = null)
        {
            // to ensure "UomName" is required (not null)
            if (UomName == null)
            {
                throw new InvalidDataException("UomName is a required property for ProxyCreateUnitOfMeasure and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateUnitOfMeasure {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateUnitOfMeasure);
        }

        /// <summary>
        /// Returns true if ProxyCreateUnitOfMeasure instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateUnitOfMeasure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateUnitOfMeasure other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
