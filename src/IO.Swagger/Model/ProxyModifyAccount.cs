...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyModifyAccount :  IEquatable<ProxyModifyAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyAccount" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyAccount {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyModifyAccount);
        }

        /// <summary>
        /// Returns true if ProxyModifyAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyModifyAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
