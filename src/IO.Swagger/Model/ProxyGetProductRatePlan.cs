...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetProductRatePlan :  IEquatable<ProxyGetProductRatePlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetProductRatePlan" /> class.
        /// </summary>
        /// <param name="CreatedById">The ID of the Zuora user who created the &#x60;ProductRatePlan&#x60; object. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate"> The date when the &#x60;ProductRatePlan&#x60; object was created. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="Description">A description of the product rate plan. **Character limit**: 500 **Values**: a string of 500 characters or fewer .</param>
        /// <param name="EffectiveEndDate"> The date when the product rate plan expires and can&#39;t be subscribed to. **Character limit**: 29 **Values**: [a valid date and time value](/CB_Billing/WA_Dates_in_Zuora/A_Date_and_dateTime_Format) .</param>
        /// <param name="EffectiveStartDate"> The date when the product rate plan becomes available and can be subscribed to. **Character limit**: 29 **Values**: [a valid date and time value](/CB_Billing/WA_Dates_in_Zuora/A_Date_and_dateTime_Format) .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="Name">The name of the product rate plan. The name doesn&#39;t have to be unique in a Product Catalog, but the name has to be unique within a product. **Character limit**: 100 **Values**: a string of 100 characters or fewer .</param>
        /// <param name="ProductId">The [ID of the product](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Product) that contains the product rate plan. **Character limit**: 32 **Values**: a string of 32 characters or fewer .</param>
        ...
        public ProxyGetProductRatePlan(string CreatedById = null, DateTime? CreatedDate = null, string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Id = null, string Name = null, string ProductId = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetProductRatePlan);
        }

        /// <summary>
        /// Returns true if ProxyGetProductRatePlan instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetProductRatePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetProductRatePlan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
