...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetHostedPageType :  IEquatable<GetHostedPageType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHostedPageType" /> class.
        /// </summary>
        /// <param name="PageId">Page ID of the Payment Page that Zuora assigns when it is created. .</param>
        /// <param name="PageName">Name of the Payment Page that specified during the page configuration. .</param>
        /// <param name="PageType">Payment method type of this Payment Page, e.g. &#39;Credit Card&#39;, &#39;ACH&#39;, or &#39;Bank Transfer&#39;. .</param>
        /// <param name="PageVersion">Version of the Payment Page. 1 for Payment Pages 1.0 or 2 for Payment Pages 2.0. .</param>
        public GetHostedPageType(string PageId = null, string PageName = null, string PageType = null, string PageVersion = null)
        {
            this.PageId = PageId;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetHostedPageType);
        }

        /// <summary>
        /// Returns true if GetHostedPageType instances are equal
        /// </summary>
        /// <param name="other">Instance of GetHostedPageType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHostedPageType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.PageVersion == other.PageVersion ||
                    this.PageVersion != null &&
                    this.PageVersion.Equals(other.PageVersion)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PageVersion != null)
                    hash = hash * 59 + this.PageVersion.GetHashCode();
                return hash;
            }
        }
