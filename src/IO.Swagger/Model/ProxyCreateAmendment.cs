...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateAmendment :  IEquatable<ProxyCreateAmendment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAmendment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateAmendment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAmendment" /> class.
        /// </summary>
        ...
        /// <param name="RenewalSetting"> Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed. **Required**: If TermType is Termed **Values**: RENEW_WITH_SPECIFIC_TERM (default), RENEW_TO_EVERGREEN  (required).</param>
        ...
        public ProxyCreateAmendment(bool? AutoRenew = null, DateTime? ContractEffectiveDate = null, long? CurrentTerm = null, string CurrentTermPeriodType = null, DateTime? CustomerAcceptanceDate = null, string Description = null, DateTime? EffectiveDate = null, string Name = null, string RenewalSetting = null, long? RenewalTerm = null, string RenewalTermPeriodType = null, DateTime? ServiceActivationDate = null, DateTime? SpecificUpdateDate = null, string Status = null, string SubscriptionId = null, DateTime? TermStartDate = null, string TermType = null, string Type = null)
        {
            // to ensure "RenewalSetting" is required (not null)
            if (RenewalSetting == null)
            {
                throw new InvalidDataException("RenewalSetting is a required property for ProxyCreateAmendment and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateAmendment);
        }

        /// <summary>
        /// Returns true if ProxyCreateAmendment instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateAmendment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateAmendment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
