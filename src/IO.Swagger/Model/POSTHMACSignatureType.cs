...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTHMACSignatureType :  IEquatable<POSTHMACSignatureType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTHMACSignatureType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTHMACSignatureType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTHMACSignatureType" /> class.
        /// </summary>
        /// <param name="AccountKey">Customer account number or ID.  Specifies this field only when creating signatures for [Create payment method](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Payment_methods/1_Create_payment_method). .</param>
        /// <param name="Method">Possible values are: &#39;GET&#39;, &#39;POST&#39;, &#39;PUT&#39;, &#39;DELETE&#39;, &#39;OPTIONS&#39;.  (required).</param>
        /// <param name="Name">Account name.  Specifies this field only when creating signatures for [Create account](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Accounts/1_Create_account). .</param>
        /// <param name="PageId">The page id of your Payment Pages 2.0 form. Click **Show Page Id** next to the Payment Page name in the Hosted Page List to retrieve the page id.  Specifies this field only when creating signatures for [RSA Signatures](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/RSA_Signatures). .</param>
        /// <param name="Uri">The URI of the API object the customer will make a CORS enabled call to. e.g. \&quot;https://api.zuora.com/rest/v1/payment-methods/credit-cards\&quot;  (required).</param>
        public POSTHMACSignatureType(string AccountKey = null, string Method = null, string Name = null, string PageId = null, string Uri = null)
        {
            // to ensure "Method" is required (not null)
            if (Method == null)
            {
                throw new InvalidDataException("Method is a required property for POSTHMACSignatureType and cannot be null");
            }
            else
            {
                this.Method = Method;
            ...
            if (Uri == null)
            {
                throw new InvalidDataException("Uri is a required property for POSTHMACSignatureType and cannot be null");
            }
            else
            {
                this.Uri = Uri;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTHMACSignatureType);
        }

        /// <summary>
        /// Returns true if POSTHMACSignatureType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTHMACSignatureType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTHMACSignatureType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
