...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyCreateProduct :  IEquatable<ProxyCreateProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateProduct" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateProduct() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateProduct" /> class.
        /// </summary>
        /// <param name="AllowFeatureChanges"> Controls whether to allow your users to add or remove features while creating or amending a subscription. **Character** **limit**: n/a **notes**: WSDL 58.0+ **Values**: true, false (default) .</param>
        /// <param name="Category"> Category of the product. Used by Zuora Quotes Guided Product Selector. **Character** **limit**: 100 **notes**: WSDL16.0+ **Values**: One of the following:  - Base Products - Add On Services - Miscellaneous Products .</param>
        /// <param name="Description"> A descriptionof the product. **Character limit**: 500 **Values**: a string of 500 characters or fewer .</param>
        /// <param name="EffectiveEndDate">The date when the product expires and can&#39;t be subscribed to anymore. **Character limit**: 29 **Values**: a valid date and time value  (required).</param>
        /// <param name="EffectiveStartDate">The date when the product becomes available and can be subscribed to. **Character limit**: 29 **Values**: a valid date and time value  (required).</param>
        /// <param name="Name">The name of the product. This information is displayed in the product catalog pages in the web-based UI. **Character limit**: 100 **Values**: a string of 100 characters or fewer  (required).</param>
        /// <param name="SKU">The unique SKU for the product. **Character limit**: 50 **Values**: one of the following:  - leave null for automatic generated - an alphanumeric string of 50 characters or fewer .</param>
        public ProxyCreateProduct(bool? AllowFeatureChanges = null, string Category = null, string Description = null, DateTime? EffectiveEndDate = null, DateTime? EffectiveStartDate = null, string Name = null, string SKU = null)
        {
            // to ensure "EffectiveEndDate" is required (not null)
            if (EffectiveEndDate == null)
            {
                throw new InvalidDataException("EffectiveEndDate is a required property for ProxyCreateProduct and cannot be null");
            }
            else
            {
                this.EffectiveEndDate = EffectiveEndDate;
            }
            // to ensure "EffectiveStartDate" is required (not null)
            if (EffectiveStartDate == null)
            {
                throw new InvalidDataException("EffectiveStartDate is a required property for ProxyCreateProduct and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for ProxyCreateProduct and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyCreateProduct);
        }

        /// <summary>
        /// Returns true if ProxyCreateProduct instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyCreateProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateProduct other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.AllowFeatureChanges == other.AllowFeatureChanges ||
                    this.AllowFeatureChanges != null &&
                    this.AllowFeatureChanges.Equals(other.AllowFeatureChanges)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AllowFeatureChanges != null)
                    hash = hash * 59 + this.AllowFeatureChanges.GetHashCode();
