...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTInvoiceCollectType :  IEquatable<POSTInvoiceCollectType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTInvoiceCollectType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTInvoiceCollectType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTInvoiceCollectType" /> class.
        /// </summary>
        /// <param name="AccountKey">Customer account ID or account number.  (required).</param>
        /// <param name="InvoiceDate">The invoice date that should appear on the invoice being generated, in &#x60;yyyy-mm-dd&#x60; format. If &#x60;invoiceId&#x60; is not specified and this value is omitted, the current date is used by default. .</param>
        /// <param name="InvoiceId">The ID of an existing invoice for which to collect payment using the account&#39;s default payment method. If this value is specified, no new invoice is generated, and both &#x60;invoiceDate&#x60; and &#x60;invoiceTargetDate&#x60; are ignored. .</param>
        /// <param name="InvoiceTargetDate">The date, in &#x60;yyyy-mm-dd&#x60; format, through which charges on this account will be processed when generating a new invoice.If &#x60;invoiceId&#x60; is not specified and this value is omitted, the current date is used by default. .</param>
        /// <param name="PaymentGateway">The name of the gateway that will be used for the payment. Must be a valid gateway name and the gateway must support the specific payment method. If a value is not specified, the default gateway on the Account will be used. .</param>
        public POSTInvoiceCollectType(string AccountKey = null, DateTime? InvoiceDate = null, string InvoiceId = null, DateTime? InvoiceTargetDate = null, string PaymentGateway = null)
        {
            // to ensure "AccountKey" is required (not null)
            if (AccountKey == null)
            {
                throw new InvalidDataException("AccountKey is a required property for POSTInvoiceCollectType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTInvoiceCollectType);
        }

        /// <summary>
        /// Returns true if POSTInvoiceCollectType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTInvoiceCollectType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTInvoiceCollectType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
