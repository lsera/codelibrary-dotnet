...
namespace IO.Swagger.Model
{
    ...
    public partial class PaymentMethod :  IEquatable<PaymentMethod>, IValidatableObject
    {
        ...
        /// <param name="AchAccountNumber"> The bank account number associated with the ACH payment. Use this field for ACH payment methods. **Character limit**: 30 **Values**: a string of 30 numeric characters or fewer .</param>
        /// <param name="AchAccountNumberMask"> This is a masked displayable version of the ACH account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;. Use this field for ACH payment methods. **Character limit**: 32 **Values**: automatically generated .</param>
        ...
        /// <param name="Active"> Specifies whether a payment method is available in Zuora. The default value is &#x60;false&#x60;. **Character limit**: 5 **Values**: &#x60;true&#x60;, &#x60;false&#x60; .</param>
        ...
        /// <param name="BankIdentificationNumber"> The first six digits of the payment method&#39;s number, such as the credit card number or account number. Banks use this number to identify a payment method. **Character limit**: 6 **Values**:  string of 6 characters or fewer .</param>
        ...
        /// <param name="BankTransferAccountNumber"> The number of the customer&#39;s bank account. Use this field for direct debit payment methods. **Character limit**:30 **Values**:  string of 30 characters or fewer .</param>
        /// <param name="BankTransferAccountNumberMask"> This is a masked displayable version of the ACH account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="BankTransferAccountType"> The type of the customer&#39;s bank account. Use this field for direct debit payment methods. **Character limit**: 11 **Values**: &#x60;DirectDebit&#x60; .</param>
        /// <param name="BankTransferType"> Specifies the type of direct debit transfer. The value of this field is dependent on the country of the user. Use this field is used for direct debit payment methods. **Character limit**: 20 **Values**:  - &#x60;AutomatischIncasso&#x60; (NL) - &#x60;LastschriftDE&#x60; (Germany) - &#x60;LastschriftAT&#x60; (Austria) - &#x60;DemandeDePrelevement&#x60; (FR) - &#x60;DirectDebitUK&#x60; (UK) - &#x60;Domicil&#x60; (Belgium) - &#x60;LastschriftCH&#x60; (CH) - &#x60;RID&#x60; (Italy) - &#x60;OrdenDeDomiciliacion&#x60; (Spain) .</param>
        ...
        /// <param name="CreatedById"> The user ID of the person who created the &#x60;PaymentMethod&#x60; object when there is a login user in the user session. In Hosted Payment Method and Z-Checkout pages, this field is set to 3 as there is no login user to initiate a user session. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate"> The date when the &#x60;PaymentMethod&#x60; object was created in the Zuora system. **Character limit**: 29 **Values**: automatically generated .</param>
        ...
        /// <param name="CreditCardMaskNumber"> A masked version of the credit or debit card number. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreditCardNumber"> The credit card or debit card number. This is an insert-only field; it cannot be updated nor queried for security purposes. This field is required only when you define a debit card or credit card payment. **Character limit**: 16 **Values**: a string of 16 characters or fewer .</param>
        ...
        /// <param name="GatewayOptionData"> Use this field to pass gateway options. **Character limit**: 255 **Values**: [GatewayOption](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Payment/Pass_Gateway_Parameters) .</param>
        ...
        /// <param name="Id"> The ID of this object. Upon creation, the ID of this object is &#x60;PaymentMethodId&#x60;. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="LastFailedSaleTransactionDate"> The date of the last failed attempt to collect payment with this payment method. **Character limit**: 29 **Values**: automatically generated .</param>
        ...
        /// <param name="Name"> Create Query Delete Filter .</param>
        ...
        /// <param name="PaypalBaid"> The PayPal billing agreement ID, which is a contract between two PayPal accounts. Typically, the selling party initiates a request to create a BAID, and sends it to buying party for acceptance. The seller can keep track of the BAID and use it for future charges against the buyer. This field is required when defining a PayPal payment method. **Character limit**: 64 **Values**: a string of 64 characters or fewer .</param>
        /// <param name="PaypalEmail"> The email address associated with the account holder&#39;s PayPal account or of the PayPal account of the person paying for the service. This field is required only when you define a PayPal payment method. **Character limit**: 80 **Values**: a string of 80 characters or fewer .</param>
        /// <param name="PaypalPreapprovalKey"> PayPal&#39;s Adaptive Payments API key. Zuora does not create this key, nor does it call PayPal to generate it. You must use PayPal&#39;s Adaptive Payments&#39; API to generate this key, and then pass it to Zuora. Zuora uses this key to authorize future payments to PayPal&#39;s Adaptive Payments API. This field is required when you use PayPal Adaptive Payments gateway. **Character limit**: 32 **Values**: a valid PayPal Adaptive Payment pre-approval key .</param>
        /// <param name="PaypalType"> Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments. This field is required when you use PayPal Adaptive Payments or Payflow Pro (Express Checkout) gateways. **Character limit**: 32 **Values**: &#x60;ExpressCheckout&#x60;, &#x60;AdaptivePayments&#x60; .</param>
        ...
        /// <param name="SecondTokenId"> A gateway unique identifier that replaces sensitive payment method data. SecondTokenId is conditionally required only when TokenID is being used to represent a gateway customer profile. SecondTokenId is used in the CC Reference Transaction payment method. **Character limit**: 64 **Values**: a string of 64 characters or fewer .</param>
        /// <param name="SkipValidation"> Creates the payment method even if authorization fails with the payment gateway. **Character limit**: 5 **Values**: &#x60;t&#x60;&#x60;rue&#x60;, &#x60;false&#x60; .</param>
        ...
        /// <param name="TokenId"> A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. When TokenId is used to represent a customer profile, then SecondTokenId is conditionally required for representing the underlying tokenized payment method. TokenId is required for the CC Reference Transaction payment method. **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        /// <param name="TotalNumberOfErrorPayments"> The number of error payments that used this payment method. **Character limit**: **Values**: automatically generated .</param>
        /// <param name="TotalNumberOfProcessedPayments"> The number of successful payments that used this payment method. **Character limit**: **Values**: automatically generated .</param>
        /// <param name="Type"> Create Query Update Delete Filter .</param>
        /// <param name="UpdatedById"> The ID of the user who last updated the payment method. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="UpdatedDate"> The date when the payment method was last updated. **Character limit**: 29 **Values**: automatically generated .</param>
        ...
        public PaymentMethod(string AccountId = null, string AchAbaCode = null, string AchAccountName = null, string AchAccountNumber = null, string AchAccountNumberMask = null, string AchAccountType = null, string AchAddress1 = null, string AchAddress2 = null, string AchBankName = null, bool? Active = null, string BankBranchCode = null, string BankCheckDigit = null, string BankCity = null, string BankCode = null, string BankIdentificationNumber = null, string BankName = null, string BankPostalCode = null, string BankStreetName = null, string BankStreetNumber = null, string BankTransferAccountName = null, string BankTransferAccountNumber = null, string BankTransferAccountNumberMask = null, string BankTransferAccountType = null, string BankTransferType = null, string BusinessIdentificationCode = null, string City = null, string Country = null, string CreatedById = null, DateTime? CreatedDate = null, string CreditCardAddress1 = null, string CreditCardAddress2 = null, string CreditCardCity = null, string CreditCardCountry = null, int? CreditCardExpirationMonth = null, int? CreditCardExpirationYear = null, string CreditCardHolderName = null, string CreditCardMaskNumber = null, string CreditCardNumber = null, string CreditCardPostalCode = null, string CreditCardSecurityCode = null, string CreditCardState = null, string CreditCardType = null, string DeviceSessionId = null, string Email = null, string ExistingMandate = null, string FirstName = null, GatewayOptionData GatewayOptionData = null, string IBAN = null, string IPAddress = null, string Id = null, DateTime? LastFailedSaleTransactionDate = null, string LastName = null, DateTime? LastTransactionDateTime = null, string LastTransactionStatus = null, DateTime? MandateCreationDate = null, string MandateID = null, string MandateReceived = null, DateTime? MandateUpdateDate = null, int? MaxConsecutivePaymentFailures = null, string Name = null, int? NumConsecutiveFailures = null, string PaymentMethodStatus = null, int? PaymentRetryWindow = null, string PaypalBaid = null, string PaypalEmail = null, string PaypalPreapprovalKey = null, string PaypalType = null, string Phone = null, string PostalCode = null, string SecondTokenId = null, bool? SkipValidation = null, string State = null, string StreetName = null, string StreetNumber = null, string TokenId = null, int? TotalNumberOfErrorPayments = null, int? TotalNumberOfProcessedPayments = null, string Type = null, string UpdatedById = null, DateTime? UpdatedDate = null, bool? UseDefaultRetryRule = null)
        {
        ...
        /// </summary>
        /// <value> The bank account number associated with the ACH payment. Use this field for ACH payment methods. **Character limit**: 30 **Values**: a string of 30 numeric characters or fewer </value>
        [DataMember(Name="AchAccountNumber", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value> The number of the customer&#39;s bank account. Use this field for direct debit payment methods. **Character limit**:30 **Values**:  string of 30 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The credit card or debit card number. This is an insert-only field; it cannot be updated nor queried for security purposes. This field is required only when you define a debit card or credit card payment. **Character limit**: 16 **Values**: a string of 16 characters or fewer </value>
        ...
        /// <summary>
        ///  Use this field to pass gateway options. **Character limit**: 255 **Values**: [GatewayOption](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Payment/Pass_Gateway_Parameters) 
        /// </summary>
        /// <value> Use this field to pass gateway options. **Character limit**: 255 **Values**: [GatewayOption](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Payment/Pass_Gateway_Parameters) </value>
        [DataMember(Name="GatewayOptionData", EmitDefaultValue=false)]
        public GatewayOptionData GatewayOptionData { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value> The ID of this object. Upon creation, the ID of this object is &#x60;PaymentMethodId&#x60;. **Character limit**: 32 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> Creates the payment method even if authorization fails with the payment gateway. **Character limit**: 5 **Values**: &#x60;t&#x60;&#x60;rue&#x60;, &#x60;false&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AchAccountNumber: ").Append(AchAccountNumber).Append("\n");
            ...
            sb.Append("  GatewayOptionData: ").Append(GatewayOptionData).Append("\n");
        ...
        public bool Equals(PaymentMethod other)
        {
            ...
            return 
                ...
                (
                    this.AchAccountNumber == other.AchAccountNumber ||
                    this.AchAccountNumber != null &&
                    this.AchAccountNumber.Equals(other.AchAccountNumber)
                ) && 
                (
                ...
                (
                    this.CreditCardSecurityCode == other.CreditCardSecurityCode ||
                    this.CreditCardSecurityCode != null &&
                    this.CreditCardSecurityCode.Equals(other.CreditCardSecurityCode)
                ) && 
                (
                ...
                (
                    this.GatewayOptionData == other.GatewayOptionData ||
                    this.GatewayOptionData != null &&
                    this.GatewayOptionData.Equals(other.GatewayOptionData)
                ) && 
                (
                ...
                (
                    ...
                    this.SkipValidation.Equals(other.SkipValidation)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AchAccountNumber != null)
                    hash = hash * 59 + this.AchAccountNumber.GetHashCode();
                ...
                if (this.GatewayOptionData != null)
                    hash = hash * 59 + this.GatewayOptionData.GetHashCode();
                if (this.IBAN != null)
                ...
                if (this.SkipValidation != null)
                    hash = hash * 59 + this.SkipValidation.GetHashCode();
                if (this.State != null)
