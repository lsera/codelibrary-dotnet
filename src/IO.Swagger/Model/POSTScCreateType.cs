...
namespace IO.Swagger.Model
{
    ...
    public partial class POSTScCreateType :  IEquatable<POSTScCreateType>, IValidatableObject
    {
        ...
        /// <param name="Quantity">Number of units. Must be a decimal &gt;&#x3D;&#x60;0&#x60;.  (required).</param>
        ...
        public POSTScCreateType(string ApplyDiscountTo = null, string BillCycleDay = null, string BillCycleType = null, string BillingPeriod = null, string BillingPeriodAlignment = null, string BillingTiming = null, string CustomFieldC = null, string Description = null, string DiscountAmount = null, string DiscountLevel = null, string DiscountPercentage = null, string EndDateCondition = null, string IncludedUnits = null, string ListPriceBase = null, string Number = null, long? NumberOfPeriods = null, string OveragePrice = null, string OverageUnusedUnitsCreditOption = null, string Price = null, string PriceChangeOption = null, string PriceIncreasePercentage = null, string ProductRatePlanChargeId = null, string Quantity = null, string RatingGroup = null, long? SpecificBillingPeriod = null, DateTime? SpecificEndDate = null, List<POSTTierType> Tiers = null, DateTime? TriggerDate = null, string TriggerEvent = null, string UnusedUnitsCreditRates = null, long? UpToPeriods = null, string UpToPeriodsType = null, string WeeklyBillCycleDay = null)
        {
            // to ensure "ProductRatePlanChargeId" is required (not null)
            if (ProductRatePlanChargeId == null)
            {
                throw new InvalidDataException("ProductRatePlanChargeId is a required property for POSTScCreateType and cannot be null");
            }
            else
            {
            ...
            if (Quantity == null)
            {
                throw new InvalidDataException("Quantity is a required property for POSTScCreateType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTScCreateType);
        }

        /// <summary>
        /// Returns true if POSTScCreateType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTScCreateType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTScCreateType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
