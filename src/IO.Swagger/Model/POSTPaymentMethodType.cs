...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTPaymentMethodType :  IEquatable<POSTPaymentMethodType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPaymentMethodType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTPaymentMethodType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPaymentMethodType" /> class.
        /// </summary>
        /// <param name="AccountKey">ID of the customer account to update.  (required).</param>
        /// <param name="CardHolderInfo">CardHolderInfo.</param>
        /// <param name="CreditCardNumber">Credit card number, a string of up to 16 characters. This field can only be set when creating a new payment method; it cannot be queried or updated.  (required).</param>
        /// <param name="CreditCardType">Possible values are: &#x60;Visa&#x60;, &#x60;MasterCard&#x60;, &#x60;AmericanExpress&#x60;, &#x60;Discover&#x60;.  (required).</param>
        /// <param name="DefaultPaymentMethod">Specify true to make this card the default payment method; otherwise, omit this parameter to keep the current default payment method. .</param>
        /// <param name="ExpirationMonth">Two-digit expiration month (01-12).  (required).</param>
        /// <param name="ExpirationYear">Four-digit expiration year.  (required).</param>
        /// <param name="SecurityCode">The CVV or CVV2 security code for the credit card or debit card. Only required if changing expirationMonth, expirationYear, or cardHolderName. To ensure PCI compliance, this value isn&#39;t stored and can&#39;t be queried. For more information, see [How do I control what information Zuora sends over to the Payment Gateway?](https://knowledgecenter.zuora.com/kb/How_do_I_control_what_information_Zuora_sends_over_to_the_payment_gateway_when_verifying_payment_methods%3F) .</param>
        public POSTPaymentMethodType(string AccountKey = null, POSTPaymentMethodTypeCardHolderInfo CardHolderInfo = null, string CreditCardNumber = null, string CreditCardType = null, bool? DefaultPaymentMethod = null, string ExpirationMonth = null, string ExpirationYear = null, string SecurityCode = null)
        {
            // to ensure "AccountKey" is required (not null)
            if (AccountKey == null)
            {
                throw new InvalidDataException("AccountKey is a required property for POSTPaymentMethodType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CreditCardNumber is a required property for POSTPaymentMethodType and cannot be null");
            }
            else
            {
                this.CreditCardNumber = CreditCardNumber;
            }
            // to ensure "CreditCardType" is required (not null)
            if (CreditCardType == null)
            {
                throw new InvalidDataException("CreditCardType is a required property for POSTPaymentMethodType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationMonth is a required property for POSTPaymentMethodType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ExpirationYear is a required property for POSTPaymentMethodType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTPaymentMethodType);
        }

        /// <summary>
        /// Returns true if POSTPaymentMethodType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTPaymentMethodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPaymentMethodType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.CardHolderInfo == other.CardHolderInfo ||
                    this.CardHolderInfo != null &&
                    this.CardHolderInfo.Equals(other.CardHolderInfo)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CardHolderInfo != null)
                    hash = hash * 59 + this.CardHolderInfo.GetHashCode();
