...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETProductRatePlanChargePricingType :  IEquatable<GETProductRatePlanChargePricingType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETProductRatePlanChargePricingType" /> class.
        /// </summary>
        /// <param name="Currency">Currency used by the charge model. For example: USD or EUR .</param>
        /// <param name="DiscountAmount">Value subtracted from price in currency specified. Used only when the charge model is DiscountFixedAmount. .</param>
        /// <param name="DiscountPercentage">Percent discount applied to the price. Used only when the charge model is DiscountPercentage. .</param>
        /// <param name="IncludedUnits">Specifies the number of units in the base set of units when the charge model is Overage. .</param>
        /// <param name="OveragePrice">Price per unit when base set of units is exceeded. Used only when charge model is Overage or Tiered with Overage. .</param>
        /// <param name="Price">The decimal value that applies when the charge model is not tiered .</param>
        /// <param name="Tiers">Container for one or many defined tier ranges with distinct pricing.  Applies when model is &#x60;Tiered&#x60;, &#x60;TieredWithOverage&#x60;, or &#x60;Volume&#x60; .</param>
        public GETProductRatePlanChargePricingType(string Currency = null, string DiscountAmount = null, string DiscountPercentage = null, string IncludedUnits = null, string OveragePrice = null, string Price = null, List<GETProductRatePlanChargePricingTierType> Tiers = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETProductRatePlanChargePricingType);
        }

        /// <summary>
        /// Returns true if GETProductRatePlanChargePricingType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETProductRatePlanChargePricingType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductRatePlanChargePricingType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
