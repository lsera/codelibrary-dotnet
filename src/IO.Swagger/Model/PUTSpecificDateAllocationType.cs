...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PUTSpecificDateAllocationType :  IEquatable<PUTSpecificDateAllocationType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSpecificDateAllocationType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTSpecificDateAllocationType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSpecificDateAllocationType" /> class.
        /// </summary>
        ...
        /// <param name="DistributeOn">The recognition date on which to distribute revenue for milestone-based recognition.  Type: date in &#x60;YYYY-MM-DD&#x60; format.  (required).</param>
        /// <param name="DistributionType">How to distribute the revenue for milestone-based recognition.  Possible values are: * specific date (delta fixed amount) * specific date (delta percent total) * specific date (delta percent undistributed)  (required).</param>
        /// <param name="EventType">Label of the revenue event type. Revenue event type labels can be duplicated. You can configure your revenue event type labels by navigating to **Settings &gt; Z-Finance Settings &gt; Configure Revenue Event Types** in the Zuora UI. The default revenue event types are: * Invoice Posted * Invoice Item Adjustment Created * Invoice Canceled * Invoice Item Adjustment Canceled * Revenue Distributed .</param>
        /// <param name="EventTypeSystemId">System ID of the revenue event type. Each eventType has a unique system ID. You can configure your revenue event type system IDs by navigating to **Settings &gt; Z-Finance Settings &gt; Configure Revenue Event Types** in the Zuora UI. .</param>
        /// <param name="Notes">Additional information about this record. .</param>
        /// <param name="Percentage">Percentage of the total recognition amount or total undistributed to distribute.  Required if distributionType is either: * specific date (delta percent total) * specific date (delta percent undistributed) .</param>
        public PUTSpecificDateAllocationType(string Amount = null, string CustomFieldC = null, DateTime? DistributeOn = null, string DistributionType = null, string EventType = null, string EventTypeSystemId = null, string Notes = null, string Percentage = null)
        {
            // to ensure "DistributeOn" is required (not null)
            if (DistributeOn == null)
            {
                throw new InvalidDataException("DistributeOn is a required property for PUTSpecificDateAllocationType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DistributionType is a required property for PUTSpecificDateAllocationType and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PUTSpecificDateAllocationType);
        }

        /// <summary>
        /// Returns true if PUTSpecificDateAllocationType instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTSpecificDateAllocationType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSpecificDateAllocationType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.DistributeOn == other.DistributeOn ||
                    this.DistributeOn != null &&
                    this.DistributeOn.Equals(other.DistributeOn)
                ) && 
                (
                    this.DistributionType == other.DistributionType ||
                    this.DistributionType != null &&
                    this.DistributionType.Equals(other.DistributionType)
                ) && 
                (
                ...
                (
                    this.EventTypeSystemId == other.EventTypeSystemId ||
                    this.EventTypeSystemId != null &&
                    this.EventTypeSystemId.Equals(other.EventTypeSystemId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DistributeOn != null)
                    hash = hash * 59 + this.DistributeOn.GetHashCode();
                if (this.DistributionType != null)
                    hash = hash * 59 + this.DistributionType.GetHashCode();
                if (this.EventType != null)
                    hash = hash * 59 + this.EventType.GetHashCode();
                if (this.EventTypeSystemId != null)
                    hash = hash * 59 + this.EventTypeSystemId.GetHashCode();
                if (this.Notes != null)
