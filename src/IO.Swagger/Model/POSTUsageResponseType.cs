...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTUsageResponseType :  IEquatable<POSTUsageResponseType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTUsageResponseType" /> class.
        /// </summary>
        /// <param name="CheckImportStatus">URL for checking the status of the import operation.  Possible status values at this URL are:&#x60;Pending&#x60;, &#x60;Processing&#x60;, &#x60;Completed&#x60;, &#x60;Canceled&#x60;, &#x60;Failed&#x60;.  Only a status of Completed indicates that the file contents were imported successfully. .</param>
        ...
        public POSTUsageResponseType(string CheckImportStatus = null, long? Size = null, bool? Success = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTUsageResponseType);
        }

        /// <summary>
        /// Returns true if POSTUsageResponseType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTUsageResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTUsageResponseType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.CheckImportStatus == other.CheckImportStatus ||
                    this.CheckImportStatus != null &&
                    this.CheckImportStatus.Equals(other.CheckImportStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CheckImportStatus != null)
                    hash = hash * 59 + this.CheckImportStatus.GetHashCode();
                if (this.Size != null)
