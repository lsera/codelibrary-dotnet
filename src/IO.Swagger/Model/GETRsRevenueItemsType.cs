...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETRsRevenueItemsType :  IEquatable<GETRsRevenueItemsType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRsRevenueItemsType" /> class.
        /// </summary>
        ...
        public GETRsRevenueItemsType(List<GETRsRevenueItemType> RevenueItems = null, bool? Success = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRsRevenueItemsType {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETRsRevenueItemsType);
        }

        /// <summary>
        /// Returns true if GETRsRevenueItemsType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETRsRevenueItemsType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRsRevenueItemsType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
