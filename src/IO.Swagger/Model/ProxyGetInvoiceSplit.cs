...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProxyGetInvoiceSplit :  IEquatable<ProxyGetInvoiceSplit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoiceSplit" /> class.
        /// </summary>
        /// <param name="CreatedById">The ID of the Zuora user who created the InvoiceSplit object. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="CreatedDate">The date when the InvoiceSplit object was created. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="Id">Object identifier..</param>
        /// <param name="InvoiceId"> The ID of the original invoice that the InvoiceSplit object splits. This field becomes read-only after the InvoiceSplit object is created. **Character limit**: 32 **Values**: a valid [invoice ID](https://knowledgecenter.zuora.com/BC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Invoice) .</param>
        ...
        public ProxyGetInvoiceSplit(string CreatedById = null, DateTime? CreatedDate = null, string Id = null, string InvoiceId = null, string UpdatedById = null, DateTime? UpdatedDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProxyGetInvoiceSplit);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceSplit instances are equal
        /// </summary>
        /// <param name="other">Instance of ProxyGetInvoiceSplit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceSplit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
