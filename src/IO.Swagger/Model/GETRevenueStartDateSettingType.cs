...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETRevenueStartDateSettingType :  IEquatable<GETRevenueStartDateSettingType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRevenueStartDateSettingType" /> class.
        /// </summary>
        /// <param name="StartDate">The date on which revenue automation starts. This is the first day of an accounting period. .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="UpdatedBy">The user who made the change. .</param>
        /// <param name="UpdatedOn">The date when the revenue automation start date was set. .</param>
        public GETRevenueStartDateSettingType(DateTime? StartDate = null, bool? Success = null, string UpdatedBy = null, DateTime? UpdatedOn = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETRevenueStartDateSettingType);
        }

        /// <summary>
        /// Returns true if GETRevenueStartDateSettingType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETRevenueStartDateSettingType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRevenueStartDateSettingType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
