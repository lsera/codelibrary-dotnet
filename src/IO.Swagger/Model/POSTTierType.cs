...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class POSTTierType :  IEquatable<POSTTierType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTierType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTTierType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTierType" /> class.
        /// </summary>
        /// <param name="EndingUnit">End number of a range of units for the tier. .</param>
        /// <param name="Price">Price of the tier if the charge is a flat fee, or the price of each unit in the tier if the charge model is tiered pricing.  (required).</param>
        /// <param name="PriceFormat">Indicates if pricing is a flat fee or is per unit.  Values:  * &#x60;FlatFee&#x60; * &#x60;PerUnit&#x60; .</param>
        /// <param name="StartingUnit">Starting number of a range of units for the tier. .</param>
        /// <param name="Tier">Unique number that identifies the tier that the price applies to.  (required).</param>
        public POSTTierType(string EndingUnit = null, string Price = null, string PriceFormat = null, string StartingUnit = null, long? Tier = null)
        {
            // to ensure "Price" is required (not null)
            if (Price == null)
            {
                throw new InvalidDataException("Price is a required property for POSTTierType and cannot be null");
            }
            else
            {
                this.Price = Price;
            ...
            if (Tier == null)
            {
                throw new InvalidDataException("Tier is a required property for POSTTierType and cannot be null");
            }
            else
            {
                this.Tier = Tier;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as POSTTierType);
        }

        /// <summary>
        /// Returns true if POSTTierType instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTTierType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTTierType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
