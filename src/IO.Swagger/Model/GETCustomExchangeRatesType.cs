...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GETCustomExchangeRatesType :  IEquatable<GETCustomExchangeRatesType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCustomExchangeRatesType" /> class.
        /// </summary>
        /// <param name="Inverse">- If &#x60;true&#x60;, the exchange rate in the response is an inverse exchange rate. - If &#x60;false&#x60;, the exchange rate in the response is not an inverse exchange rate. The value is determined by the **Use inverse rate** checkbox in your Z-Finance [Manage Currency Conversion](https://knowledgecenter.zuora.com/CC_Finance/Foreign_Currency_Conversion#How_to_Enable_Foreign_Currency_Conversion) settings. .</param>
        /// <param name="Rates">Container for exchange rate data. Contains a set of fields that provide exchange rate data for each day between the specified &#x60;startDate&#x60; and &#x60;endDate&#x60; (inclusive).  .</param>
        /// <param name="Success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        public GETCustomExchangeRatesType(bool? Inverse = null, List<GETCustomExchangeRatesDataType> Rates = null, bool? Success = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GETCustomExchangeRatesType);
        }

        /// <summary>
        /// Returns true if GETCustomExchangeRatesType instances are equal
        /// </summary>
        /// <param name="other">Instance of GETCustomExchangeRatesType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCustomExchangeRatesType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Inverse != null &&
                    this.Inverse.Equals(other.Inverse)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Inverse != null)
                    hash = hash * 59 + this.Inverse.GetHashCode();
                if (this.Rates != null)
