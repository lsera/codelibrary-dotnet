...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IGetFilesApi : IApiAccessor
    {
        ...
        ApiResponse<Object> GETFilesWithHttpInfo (string fileId);
        ...
        System.Threading.Tasks.Task GETFilesAsync (string fileId);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GETFilesAsyncWithHttpInfo (string fileId);
    ...
    public partial class GetFilesApi : IGetFilesApi
    {
        ...
        /// <returns></returns>
        public GetFilesApi(Configuration configuration = null)
        {
        ...
        /// <param name="fileId">The Zuora ID of the file you want to retrieve.  See [Get Accounting Period](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Accounting_Periods/Get_Accounting_Period) for getting file IDs of accounting period reports, such as the Revenue Detail report. </param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GETFilesWithHttpInfo (string fileId)
        {
            // verify the required parameter 'fileId' is set
            if (fileId == null)
                throw new ApiException(400, "Missing required parameter 'fileId' when calling GetFilesApi->GETFiles");

            var localVarPath = "/files/{file-id}";
            ...
            if (fileId != null) localVarPathParams.Add("file-id", Configuration.ApiClient.ParameterToString(fileId)); // path parameter
        ...
        /// <param name="fileId">The Zuora ID of the file you want to retrieve.  See [Get Accounting Period](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Accounting_Periods/Get_Accounting_Period) for getting file IDs of accounting period reports, such as the Revenue Detail report. </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GETFilesAsync (string fileId)
        {
             await GETFilesAsyncWithHttpInfo(fileId);
        ...
        /// <param name="fileId">The Zuora ID of the file you want to retrieve.  See [Get Accounting Period](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Accounting_Periods/Get_Accounting_Period) for getting file IDs of accounting period reports, such as the Revenue Detail report. </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GETFilesAsyncWithHttpInfo (string fileId)
        {
            // verify the required parameter 'fileId' is set
            if (fileId == null)
                throw new ApiException(400, "Missing required parameter 'fileId' when calling GetFilesApi->GETFiles");
