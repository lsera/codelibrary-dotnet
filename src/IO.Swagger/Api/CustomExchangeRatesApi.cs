...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface ICustomExchangeRatesApi : IApiAccessor
    {
        ...
        /// <param name="startDate">Start date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-15. The start date cannot be later than the end date. </param>
        /// <param name="endDate">End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. </param>
        /// <returns>ApiResponse of GETCustomExchangeRatesType</returns>
        ApiResponse<GETCustomExchangeRatesType> GETCustomExchangeRatesWithHttpInfo (string currency, string startDate, string endDate);
        ...
        /// <param name="startDate">Start date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-15. The start date cannot be later than the end date. </param>
        /// <param name="endDate">End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. </param>
        /// <returns>Task of GETCustomExchangeRatesType</returns>
        System.Threading.Tasks.Task<GETCustomExchangeRatesType> GETCustomExchangeRatesAsync (string currency, string startDate, string endDate);
        ...
        /// <param name="startDate">Start date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-15. The start date cannot be later than the end date. </param>
        /// <param name="endDate">End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. </param>
        /// <returns>Task of ApiResponse (GETCustomExchangeRatesType)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETCustomExchangeRatesType>> GETCustomExchangeRatesAsyncWithHttpInfo (string currency, string startDate, string endDate);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomExchangeRatesApi : ICustomExchangeRatesApi
    {
        ...
        /// <returns></returns>
        public CustomExchangeRatesApi(Configuration configuration = null)
        {
        ...
        {
             ApiResponse<GETCustomExchangeRatesType> localVarResponse = GETCustomExchangeRatesWithHttpInfo(currency, startDate, endDate);
        ...
        /// <param name="endDate">End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. </param>
        /// <returns>ApiResponse of GETCustomExchangeRatesType</returns>
        public ApiResponse< GETCustomExchangeRatesType > GETCustomExchangeRatesWithHttpInfo (string currency, string startDate, string endDate)
        {
            // verify the required parameter 'currency' is set
            if (currency == null)
                throw new ApiException(400, "Missing required parameter 'currency' when calling CustomExchangeRatesApi->GETCustomExchangeRates");
            // verify the required parameter 'startDate' is set
            if (startDate == null)
                throw new ApiException(400, "Missing required parameter 'startDate' when calling CustomExchangeRatesApi->GETCustomExchangeRates");
            // verify the required parameter 'endDate' is set
            if (endDate == null)
                throw new ApiException(400, "Missing required parameter 'endDate' when calling CustomExchangeRatesApi->GETCustomExchangeRates");

            var localVarPath = "/custom-exchange-rates/{currency}";
            ...
            if (currency != null) localVarPathParams.Add("currency", Configuration.ApiClient.ParameterToString(currency)); // path parameter
            ...
            {
                Exception exception = ExceptionFactory("GETCustomExchangeRates", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<GETCustomExchangeRatesType>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (GETCustomExchangeRatesType) Configuration.ApiClient.Deserialize(localVarResponse, typeof(GETCustomExchangeRatesType)));
        ...
        /// <param name="endDate">End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. </param>
        /// <returns>Task of GETCustomExchangeRatesType</returns>
        public async System.Threading.Tasks.Task<GETCustomExchangeRatesType> GETCustomExchangeRatesAsync (string currency, string startDate, string endDate)
        {
             ApiResponse<GETCustomExchangeRatesType> localVarResponse = await GETCustomExchangeRatesAsyncWithHttpInfo(currency, startDate, endDate);
             return localVarResponse.Data;
        ...
        /// <param name="endDate">End date of the date range for which you want to get exchange rates.  The date must be in yyyy-mm-dd format, for example, 2016-01-16. The end date can be a maximum of 90 days after the start date. </param>
        /// <returns>Task of ApiResponse (GETCustomExchangeRatesType)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GETCustomExchangeRatesType>> GETCustomExchangeRatesAsyncWithHttpInfo (string currency, string startDate, string endDate)
        {
            // verify the required parameter 'currency' is set
            if (currency == null)
                throw new ApiException(400, "Missing required parameter 'currency' when calling CustomExchangeRatesApi->GETCustomExchangeRates");
