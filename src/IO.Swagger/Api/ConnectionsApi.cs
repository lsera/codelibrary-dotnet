...
namespace IO.Swagger.Api
{
    ...
    public interface IConnectionsApi : IApiAccessor
    {
        ...
        ApiResponse<CommonResponseType> POSTConnectionsWithHttpInfo (string apiAccessKeyId, string apiSecretAccessKey, string contentType);
        ...
        System.Threading.Tasks.Task<CommonResponseType> POSTConnectionsAsync (string apiAccessKeyId, string apiSecretAccessKey, string contentType);
        ...
        System.Threading.Tasks.Task<ApiResponse<CommonResponseType>> POSTConnectionsAsyncWithHttpInfo (string apiAccessKeyId, string apiSecretAccessKey, string contentType);
    ...
    public partial class ConnectionsApi : IConnectionsApi
    {
        ...
        {
             ApiResponse<CommonResponseType> localVarResponse = POSTConnectionsWithHttpInfo(apiAccessKeyId, apiSecretAccessKey, contentType);
        ...
        /// <param name="contentType">Must be set to \&quot;application/json\&quot; </param>
        /// <returns>ApiResponse of CommonResponseType</returns>
        public ApiResponse< CommonResponseType > POSTConnectionsWithHttpInfo (string apiAccessKeyId, string apiSecretAccessKey, string contentType)
        {
            // verify the required parameter 'apiAccessKeyId' is set
            if (apiAccessKeyId == null)
                throw new ApiException(400, "Missing required parameter 'apiAccessKeyId' when calling ConnectionsApi->POSTConnections");
            // verify the required parameter 'apiSecretAccessKey' is set
            if (apiSecretAccessKey == null)
                throw new ApiException(400, "Missing required parameter 'apiSecretAccessKey' when calling ConnectionsApi->POSTConnections");
            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new ApiException(400, "Missing required parameter 'contentType' when calling ConnectionsApi->POSTConnections");
            ...
            if (apiAccessKeyId != null) localVarHeaderParams.Add("apiAccessKeyId", Configuration.ApiClient.ParameterToString(apiAccessKeyId)); // header parameter
            if (apiSecretAccessKey != null) localVarHeaderParams.Add("apiSecretAccessKey", Configuration.ApiClient.ParameterToString(apiSecretAccessKey)); // header parameter
            ...
            {
                Exception exception = ExceptionFactory("POSTConnections", localVarResponse);
        ...
        /// <param name="contentType">Must be set to \&quot;application/json\&quot; </param>
        /// <returns>Task of CommonResponseType</returns>
        public async System.Threading.Tasks.Task<CommonResponseType> POSTConnectionsAsync (string apiAccessKeyId, string apiSecretAccessKey, string contentType)
        {
             ApiResponse<CommonResponseType> localVarResponse = await POSTConnectionsAsyncWithHttpInfo(apiAccessKeyId, apiSecretAccessKey, contentType);
             return localVarResponse.Data;
        ...
        /// <param name="contentType">Must be set to \&quot;application/json\&quot; </param>
        /// <returns>Task of ApiResponse (CommonResponseType)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CommonResponseType>> POSTConnectionsAsyncWithHttpInfo (string apiAccessKeyId, string apiSecretAccessKey, string contentType)
        {
            // verify the required parameter 'apiAccessKeyId' is set
            if (apiAccessKeyId == null)
                throw new ApiException(400, "Missing required parameter 'apiAccessKeyId' when calling ConnectionsApi->POSTConnections");
