...
namespace IO.Swagger.Test
{
    ...
    public class OperationsApiTests
    {
        ...
        /// <summary>
        /// Test POSTTransactionInvoicePayment
        /// </summary>
        [Test]
        public void POSTTransactionInvoicePaymentTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //POSTInvoiceCollectType request = null;
            //var response = instance.POSTTransactionInvoicePayment(request);
            //Assert.IsInstanceOf<POSTInvoiceCollectResponseType> (response, "response is POSTInvoiceCollectResponseType");
        }
