...
namespace IO.Swagger.Test
{
    ...
    public class SettingsApiTests
    {
        ...
        /// <summary>
        /// Test GETRevenueStartDateSetting
        /// </summary>
        [Test]
        public void GETRevenueStartDateSettingTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GETRevenueStartDateSetting();
            //Assert.IsInstanceOf<GETRevenueStartDateSettingType> (response, "response is GETRevenueStartDateSettingType");
        }
