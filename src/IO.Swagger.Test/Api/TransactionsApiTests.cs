...
namespace IO.Swagger.Test
{
    ...
    public class TransactionsApiTests
    {
        ...
        public void GETInvoiceTest()
        {
            ...
            //var response = instance.GETInvoice(accountKey);
            //Assert.IsInstanceOf<GETInvoiceFileWrapper> (response, "response is GETInvoiceFileWrapper");
        }
        ...
        public void GETPaymentsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string accountKey = null;
            //var response = instance.GETPayments(accountKey);
            //Assert.IsInstanceOf<GETPaymentsType> (response, "response is GETPaymentsType");
        }
